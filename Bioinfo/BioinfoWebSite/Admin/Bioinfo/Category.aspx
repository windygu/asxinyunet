<%@ Page Title="类别信息管理" Language="C#" MasterPageFile="~/Admin/ManagerPage.master" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="Common_Category" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    <div class="toolbar">
        <XCL:LinkBox ID="lbAdd" runat="server" BoxHeight="211px" BoxWidth="440px" Url="CategoryForm.aspx"
            IconLeft="~/Admin/images/icons/new.gif" EnableViewState="false"><b>添加类别信息</b></XCL:LinkBox>
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="ods" AllowPaging="True" AllowSorting="True" CssClass="m_table" PageSize="20" CellPadding="0" GridLines="None" EnableModelValidation="True" EnableViewState="false">
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText="类名称" SortExpression="Name" />
            ...
            <XCL:LinkBoxField HeaderText="编辑" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="CategoryForm.aspx?Id={0}" Height="211px" Text="编辑" Width="440px" Title="编辑类别信息">
