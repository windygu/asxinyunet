...
private System.Windows.Forms.TextBox txtRemark ;
   ...
   private System.Windows.Forms.ErrorProvider errorProvider1 ;
		...
		private void InitializeComponent()
		{
            ...
            this.FormPager.Location = new System.Drawing.Point(5, 151);
            ...
            this.lblProductIdTP.Location = new System.Drawing.Point(8, 10);
            ...
            this.lblProductNameTP.Location = new System.Drawing.Point(8, 37);
            ...
            this.lblBtCount.Location = new System.Drawing.Point(8, 64);
            ...
            this.lblT501Count.Location = new System.Drawing.Point(214, 10);
            ...
            this.lblT602Count.Location = new System.Drawing.Point(214, 37);
            ...
            this.lblYJCount.Location = new System.Drawing.Point(214, 64);
            ...
            this.lblUpdateTime.Location = new System.Drawing.Point(8, 96);
            ...
            this.lblRemark.Location = new System.Drawing.Point(36, 123);
            ...
            this.combProductIdTP.Location = new System.Drawing.Point(73, 7);
            this.combProductIdTP.Name = "combProductIdTP";
            this.combProductIdTP.Size = new System.Drawing.Size(135, 22);
            ...
            this.combProductNameTP.Location = new System.Drawing.Point(73, 34);
            this.combProductNameTP.Name = "combProductNameTP";
            this.combProductNameTP.Size = new System.Drawing.Size(135, 22);
            ...
            this.txtBtCount.Location = new System.Drawing.Point(73, 61);
            this.txtBtCount.Name = "txtBtCount";
            this.txtBtCount.Size = new System.Drawing.Size(135, 23);
            ...
            this.txtT501Count.Location = new System.Drawing.Point(279, 7);
            this.txtT501Count.Name = "txtT501Count";
            this.txtT501Count.Size = new System.Drawing.Size(92, 23);
            ...
            this.txtT602Count.Location = new System.Drawing.Point(279, 34);
            this.txtT602Count.Name = "txtT602Count";
            this.txtT602Count.Size = new System.Drawing.Size(92, 23);
            ...
            this.txtYJCount.Location = new System.Drawing.Point(279, 61);
            this.txtYJCount.Name = "txtYJCount";
            this.txtYJCount.Size = new System.Drawing.Size(92, 23);
            ...
            this.dtUpdateTime.Location = new System.Drawing.Point(73, 93);
            this.dtUpdateTime.Name = "dtUpdateTime";
            this.dtUpdateTime.Size = new System.Drawing.Size(298, 23);
            ...
            this.txtRemark.Location = new System.Drawing.Point(73, 120);
            this.txtRemark.Name = "txtRemark";
            this.txtRemark.Size = new System.Drawing.Size(298, 23);
            this.txtRemark.TabIndex = 14;
            // 
            // btnOK
            // 
            this.btnOK.Font = new System.Drawing.Font("宋体", 10.5F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.btnOK.Location = new System.Drawing.Point(245, 152);
            ...
            this.btnCancle.Location = new System.Drawing.Point(308, 152);
            this.btnCancle.Name = "btnCancle";
            this.btnCancle.Size = new System.Drawing.Size(63, 27);
            ...
            this.Size = new System.Drawing.Size(387, 184);
		...
		#region 构造函数 及初始化
		public AddProductFormule()	{InitializeComponent(); CustomerSettings(); }	
		...
		/// 获取或者设置当前实体
		/// </summary>
		public tb_ProductFormule CutModel{get ;set ;}
		/// <summary>
		/// 当前实体窗体的显示模式,默认为连续显示
		/// </summary>
		...
		{
			if(combProductIdTP.Text.Trim()=="")//产品编号
			{
		...
		void btnOK_Click(object sender, EventArgs e)
		{
			...
			else 
			{
				if(((CutShowMode!= FormShowMode.ReadOnlyForAll) || (CutShowMode != FormShowMode.ReadOnlyForOne)) && ValidateControls() )
				{
					...
					if(combProductIdTP.Text.Trim()!="") model.ProductIdTP = combProductIdTP.Text.Trim() ;//产品编号
					if(combProductNameTP.Text.Trim()!="") model.ProductNameTP = combProductNameTP.Text.Trim() ;//产品名称
					if(txtBtCount.Text.Trim()!="")	model.BtCount =Convert.ToDouble(txtBtCount.Text.Trim()) ;//白土用量
					if(txtT501Count.Text.Trim()!="")	model.T501Count =Convert.ToDouble(txtT501Count.Text.Trim()) ;//T501用量
					if(txtT602Count.Text.Trim()!="")	model.T602Count =Convert.ToDouble(txtT602Count.Text.Trim()) ;//T602用量
					if(txtYJCount.Text.Trim()!="")	model.YJCount =Convert.ToDouble(txtYJCount.Text.Trim()) ;//液碱用量
		...
		List <tb_ProductFormule> modelList ;//当前实体列表
		void GetData()
		{				
			//判断不为空，才能绑定				
		...
		private void SetControlReSet()
		{
			...
			if (CutShowMode == FormShowMode.AddOne || CutShowMode== FormShowMode.ContinueAdd )
			{
				...
				btnOK.Text ="保存";
				//设置控件清空，并且可用
				combProductIdTP.Enabled = true ; //产品编号	
				combProductNameTP.Enabled = true ; //产品名称	
				txtBtCount.ReadOnly = false ;//白土用量
				txtBtCount.Text = string.Empty  ; 
				txtT501Count.ReadOnly = false ;//T501用量
				txtT501Count.Text = string.Empty  ; 
				txtT602Count.ReadOnly = false ;//T602用量
				txtT602Count.Text = string.Empty  ; 
				txtYJCount.ReadOnly = false ;//液碱用量
				txtYJCount.Text = string.Empty  ; 
		...
		private void SetControlEdit()
		{
			if (CutShowMode== FormShowMode.ContinueDisplay || CutShowMode== FormShowMode.DisplayCurrent ) {
				...
				btnOK.Text =" 保存";
				//控件除主键外都可读
				combProductIdTP.Enabled = false;//产品编号combProductNameTP.Enabled = true ;//产品名称
				txtBtCount.ReadOnly = false ;//白土用量
				txtT501Count.ReadOnly = false ;//T501用量
				txtT602Count.ReadOnly = false ;//T602用量
				txtYJCount.ReadOnly = false ;//液碱用量
		...
		private void SetControlReadOnly()
		{
			...
			combProductIdTP.Enabled = false ;//产品编号
			combProductNameTP.Enabled = false ;//产品名称
			txtBtCount.ReadOnly = true  ;//白土用量
			txtT501Count.ReadOnly = true  ;//T501用量
			txtT602Count.ReadOnly = true  ;//T602用量
			txtYJCount.ReadOnly = true  ;//液碱用量
		...
		{
			combProductIdTP.DataBindings.Clear () ;//产品编号
