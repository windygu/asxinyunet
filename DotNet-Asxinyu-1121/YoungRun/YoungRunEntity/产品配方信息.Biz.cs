...
namespace YoungRunEntity
{
    ...
    public partial class tb_ProductFormule : Entity<tb_ProductFormule>
    {
        ...
        public static tb_ProductFormule FindByProductIdTP(String productidtp)
        {
            if (Meta.Count >= 1000)
                return Find(new String[] { _.ProductIdTP }, new Object[] { productidtp });
            else // 实体缓存
                return Meta.Cache.Entities.Find(_.ProductIdTP, productidtp);
            // 单对象缓存
            //return Meta.SingleCache[productidtp];
        }
        #endregion
