...
namespace YoungRunEntity
{
    ...
    public partial class tb_OilTankInfo : Entity<tb_OilTankInfo>
    {
        ...
        public static tb_OilTankInfo FindByTankId(String tankid)
        {
            if (Meta.Count >= 1000)
                return Find(new String[] { _.TankId }, new Object[] { tankid });
            else // 实体缓存
                return Meta.Cache.Entities.Find(_.TankId, tankid);
            // 单对象缓存
        ...
        //public static EntityList<tb_OilTankInfo> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
