    ...
    public partial class BaseFileManager : BaseManager
    {
        ...
        public BaseFileEntity GetEntity(string id)
        {
            ...
            sqlQuery = " SELECT " + BaseFileEntity.FieldId
                    ...
                    + "        ," + BaseFileEntity.FieldCategoryCode
                    + "        ," + BaseFileEntity.FieldCode
                    + "        ," + BaseFileEntity.FieldFileName
                    + "        ," + BaseFileEntity.FieldSource
                    + "        ," + BaseFileEntity.FieldIntroduction
                    + "        ," + BaseFileEntity.FieldHomePage
                    + "        ," + BaseFileEntity.FieldSubPage
                    + "        ," + BaseFileEntity.FieldFilePath
                    + "        ," + BaseFileEntity.FieldImageUrl
                    + "        ," + BaseFileEntity.FieldKeywords
                    + "        ," + BaseFileEntity.FieldFileSize
                    + "        ," + BaseFileEntity.FieldReadCount
                    + "        ," + BaseFileEntity.FieldDescription
                    + "        ," + BaseFileEntity.FieldAuditStatus
        ...
        private string Add(string folderId, string fileName, string file, byte[] byteFile, string description, string categoryCode, bool enabled, out string statusCode)
        {
            ...
            fileEntity.CategoryCode = categoryCode;
            fileEntity.Enabled = enabled ? 1:0;
        ...
        public DataTable Search(string userId, string categoryCode, string searchValue, bool? enabled, bool? deletionStateCode)
        {
            ...
            */
            ...
            {
                sqlQuery += " AND " + BaseFileEntity.FieldCategoryCode + " = '" + categoryCode + "'";
            }
            ...
            if (!String.IsNullOrEmpty(searchValue))
            {
                ...
                sqlQuery += " OR " + BaseFileEntity.FieldCategoryCode + " LIKE " + DbHelper.GetParameter(BaseFileEntity.FieldCategoryCode);
                ...
                dbParameters.Add(DbHelper.MakeParameter(BaseFileEntity.FieldCategoryCode, searchValue));
