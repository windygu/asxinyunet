...
namespace DotNet.Business
{
    ...
    public partial class BaseCommentManager : BaseManager, IBaseManager
    {
        ...
        #region  public DataTable Search(string year, string month, string searchValue) 查询具体方法
        /// <summary>
        /// 查询具体方法
        /// </summary>
        ...
        {
            return this.GetDataTable(new KeyValuePair<string, object>(BaseCommentEntity.FieldCategoryCode, categoryCode), topLimit, BaseCommentEntity.FieldCreateOn);
        }
        #endregion
        ...
        public DataTable GetDataTableByCategory(string categoryCode, string objectId)
        {
            ...
            parameters.Add(new KeyValuePair<string, object>(BaseCommentEntity.FieldCategoryCode, objectId));
