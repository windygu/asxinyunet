    ...
    public partial class BaseUserManager : BaseManager
    {
        ...
        public DataTable GetDataTableByRole(string roleId)
        {
            ...
            string sqlQuery = " SELECT * FROM " + BaseUserEntity.TableName
                            ...
                            + "       AND (" + BaseUserEntity.FieldRoleId + "='" + roleId + "'"
        ...
        {
            string sqlQuery = " UPDATE BaseStaff SET UserId = null WHERE UserId NOT IN ( SELECT Id FROM BASE_USER WHERE DeletionStateCode = 0 ) ";
