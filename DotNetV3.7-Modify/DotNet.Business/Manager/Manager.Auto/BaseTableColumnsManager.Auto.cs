...
namespace DotNet.Business
{
    ...
    public partial class BaseTableColumnsManager : BaseManager, IBaseManager
    {
        ...
        {
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldTableCode, baseTableColumnsEntity.TableCode);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldColumnCode, baseTableColumnsEntity.ColumnCode);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldColumnName, baseTableColumnsEntity.ColumnName);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldIsPublic, baseTableColumnsEntity.IsPublic);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldEnabled, baseTableColumnsEntity.Enabled);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldAllowEdit, baseTableColumnsEntity.AllowEdit);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldAllowDelete, baseTableColumnsEntity.AllowDelete);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldDeletionStateCode, baseTableColumnsEntity.DeletionStateCode);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldSortCode, baseTableColumnsEntity.SortCode);
            sqlBuilder.SetValue(BaseTableColumnsEntity.FieldDescription, baseTableColumnsEntity.Description);
        }
