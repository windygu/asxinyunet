...
namespace DotNet.Business
{
    ...
    public partial class BaseWorkFlowCurrentManager : BaseManager, IBaseManager
    {
        ...
        public int AuditReject(string[] currentIds, string auditIdea, int? historyId = null)
        {
            int returnValue = 0;
        ...
        /// <returns>影响行数</returns>
        public int AuditReject(string currentId, string auditIdea, int? historyId = null)
        {
        ...
        #region public int AuditReject(IWorkFlowManager workFlowManager, string currentId, string auditIdea, int? historyId = null)
        /// <summary>
        /// 审核退回
        /// </summary>
        ...
        /// <param name="historyId">退回到第几步</param>
        /// <returns>影响行数</returns>
        public int AuditReject(IWorkFlowManager workFlowManager, string currentId, string auditIdea, int? historyId = null)
        {
            int returnValue = 0;
            ...
            lock (WorkFlowCurrentLock)
            {
                ...
                try
                {
                    ...
                    */
                    ...
                    DataTable dataTable = workFlowStepManager.GetDataTable(parameters, BaseWorkFlowStepEntity.FieldSortCode);
                    ...
                    string[] userIds = workFlowHistoryManager.GetProperties(new KeyValuePair<string, object>(BaseWorkFlowHistoryTable.FieldCurrentFlowId, workFlowCurrentEntity.Id), BaseWorkFlowHistoryTable.FieldAuditUserId);
                    ...
                    if (workFlowCurrentEntity.Id != null)
                    {
                        ...
                        if (workFlowManager != null)
                        {
                            ...
                            */
                            // 都给谁发送退回的消息
                            returnValue = workFlowManager.SendRemindMessage(workFlowCurrentEntity, AuditStatus.AuditReject, userIds, workFlowCurrentEntity.ToDepartmentId, workFlowCurrentEntity.ToRoleId);
                        }
                    }
                    else
                    {
