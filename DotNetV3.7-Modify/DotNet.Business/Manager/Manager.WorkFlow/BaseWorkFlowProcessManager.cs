...
namespace DotNet.Business
{
	...
	public partial class BaseWorkFlowProcessManager : BaseManager
	{
        ...
        /// <returns>流程</returns>
        public string GetProcessId(string userId, string workFlowCode)
        {
            // 这里处理单据编号
            ...
            parameters.Add(new KeyValuePair<string, object>(BaseWorkFlowProcessEntity.FieldUserId, userId));
