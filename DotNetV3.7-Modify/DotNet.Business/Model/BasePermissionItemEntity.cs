...
namespace DotNet.Business
{
    ...
    public partial class BasePermissionItemEntity
    {
        ...
        public BasePermissionItemEntity GetFrom(DataRow dataRow)
        {
            ...
            this.ParentId = BaseBusinessLogic.ConvertToInt(dataRow[BasePermissionItemEntity.FieldParentId]);
        ...
        public BasePermissionItemEntity GetFrom(IDataReader dataReader)
        {
            ...
            this.ParentId = BaseBusinessLogic.ConvertToInt(dataReader[BasePermissionItemEntity.FieldParentId]);
