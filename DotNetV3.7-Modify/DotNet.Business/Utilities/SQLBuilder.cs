...
namespace DotNet.Business
{
   ...
   public partial class SQLBuilder
   {
      ...
      #region 获得数据库连接相关 private void PrepareCommand()
      /// <summary>
      /// 获得数据库连接
      /// </summary>
      ...
      #region 开始查询 public void BeginSelect(string tableName)
      /// <summary>
      /// 开始查询
      /// </summary>
      ...
      #region 开始插入 public void BeginInsert(string tableName)
      /// <summary>
      /// 开始插入
      /// </summary>
      /// <param name="tableName">目标表</param>
      ...
      #region 开始插入 传入是否自增 public void BeginInsert(string tableName, bool identity)
      /// <summary>
      /// 开始插入  传入是否自增
      /// </summary>
      /// <param name="tableName">目标表</param>
      ...
      #region 开始插入 传入主键 public void BeginInsert(string tableName, string primaryKey)
      /// <summary>
      /// 开始插入 传入主键
      /// </summary>
      /// <param name="tableName">目标表</param>
      ...
      #region 开始更新 public BeginUpdate(string tableName)
      /// <summary>
      /// 开始更新
      /// </summary>
      /// <param name="tableName">目标表</param>
      ...
      #region 开始删除 public void BeginDelete(string tableName)
      /// <summary>
      /// 开始删除
      /// </summary>
      /// <param name="tableName">目标表</param>
      ...
      #region 开始增删改查 private void Begin(string tableName, DbOperation dbOperation)
      /// <summary>
      /// 开始查询语句
      /// </summary>
      /// <param name="tableName">目标表</param>
      ...
      #region 设置公式 public void SetFormula(string targetFiled, string formula, string relation)
      /// <summary>
      /// 设置公式
      /// </summary>
      ...
      #region 设置为当前时间 public void SetDBNow(string targetFiled)
      /// <summary>
      /// 设置为当前时间
      /// </summary>
      /// <param name="targetFiled">目标字段</param>
      ...
      #region 设置为Null值 public void SetNull(string targetFiled)
      /// <summary>
      /// 设置为Null值
      /// </summary>
      /// <param name="targetFiled">目标字段</param>
      ...
      #region 设置值 public void SetValue(string targetFiled, object targetValue)
      /// <summary>
      /// 设置值
      /// </summary>
      /// <param name="targetFiled">目标字段</param>
      ...
      #region 添加参数 private void AddParameter(string targetFiled, object targetValue)
      /// <summary>
      /// 添加参数
      /// </summary>
      /// <param name="targetFiled">目标字段</param>
      ...
      #region 设置条件 public string SetWhere(string[] targetFileds, Object[] targetValues, string relation = " AND ")
      /// <summary>
      /// 设置条件
      /// </summary>
      ...
      #region 设置条件 public string SetWhere(string targetFiled, object targetValue, string targetFiledName = null, string relation = " AND ")
      /// <summary>
      /// 设置条件
      /// </summary>
      /// <param name="targetFiled">目标字段</param>
      ...
      #region 设置条件 public string SetWhere(string targetFiled, Object[] targetValues) "In"
      /// <summary>
      /// 设置条件
      /// </summary>
      ...
      #region 结束查询 public int EndSelect()
      /// <summary>
      /// 结束查询
      /// </summary>
      ...
      #region 结束插入 public int EndInsert()
      /// <summary>
      /// 结束插入
      /// </summary>
      /// <returns>影响行数</returns>
      ...
      #region  结束更新 public int EndUpdate()
      /// <summary>
      /// 结束更新
      /// </summary>
      /// <returns>影响行数</returns>
      ...
      #region 结束删除 public int EndDelete()
      /// <summary>
      /// 结束删除
      /// </summary>
      /// <returns>影响行数</returns>
      ...
      #region 执行语句 private int Execute()
      /// <summary>
      /// 执行语句
      /// </summary>
      /// <returns>影响行数</returns>
