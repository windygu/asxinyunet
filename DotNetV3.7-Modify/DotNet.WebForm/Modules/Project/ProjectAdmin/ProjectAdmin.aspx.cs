...
/// </author>
/// </remarks>
public partial class ProjectAdmin : BasePage
{
    ...
    private void GetDataBaseParamter()
    {
        ...
        string pageSize = parameterManager.GetParameter("User", this.UserInfo.Id, "ProjectAdmin.PageSize");
    ...
    {
        this.permissionAdd = this.IsAuthorized("Project.Add");
        this.permissionEdit = this.IsAuthorized("Project.Edit");
        this.permissionDelete = this.IsAuthorized("Project.Delete");
    }
    #endregion
    ...
    {
        this.myNavigator.BindData(this.gridView, this.DTProject, e);
    ...
    {
        BaseParameterManager parameterManager = new BaseParameterManager(this.UserCenterDbHelper, this.UserInfo);
        parameterManager.SetParameter("User", this.UserInfo.Id, "ProjectAdmin.PageSize", this.myNavigator.PageSize.ToString());
    }
    #endregion
    ...
    protected void gridView_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        // 导向编辑页面
        Page.Response.Redirect("ProjectEdit.aspx?Id=" + id);
    }
    ...
    private void DeleteMark(string id)
    {
        ...
        try
        {
            this.DbHelper.Open();
            ProjectManager projectManager = new ProjectManager(this.DbHelper, this.UserInfo);
            returnValue = projectManager.SetDeleted(id);
            this.DoSearch();
        }
        catch (Exception ex)
        {
    ...
    private int BathDelete()
    {
        ...
        try
        {
            this.DbHelper.Open();
            ProjectManager projectManager = new ProjectManager(this.DbHelper, this.UserInfo);
            returnValue = projectManager.SetDeleted(ids);
        }
        catch (Exception ex)
        {
            this.LogException(ex);
    ...
    protected void gridView_Sorting(object sender, GridViewSortEventArgs e)
    {
        ...
        this.DTProject.DefaultView.Sort = this.SortExpression + " " + this.SortDire;
        this.gridView.EditIndex = -1;
        PageChangeEventArgs pageChangeEventArgs = new PageChangeEventArgs(this.gridView, "Sorting");
        this.myNavigator.BindData(this.gridView, this.DTProject, pageChangeEventArgs);
        this.GetPermission();
        this.SetControlState();
    }
    ...
    {
        Page.Response.Redirect("ProjectAdd.aspx");
    }
    ...
    private DataTable DTProject
    {
        get
        {
            return Utilities.GetFromSession("_DTProject") as DataTable;
        }
        set
        {
            Utilities.AddSession("_DTProject", value);
        }
    }
}