<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDraftAdmin.aspx.cs" Inherits="UserDraftAdmin" %>
    ...
    <table width="100%" height="100%">
                    ...
                    <asp:GridView ID="gridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="单据标题" SortExpression="Title" >
                                <ItemTemplate>
                                    <a target="_blank" href="SubmitBill.aspx?ObjectId=<%#DataBinder.Eval(Container, "DataItem.Id").ToString()%>&ObjectFullName=<%# HttpUtility.UrlEncode(DataBinder.Eval(Container, "DataItem.Title").ToString())%>&CategoryCode=<%# DataBinder.Eval(Container, "DataItem.CategoryCode").ToString()%>&CategoryFullName=<%# HttpUtility.UrlEncode(DataBinder.Eval(Container, "DataItem.Introduction").ToString())%>">
        ...
        <tr>
            <td align="center" valign="middle" style="height: 20px; margin: auto auto auto auto">
                <asp:Button ID="btnAdd" runat="server" CssClass="Button" Text="新增单据" AccessKey="N"
                    TabIndex="3" OnClick="btnAdd_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                <asp:Button ID="btnBatchAutoStatr" runat="server" CssClass="Button" Text="提交单据" AccessKey="N"
                    TabIndex="3" OnClientClick="return CheckSelectAnyOne('你确认提交所选单据吗？');" OnClick="btnBatchAutoStatr_Click"
                    onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
