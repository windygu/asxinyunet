<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RolePermissionAdmin.aspx.cs"
    Inherits="RolePermissionAdmin" %>

<html>
<head>
    <title>角色操作权限配置</title>
        ...
        <tr>
            <td width="100%" height="100%" valign="top">
                <div style="overflow: auto; width: 100%; height: 100%">
                    <asp:TreeView BorderWidth="0" ID="tvPermission" runat="server" 
