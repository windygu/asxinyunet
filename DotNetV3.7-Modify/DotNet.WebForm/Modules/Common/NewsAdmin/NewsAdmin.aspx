...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
    ...
    <table width="100%" height="100%">
        ...
        <tr>
            <td align="center">
                分类：<asp:DropDownList ID="cmbNewsFolder" OnSelectedIndexChanged="cmbNewsFolder_SelectedIndexChanged"
                    ...
                    <asp:GridView ID="gridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkSelected" onClick="CheckItem('gridView_ctl01_chkAll');"
                                        runat="server" />
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="False" />
                                <ItemStyle HorizontalAlign="Center" Width="30px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="新闻标题" SortExpression="FileName">
                                <ItemTemplate>
                                    <a target="_blank" href="<%=this.ShoppingURL%>EditNews.aspx?OpenId=<%=this.UserInfo.OpenId%>&ID=<%# DataBinder.Eval(Container, "DataItem.Id").ToString()%>"><%# DataBinder.Eval(Container, "DataItem.Title").ToString()%></a>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="False" />
                            ...
                            <asp:BoundField DataField="AuditStatus" HeaderText="审核状态" HtmlEncode="False" SortExpression="AuditStatus">
                                ...
                                <ItemStyle Wrap="False" Width="60px" CssClass="leftBlank rightBlank" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ModifiedBy" HeaderText="发布人" HtmlEncode="False"
        ...
        <tr>
            <td align="center" valign="middle" style="height: 20px; margin: auto auto auto auto">
                <asp:Button ID="btnAdd" runat="server" CssClass="Button" Text="录入新闻" AccessKey="N"
                    TabIndex="3" OnClick="btnAdd_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                <asp:Button ID="btnAllow" runat="server" CssClass="Button" Text="允许发布" AccessKey="N" TabIndex="3"
                    OnClick="btnAllow_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                <asp:Button ID="btnStop" runat="server" CssClass="Button" Text="停止发布" AccessKey="N"
                    TabIndex="3" OnClick="btnStop_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
