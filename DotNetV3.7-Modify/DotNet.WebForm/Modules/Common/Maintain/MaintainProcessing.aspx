<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaintainProcessing.aspx.cs"
    Inherits="MaintainProcessing" %>
...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
    ...
    <table width="100%" height="100%">
        ...
        <tr>
            <td align="center">
                故障类别：<asp:DropDownList ID="cmbBugCategory" Width="200px" TabIndex="1" runat="server"
                    AutoPostBack="True" OnSelectedIndexChanged="cmbBugCategory_SelectedIndexChanged">
                </asp:DropDownList>
                ...
                <div style="overflow: auto; width: 100%; height: 100%">
                    <asp:GridView ID="gridView" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="受理" SortExpression="ProcessorName">
                                <ItemTemplate>
        ...
        <tr>
            <td align="center" valign="middle" style="height: 20px">
                <asp:Button ID="btnCheckAll" runat="server" CssClass="Button" Text="全选(A)" TabIndex="1"
                    ...
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                &nbsp;<asp:Button ID="btnSetSend" runat="server" CssClass="Button" Text="待维修(C)"
                    AccessKey="C" TabIndex="2" OnClientClick="return CheckSelectAnyOne('你确定所选单据设置为待维修状态吗？');"
                    OnClick="btnSetSend_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                &nbsp;<asp:Button ID="btnSetProcessed" runat="server" CssClass="Button" Text="已维修(S)"
                    AccessKey="S" TabIndex="3" OnClientClick="return CheckSelectAnyOne('你确定所选单据设置为已维修状态吗？');"
