<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaintainProcessed.aspx.cs"
    Inherits="MaintainProcessed" %>
        ...
        <tr>
            <td align="center" valign="middle" style="height: 20px">
                <asp:Button ID="btnCheckAll" runat="server" CssClass="Button" Text="全选(A)" TabIndex="1"
                    ...
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                &nbsp;<asp:Button ID="btnProcessing" runat="server" CssClass="Button" Text="维修中(C)"
                    AccessKey="C" TabIndex="2" OnClientClick="return CheckSelectAnyOne('你确定所选单据设置为维修中修状态吗？');"
                    OnClick="btnProcessing_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
            </td>
        </tr>
    </table>
