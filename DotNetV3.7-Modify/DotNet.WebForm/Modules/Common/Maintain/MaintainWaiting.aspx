<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaintainWaiting.aspx.cs"
    Inherits="MaintainWaiting" %>
        ...
        <tr>
            <td align="center" valign="middle" >
                <asp:Button ID="btnCheckAll" runat="server" CssClass="Button" Text="全选(A)" TabIndex="1"
                    ...
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                &nbsp;<asp:Button ID="btnSetProcessing" runat="server" CssClass="Button" Text="维修中(C)"
                    AccessKey="C" TabIndex="2" OnClientClick="return CheckSelectAnyOne('你确定所选单据设置为维修中状态吗？');"
                    OnClick="btnSetProcessing_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                &nbsp;<asp:Button ID="btnSetProcessed" runat="server" CssClass="Button" Text="已维修(S)"
                    AccessKey="S" TabIndex="1" OnClientClick="return CheckSelectAnyOne('你确定所选单据设置为已维修状态吗？');"
