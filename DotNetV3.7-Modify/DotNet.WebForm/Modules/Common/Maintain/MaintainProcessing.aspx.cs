...
/// </author>
/// </remarks>
public partial class MaintainProcessing : BasePage
{
    ...
    private void DoSearch()
    {
        ...
        // DataTable dataTable = maintainManager.GetDataTableByPage(string.Empty, "维修中", searchValue, out recordCount, this.myNavigator.PageIndex + 1, this.myNavigator.PageSize, this.SortExpression, this.SortDire);
        DataTable dataTable = maintainManager.GetDataTableByPage(string.Empty, this.cmbBugCategory.SelectedValue, MaintainStatus.MaintainProcessing.ToDescription(), searchValue, out recordCount, this.myNavigator.PageIndex + 1, this.myNavigator.PageSize, this.SortExpression, this.SortDire);
    ...
    #region private int SetSend() 批量撤销
    /// <summary>
    /// 批量撤销
    /// </summary>
