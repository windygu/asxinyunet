...
{
    /// <summary></summary>
    public partial class ItemsPattern : Entity<ItemsPattern>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsPattern数据……", typeof(ItemsPattern).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsPattern数据！", typeof(ItemsPattern).Name);
        //}
        #endregion
        ...
        public static ItemsPattern FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsPattern> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
