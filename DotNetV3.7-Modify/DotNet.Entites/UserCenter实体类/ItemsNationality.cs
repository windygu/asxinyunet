...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_Nationality", true, "Id")]
    [BindTable("ItemsNationality", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsNationality : IItemsNationality
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsNationality
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
