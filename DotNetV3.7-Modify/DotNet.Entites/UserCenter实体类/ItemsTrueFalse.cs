...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_TrueFalse", true, "Id")]
    [BindTable("ItemsTrueFalse", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsTrueFalse : IItemsTrueFalse
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsTrueFalse
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
