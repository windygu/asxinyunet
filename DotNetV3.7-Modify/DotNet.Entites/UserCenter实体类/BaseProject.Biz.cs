...
{
    /// <summary></summary>
    public partial class BaseProject : Entity<BaseProject>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseProject数据……", typeof(BaseProject).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseProject数据！", typeof(BaseProject).Name);
        //}
        #endregion
        ...
        public static BaseProject FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseProject> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
