...
{
    /// <summary></summary>
    public partial class ItemsArea : Entity<ItemsArea>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsArea数据……", typeof(ItemsArea).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsArea数据！", typeof(ItemsArea).Name);
        //}
        #endregion
        ...
        public static ItemsArea FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsArea> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
