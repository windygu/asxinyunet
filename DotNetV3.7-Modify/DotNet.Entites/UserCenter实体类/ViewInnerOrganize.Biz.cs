...
{
    /// <summary></summary>
    public partial class ViewInnerOrganize : Entity<ViewInnerOrganize>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewInnerOrganize数据……", typeof(ViewInnerOrganize).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewInnerOrganize数据！", typeof(ViewInnerOrganize).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewInnerOrganize> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
