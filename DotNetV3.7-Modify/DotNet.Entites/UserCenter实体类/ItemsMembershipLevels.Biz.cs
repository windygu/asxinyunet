...
{
    /// <summary></summary>
    public partial class ItemsMembershipLevels : Entity<ItemsMembershipLevels>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsMembershipLevels数据……", typeof(ItemsMembershipLevels).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsMembershipLevels数据！", typeof(ItemsMembershipLevels).Name);
        //}
        #endregion
        ...
        public static ItemsMembershipLevels FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsMembershipLevels> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
