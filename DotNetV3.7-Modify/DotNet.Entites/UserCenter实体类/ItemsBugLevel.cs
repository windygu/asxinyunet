...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_BugLevel", true, "Id")]
    [BindTable("ItemsBugLevel", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsBugLevel : IItemsBugLevel
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsBugLevel
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
