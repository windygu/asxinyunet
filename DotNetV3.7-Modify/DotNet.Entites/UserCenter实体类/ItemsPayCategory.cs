...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_PayCategory", true, "Id")]
    [BindTable("ItemsPayCategory", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsPayCategory : IItemsPayCategory
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(9, "IsPublic", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(10, "DeletionStateCode", "", "0", "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IItemsPayCategory
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
