...
{
    /// <summary></summary>
    public partial class ItemsSalaryItemCategory : Entity<ItemsSalaryItemCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsSalaryItemCategory数据……", typeof(ItemsSalaryItemCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsSalaryItemCategory数据！", typeof(ItemsSalaryItemCategory).Name);
        //}
        #endregion
        ...
        public static ItemsSalaryItemCategory FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsSalaryItemCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
