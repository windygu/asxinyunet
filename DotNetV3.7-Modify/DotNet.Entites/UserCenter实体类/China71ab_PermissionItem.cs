...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_China71ab_PermissionItem", true, "Id")]
    [BindTable("China71ab_PermissionItem", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class China71ab_PermissionItem : IChina71ab_PermissionItem
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IChina71ab_PermissionItem
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
