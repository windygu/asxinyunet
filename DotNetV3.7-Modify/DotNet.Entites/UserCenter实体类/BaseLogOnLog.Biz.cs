...
{
    /// <summary></summary>
    public partial class BaseLogOnLog : Entity<BaseLogOnLog>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseLogOnLog数据……", typeof(BaseLogOnLog).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseLogOnLog数据！", typeof(BaseLogOnLog).Name);
        //}
        #endregion
        ...
        //public static EntityList<BaseLogOnLog> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
