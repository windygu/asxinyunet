...
{
    /// <summary></summary>
    public partial class BaseUserRole : Entity<BaseUserRole>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseUserRole数据……", typeof(BaseUserRole).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseUserRole数据！", typeof(BaseUserRole).Name);
        //}
        #endregion
        ...
        public static BaseUserRole FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseUserRole> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
