...
{
    /// <summary></summary>
    public partial class ItemsGender : Entity<ItemsGender>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsGender数据……", typeof(ItemsGender).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsGender数据！", typeof(ItemsGender).Name);
        //}
        #endregion
        ...
        public static ItemsGender FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsGender> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
