...
{
    /// <summary></summary>
    public partial class ItemsOilInstallations : Entity<ItemsOilInstallations>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsOilInstallations数据……", typeof(ItemsOilInstallations).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsOilInstallations数据！", typeof(ItemsOilInstallations).Name);
        //}
        #endregion
        ...
        public static ItemsOilInstallations FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsOilInstallations> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
