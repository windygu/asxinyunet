...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_OilEventType", true, "Id")]
    [BindTable("ItemsOilEventType", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsOilEventType : IItemsOilEventType
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsOilEventType
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
