...
{
    /// <summary></summary>
    public partial class BaseWorkReport : Entity<BaseWorkReport>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseWorkReport数据……", typeof(BaseWorkReport).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseWorkReport数据！", typeof(BaseWorkReport).Name);
        //}
        #endregion
        ...
        public static BaseWorkReport FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseWorkReport> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
