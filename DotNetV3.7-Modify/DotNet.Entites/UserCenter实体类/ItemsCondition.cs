...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_Condition", true, "Id")]
    [BindTable("ItemsCondition", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsCondition : IItemsCondition
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsCondition
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
