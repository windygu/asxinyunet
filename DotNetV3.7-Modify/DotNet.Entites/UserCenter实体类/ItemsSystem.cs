...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_System", true, "Id")]
    [BindTable("ItemsSystem", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsSystem : IItemsSystem
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsSystem
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
