...
{
    /// <summary></summary>
    public partial class BaseUserOrganize : Entity<BaseUserOrganize>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseUserOrganize数据……", typeof(BaseUserOrganize).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseUserOrganize数据！", typeof(BaseUserOrganize).Name);
        //}
        #endregion
        ...
        public static BaseUserOrganize FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseUserOrganize> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
