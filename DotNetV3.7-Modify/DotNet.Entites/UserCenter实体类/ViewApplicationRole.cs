...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("ViewApplicationRole", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ViewApplicationRole : IViewApplicationRole
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IViewApplicationRole
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
