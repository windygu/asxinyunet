...
{
    /// <summary></summary>
    public partial class ItemsYesNo : Entity<ItemsYesNo>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsYesNo数据……", typeof(ItemsYesNo).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsYesNo数据！", typeof(ItemsYesNo).Name);
        //}
        #endregion
        ...
        public static ItemsYesNo FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsYesNo> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
