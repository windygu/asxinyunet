...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_MembershipLevels", true, "Id")]
    [BindTable("ItemsMembershipLevels", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsMembershipLevels : IItemsMembershipLevels
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(6, "IsPublic", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(8, "AllowEdit", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(9, "AllowDelete", "", null, "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IItemsMembershipLevels
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
