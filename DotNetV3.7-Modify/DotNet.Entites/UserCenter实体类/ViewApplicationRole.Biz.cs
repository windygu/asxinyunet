...
{
    /// <summary></summary>
    public partial class ViewApplicationRole : Entity<ViewApplicationRole>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewApplicationRole数据……", typeof(ViewApplicationRole).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewApplicationRole数据！", typeof(ViewApplicationRole).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewApplicationRole> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
