...
{
    /// <summary></summary>
    public partial class ItemsBugCategory : Entity<ItemsBugCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsBugCategory数据……", typeof(ItemsBugCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsBugCategory数据！", typeof(ItemsBugCategory).Name);
        //}
        #endregion
        ...
        public static ItemsBugCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsBugCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
