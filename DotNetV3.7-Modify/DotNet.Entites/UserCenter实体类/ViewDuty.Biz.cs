...
{
    /// <summary></summary>
    public partial class ViewDuty : Entity<ViewDuty>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewDuty数据……", typeof(ViewDuty).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewDuty数据！", typeof(ViewDuty).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewDuty> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
