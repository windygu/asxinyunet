...
{
    /// <summary></summary>
    public partial class ItemsLockWaitMinute : Entity<ItemsLockWaitMinute>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsLockWaitMinute数据……", typeof(ItemsLockWaitMinute).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsLockWaitMinute数据！", typeof(ItemsLockWaitMinute).Name);
        //}
        #endregion
        ...
        public static ItemsLockWaitMinute FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsLockWaitMinute> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
