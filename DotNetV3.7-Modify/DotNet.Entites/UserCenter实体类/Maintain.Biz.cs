...
{
    /// <summary></summary>
    public partial class Maintain : Entity<Maintain>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}Maintain数据……", typeof(Maintain).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}Maintain数据！", typeof(Maintain).Name);
        //}
        #endregion
        ...
        public static Maintain FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<Maintain> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
