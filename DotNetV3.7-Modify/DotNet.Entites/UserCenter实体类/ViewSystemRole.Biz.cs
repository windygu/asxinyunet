...
{
    /// <summary></summary>
    public partial class ViewSystemRole : Entity<ViewSystemRole>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewSystemRole数据……", typeof(ViewSystemRole).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewSystemRole数据！", typeof(ViewSystemRole).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewSystemRole> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
