...
{
    /// <summary></summary>
    public partial class ViewUserPermission : Entity<ViewUserPermission>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewUserPermission数据……", typeof(ViewUserPermission).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewUserPermission数据！", typeof(ViewUserPermission).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewUserPermission> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
