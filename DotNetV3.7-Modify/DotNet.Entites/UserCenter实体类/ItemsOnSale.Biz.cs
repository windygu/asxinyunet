...
{
    /// <summary></summary>
    public partial class ItemsOnSale : Entity<ItemsOnSale>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsOnSale数据……", typeof(ItemsOnSale).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsOnSale数据！", typeof(ItemsOnSale).Name);
        //}
        #endregion
        ...
        public static ItemsOnSale FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsOnSale> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
