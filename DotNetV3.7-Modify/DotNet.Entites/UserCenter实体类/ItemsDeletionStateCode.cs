...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_DeletionStateCode", true, "Id")]
    [BindTable("ItemsDeletionStateCode", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsDeletionStateCode : IItemsDeletionStateCode
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsDeletionStateCode
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
