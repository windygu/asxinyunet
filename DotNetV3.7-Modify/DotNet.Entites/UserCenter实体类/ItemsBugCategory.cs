...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_BugCategory", true, "Id")]
    [BindTable("ItemsBugCategory", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsBugCategory : IItemsBugCategory
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsBugCategory
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
