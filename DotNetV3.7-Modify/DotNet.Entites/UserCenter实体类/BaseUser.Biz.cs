...
{
    /// <summary></summary>
    public partial class BaseUser : Entity<BaseUser>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseUser数据……", typeof(BaseUser).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseUser数据！", typeof(BaseUser).Name);
        //}
        #endregion
        ...
        public static BaseUser FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseUser> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
