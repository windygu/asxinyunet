...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_OilInstallations", true, "Id")]
    [BindTable("ItemsOilInstallations", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsOilInstallations : IItemsOilInstallations
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsOilInstallations
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
