...
{
    /// <summary></summary>
    public partial class ItemsEnabled : Entity<ItemsEnabled>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsEnabled数据……", typeof(ItemsEnabled).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsEnabled数据！", typeof(ItemsEnabled).Name);
        //}
        #endregion
        ...
        public static ItemsEnabled FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsEnabled> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
