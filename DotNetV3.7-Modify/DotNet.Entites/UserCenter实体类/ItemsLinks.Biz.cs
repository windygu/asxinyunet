...
{
    /// <summary></summary>
    public partial class ItemsLinks : Entity<ItemsLinks>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsLinks数据……", typeof(ItemsLinks).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsLinks数据！", typeof(ItemsLinks).Name);
        //}
        #endregion
        ...
        public static ItemsLinks FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsLinks> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
