...
{
    /// <summary></summary>
    public partial class ItemsOilAlarmFiltering : Entity<ItemsOilAlarmFiltering>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsOilAlarmFiltering数据……", typeof(ItemsOilAlarmFiltering).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsOilAlarmFiltering数据！", typeof(ItemsOilAlarmFiltering).Name);
        //}
        #endregion
        ...
        public static ItemsOilAlarmFiltering FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsOilAlarmFiltering> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
