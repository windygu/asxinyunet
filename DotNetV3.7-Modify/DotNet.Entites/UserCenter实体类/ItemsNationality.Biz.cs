...
{
    /// <summary></summary>
    public partial class ItemsNationality : Entity<ItemsNationality>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsNationality数据……", typeof(ItemsNationality).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsNationality数据！", typeof(ItemsNationality).Name);
        //}
        #endregion
        ...
        public static ItemsNationality FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsNationality> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
