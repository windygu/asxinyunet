...
{
    /// <summary></summary>
    public partial class ItemsRoleCategory : Entity<ItemsRoleCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsRoleCategory数据……", typeof(ItemsRoleCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsRoleCategory数据！", typeof(ItemsRoleCategory).Name);
        //}
        #endregion
        ...
        public static ItemsRoleCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsRoleCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
