...
{
    /// <summary></summary>
    public partial class ViewUserOrganize : Entity<ViewUserOrganize>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewUserOrganize数据……", typeof(ViewUserOrganize).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewUserOrganize数据！", typeof(ViewUserOrganize).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewUserOrganize> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
