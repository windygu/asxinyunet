...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_News", true, "Id")]
    [BindTable("BaseNews", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseNews : IBaseNews
    {
        #region 属性
        private String _Id;
        /// <summary></summary>
        ...
        [BindColumn(2, "FolderId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(4, "FilePath", "", null, "nvarchar(500)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(5, "CategoryCode", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(6, "Source", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn(7, "Introduction", "", null, "nvarchar(500)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn(8, "Keywords", "", null, "nvarchar(500)", 0, 0, true)]
        ...
        [BindColumn(9, "Contents", "", null, "text", 0, 0, false)]
        ...
        [BindColumn(10, "ReadCount", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(11, "FileSize", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(12, "ImageUrl", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [BindColumn(13, "HomePage", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(14, "SubPage", "", null, "int", 10, 0, false)]
        ...
        [BindColumn(15, "AuditStatus", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(21, "CreateUserId", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(22, "CreateBy", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(24, "ModifiedUserId", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(25, "ModifiedBy", "", null, "nvarchar(20)", 0, 0, true)]
    ...
    /// <summary>接口</summary>
    public partial interface IBaseNews
    {
        #region 属性
        /// <summary></summary>
        String Id { get; set; }
