...
{
    /// <summary></summary>
    public partial class ItemsNewsCategory : Entity<ItemsNewsCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsNewsCategory数据……", typeof(ItemsNewsCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsNewsCategory数据！", typeof(ItemsNewsCategory).Name);
        //}
        #endregion
        ...
        public static ItemsNewsCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsNewsCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
