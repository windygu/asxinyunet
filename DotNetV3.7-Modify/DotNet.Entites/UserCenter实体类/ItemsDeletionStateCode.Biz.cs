...
{
    /// <summary></summary>
    public partial class ItemsDeletionStateCode : Entity<ItemsDeletionStateCode>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsDeletionStateCode数据……", typeof(ItemsDeletionStateCode).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsDeletionStateCode数据！", typeof(ItemsDeletionStateCode).Name);
        //}
        #endregion
        ...
        public static ItemsDeletionStateCode FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsDeletionStateCode> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
