...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_OilAlarmFiltering", true, "Id")]
    [BindTable("ItemsOilAlarmFiltering", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsOilAlarmFiltering : IItemsOilAlarmFiltering
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsOilAlarmFiltering
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
