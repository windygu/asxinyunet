...
{
    /// <summary></summary>
    public partial class ItemsDegree : Entity<ItemsDegree>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsDegree数据……", typeof(ItemsDegree).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsDegree数据！", typeof(ItemsDegree).Name);
        //}
        #endregion
        ...
        public static ItemsDegree FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsDegree> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
