...
{
    /// <summary></summary>
    public partial class ItemsLeaveCategory : Entity<ItemsLeaveCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsLeaveCategory数据……", typeof(ItemsLeaveCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsLeaveCategory数据！", typeof(ItemsLeaveCategory).Name);
        //}
        #endregion
        ...
        public static ItemsLeaveCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsLeaveCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
