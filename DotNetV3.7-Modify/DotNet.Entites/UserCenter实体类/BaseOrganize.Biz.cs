...
{
    /// <summary></summary>
    public partial class BaseOrganize : Entity<BaseOrganize>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseOrganize数据……", typeof(BaseOrganize).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseOrganize数据！", typeof(BaseOrganize).Name);
        //}
        #endregion
        ...
        public static BaseOrganize FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseOrganize> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
