...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_PostCategory", true, "Id")]
    [BindTable("ItemsPostCategory", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsPostCategory : IItemsPostCategory
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsPostCategory
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
