...
{
    /// <summary></summary>
    public partial class ItemsUnits : Entity<ItemsUnits>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsUnits数据……", typeof(ItemsUnits).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsUnits数据！", typeof(ItemsUnits).Name);
        //}
        #endregion
        ...
        public static ItemsUnits FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsUnits> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
