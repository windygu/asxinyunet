...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_AllowEdit", true, "Id")]
    [BindTable("ItemsAllowEdit", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsAllowEdit : IItemsAllowEdit
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsAllowEdit
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
