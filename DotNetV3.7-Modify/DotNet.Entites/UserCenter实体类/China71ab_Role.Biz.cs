...
{
    /// <summary></summary>
    public partial class China71ab_Role : Entity<China71ab_Role>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}China71ab_Role数据……", typeof(China71ab_Role).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}China71ab_Role数据！", typeof(China71ab_Role).Name);
        //}
        #endregion
        ...
        public static China71ab_Role FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<China71ab_Role> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
