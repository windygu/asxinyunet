...
{
    /// <summary></summary>
    public partial class ItemsPostCategory : Entity<ItemsPostCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsPostCategory数据……", typeof(ItemsPostCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsPostCategory数据！", typeof(ItemsPostCategory).Name);
        //}
        #endregion
        ...
        public static ItemsPostCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsPostCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
