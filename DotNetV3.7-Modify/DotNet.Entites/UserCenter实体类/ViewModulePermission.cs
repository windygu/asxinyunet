...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("ViewModulePermission", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ViewModulePermission : IViewModulePermission
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(2, "ResourceId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(3, "ResourceCategory", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(4, "PermissionId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(5, "PermissionConstraint", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [BindColumn(6, "Enabled", "", null, "int", 10, 0, false)]
        ...
        [BindColumn(7, "DeletionStateCode", "", null, "int", 10, 0, false)]
        ...
        [BindColumn(9, "CreateOn", "", null, "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(12, "ModifiedOn", "", null, "smalldatetime", 3, 0, false)]
        ...
        public override Object this[String name]
        {
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "PermissionId" : _PermissionId = Convert.ToString(value); break;
    ...
    /// <summary>接口</summary>
    public partial interface IViewModulePermission
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
