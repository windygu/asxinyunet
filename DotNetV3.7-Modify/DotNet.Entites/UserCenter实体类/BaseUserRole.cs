...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_UserRole", true, "Id")]
    [BindTable("BaseUserRole", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseUserRole : IBaseUserRole
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IBaseUserRole
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
