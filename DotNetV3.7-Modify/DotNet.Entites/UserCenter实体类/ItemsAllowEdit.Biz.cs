...
{
    /// <summary></summary>
    public partial class ItemsAllowEdit : Entity<ItemsAllowEdit>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsAllowEdit数据……", typeof(ItemsAllowEdit).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsAllowEdit数据！", typeof(ItemsAllowEdit).Name);
        //}
        #endregion
        ...
        public static ItemsAllowEdit FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsAllowEdit> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
