...
{
    /// <summary></summary>
    public partial class BaseTableColumns : Entity<BaseTableColumns>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseTableColumns数据……", typeof(BaseTableColumns).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseTableColumns数据！", typeof(BaseTableColumns).Name);
        //}
        #endregion
        ...
        public static BaseTableColumns FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseTableColumns> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
