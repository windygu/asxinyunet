...
{
    /// <summary></summary>
    public partial class ItemsHousehold : Entity<ItemsHousehold>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsHousehold数据……", typeof(ItemsHousehold).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsHousehold数据！", typeof(ItemsHousehold).Name);
        //}
        #endregion
        ...
        public static ItemsHousehold FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsHousehold> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
