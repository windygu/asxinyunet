...
{
    /// <summary></summary>
    public partial class ItemsWorkFlowCategories : Entity<ItemsWorkFlowCategories>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsWorkFlowCategories数据……", typeof(ItemsWorkFlowCategories).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsWorkFlowCategories数据！", typeof(ItemsWorkFlowCategories).Name);
        //}
        #endregion
        ...
        public static ItemsWorkFlowCategories FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsWorkFlowCategories> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
