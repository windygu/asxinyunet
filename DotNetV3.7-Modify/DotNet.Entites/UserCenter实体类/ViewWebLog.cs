...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("ViewWebLog", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ViewWebLog : IViewWebLog
    {
        #region 属性
    ...
    /// <summary>接口</summary>
    public partial interface IViewWebLog
    {
        #region 属性
        /// <summary></summary>
        Int32 LogId { get; set; }
