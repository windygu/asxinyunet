...
{
    /// <summary></summary>
    public partial class ItemsEducation : Entity<ItemsEducation>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsEducation数据……", typeof(ItemsEducation).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsEducation数据！", typeof(ItemsEducation).Name);
        //}
        #endregion
        ...
        public static ItemsEducation FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsEducation> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
