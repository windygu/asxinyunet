...
{
    /// <summary></summary>
    public partial class ItemsSystem : Entity<ItemsSystem>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsSystem数据……", typeof(ItemsSystem).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsSystem数据！", typeof(ItemsSystem).Name);
        //}
        #endregion
        ...
        public static ItemsSystem FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsSystem> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
