...
{
    /// <summary></summary>
    public partial class ItemsSendCategory : Entity<ItemsSendCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsSendCategory数据……", typeof(ItemsSendCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsSendCategory数据！", typeof(ItemsSendCategory).Name);
        //}
        #endregion
        ...
        public static ItemsSendCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsSendCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
