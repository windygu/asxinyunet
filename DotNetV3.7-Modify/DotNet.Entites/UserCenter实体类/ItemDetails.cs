...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails", true, "Id")]
    [BindTable("ItemDetails", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemDetails : IItemDetails
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
