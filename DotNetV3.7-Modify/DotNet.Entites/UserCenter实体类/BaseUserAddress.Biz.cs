...
{
    /// <summary></summary>
    public partial class BaseUserAddress : Entity<BaseUserAddress>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseUserAddress数据……", typeof(BaseUserAddress).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseUserAddress数据！", typeof(BaseUserAddress).Name);
        //}
        #endregion
        ...
        public static BaseUserAddress FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseUserAddress> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
