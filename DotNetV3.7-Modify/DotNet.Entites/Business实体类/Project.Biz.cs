...
namespace DotNet.Entites
{
    ...
    public partial class Project : Entity<Project>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}项目数据……", typeof(Project).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}项目数据！", typeof(Project).Name);
        //}
        #endregion
        ...
        //public static EntityList<Project> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
