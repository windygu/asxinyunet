...
namespace DotNet.Entites
{
    ...
    public partial class Base_Comment : Entity<Base_Comment>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}基地InnoDBfree:29696kB;(`post_id`)REFER`wbtoolkit/tbl_post`(`id`)ONDELETECA数据……", typeof(Base_Comment).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}基地InnoDBfree:29696kB;(`post_id`)REFER`wbtoolkit/tbl_post`(`id`)ONDELETECA数据！", typeof(Base_Comment).Name);
        //}
        #endregion
        ...
        public static Base_Comment FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<Base_Comment> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
