...
namespace DotNet.Entites
{
    ...
    public partial class UserByInt : Entity<UserByInt>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}Usersandglobalprivileges由Int数据……", typeof(UserByInt).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}Usersandglobalprivileges由Int数据！", typeof(UserByInt).Name);
        //}
        #endregion
        ...
        public static UserByInt FindByUserId(Int32 userid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<UserByInt> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
