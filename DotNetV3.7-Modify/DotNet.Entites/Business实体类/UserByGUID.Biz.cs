...
namespace DotNet.Entites
{
    ...
    public partial class UserByGUID : Entity<UserByGUID>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}Usersandglobalprivileges由主键一数据……", typeof(UserByGUID).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}Usersandglobalprivileges由主键一数据！", typeof(UserByGUID).Name);
        //}
        #endregion
        ...
        public static UserByGUID FindByUserId(String userid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<UserByGUID> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
