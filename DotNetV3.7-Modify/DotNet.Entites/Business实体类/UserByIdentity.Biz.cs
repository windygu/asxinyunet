...
namespace DotNet.Entites
{
    ...
    public partial class UserByIdentity : Entity<UserByIdentity>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}Usersandglobalprivileges由标识数据……", typeof(UserByIdentity).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}Usersandglobalprivileges由标识数据！", typeof(UserByIdentity).Name);
        //}
        #endregion
        ...
        public static UserByIdentity FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        //public static EntityList<UserByIdentity> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
