...
namespace DotNet.Entites
{
    ...
    public partial class Base_Sequence : Entity<Base_Sequence>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}基地序号数据……", typeof(Base_Sequence).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}基地序号数据！", typeof(Base_Sequence).Name);
        //}
        #endregion
        ...
        public static Base_Sequence FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<Base_Sequence> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
