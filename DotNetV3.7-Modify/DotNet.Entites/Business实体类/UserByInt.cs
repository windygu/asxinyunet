...
{
    /// <summary>Usersandglobalprivileges由Int</summary>
    [Serializable]
    [DataObject]
    [Description("Usersandglobalprivileges由Int")]
    [BindIndex("PK_USERBYINT", true, "UserId")]
    [BindTable("UserByInt", Description = "Usersandglobalprivileges由Int", ConnName = "BusinessDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class UserByInt : IUserByInt
    {
        #region 属性
        ...
        [BindColumn(1, "UserId", "用户编号", null, "int", 10, 0, false)]
        ...
        #region 字段名
        /// <summary>取得Usersandglobalprivileges由Int字段信息的快捷方式</summary>
        public class _
        {
            ///<summary>用户编号</summary>
    ...
    /// <summary>Usersandglobalprivileges由Int接口</summary>
    public partial interface IUserByInt
    {
        #region 属性
        /// <summary>用户编号</summary>
