...
{
    /// <summary></summary>
    public partial class BaseWorkFlowHistory : Entity<BaseWorkFlowHistory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseWorkFlowHistory数据……", typeof(BaseWorkFlowHistory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseWorkFlowHistory数据！", typeof(BaseWorkFlowHistory).Name);
        //}
        #endregion
        ...
        public static BaseWorkFlowHistory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseWorkFlowHistory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
