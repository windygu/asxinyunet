...
{
    /// <summary></summary>
    public partial class ProcurementEquipment : Entity<ProcurementEquipment>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ProcurementEquipment数据……", typeof(ProcurementEquipment).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ProcurementEquipment数据！", typeof(ProcurementEquipment).Name);
        //}
        #endregion
        ...
        public static ProcurementEquipment FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ProcurementEquipment> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
