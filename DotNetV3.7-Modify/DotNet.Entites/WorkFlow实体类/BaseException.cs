...
namespace DotNet.Entites.WorkFlow
{
    ...
    [BindTable("BaseException", Description = "", ConnName = "WorkFlowDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseException : IBaseException
    {
        ...
        [Description("")]
        [DataObjectField(false, false, true, 40)]
        [BindColumn(17, "CreateUserID", "", null, "nvarchar(40)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 40)]
        [BindColumn(18, "CreateBy", "", null, "nvarchar(40)", 0, 0, true)]
