...
{
    /// <summary></summary>
    public partial class WorkFlowUserBill : Entity<WorkFlowUserBill>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}WorkFlowUserBill数据……", typeof(WorkFlowUserBill).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}WorkFlowUserBill数据！", typeof(WorkFlowUserBill).Name);
        //}
        #endregion
        ...
        public static WorkFlowUserBill FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<WorkFlowUserBill> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
