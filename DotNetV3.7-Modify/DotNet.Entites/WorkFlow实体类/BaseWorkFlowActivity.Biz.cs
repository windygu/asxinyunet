...
{
    /// <summary></summary>
    public partial class BaseWorkFlowActivity : Entity<BaseWorkFlowActivity>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseWorkFlowActivity数据……", typeof(BaseWorkFlowActivity).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseWorkFlowActivity数据！", typeof(BaseWorkFlowActivity).Name);
        //}
        #endregion
        ...
        public static BaseWorkFlowActivity FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseWorkFlowActivity> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
