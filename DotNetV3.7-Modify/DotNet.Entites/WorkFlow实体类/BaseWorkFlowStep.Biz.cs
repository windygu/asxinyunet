...
{
    /// <summary></summary>
    public partial class BaseWorkFlowStep : Entity<BaseWorkFlowStep>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseWorkFlowStep数据……", typeof(BaseWorkFlowStep).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseWorkFlowStep数据！", typeof(BaseWorkFlowStep).Name);
        //}
        #endregion
        ...
        public static BaseWorkFlowStep FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseWorkFlowStep> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
