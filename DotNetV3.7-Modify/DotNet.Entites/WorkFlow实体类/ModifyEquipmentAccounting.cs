...
namespace DotNet.Entites.WorkFlow
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_MODIFYEQUIPMENTACCOUNTING", true, "Id")]
    [BindTable("ModifyEquipmentAccounting", Description = "", ConnName = "WorkFlowDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ModifyEquipmentAccounting : IModifyEquipmentAccounting
    {
        #region 属性
        private String _Id;
        /// <summary></summary>
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(10, "MeterName", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(22, "CreateOn", "", null, "datetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(25, "ModifiedOn", "", null, "datetime", 3, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IModifyEquipmentAccounting
    {
        #region 属性
        /// <summary></summary>
        String Id { get; set; }
