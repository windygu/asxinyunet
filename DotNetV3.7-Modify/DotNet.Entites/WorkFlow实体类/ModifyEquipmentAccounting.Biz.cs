...
{
    /// <summary></summary>
    public partial class ModifyEquipmentAccounting : Entity<ModifyEquipmentAccounting>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ModifyEquipmentAccounting数据……", typeof(ModifyEquipmentAccounting).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ModifyEquipmentAccounting数据！", typeof(ModifyEquipmentAccounting).Name);
        //}
        #endregion
        ...
        public static ModifyEquipmentAccounting FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ModifyEquipmentAccounting> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
