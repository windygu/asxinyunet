...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class FrmStaffSelect : BaseForm, IBaseSelectUserForm
    {
        ...
        #region private void DataTableAddColumn() 往　DataTable　里面添加一列
        /// <summary>
        /// 往DataTable里面添加一列
        /// </summary>
        ...
        //    // 设置表主键
        //    DataColumn[] primaryKey = new DataColumn[]{this.DTStaff.Columns[BaseStaffEntity.FieldId]};
        //    this.DTStaff.PrimaryKey = primaryKey;
        //}
        #endregion
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.DTStaff.DefaultView.RowFilter = BaseStaffEntity.FieldUserName + " LIKE '" + search + "'"
