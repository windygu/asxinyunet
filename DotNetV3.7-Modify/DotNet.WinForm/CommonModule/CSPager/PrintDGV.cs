                ...
                if (PageNo == 1) 
                {
                    foreach (DataGridViewColumn GridCol in dgv.Columns)
                    {
                        ...
                        HeaderHeight = (int)(e.Graphics.MeasureString(GridCol.HeaderText,
                                    GridCol.InheritedStyle.Font, tmpWidth).Height) + 15;
                    ...
                    else
                    {
                        ...
                        foreach (DataGridViewCell Cel in GridRow.Cells)
                        {
                                ...
                                ((Type) ColumnTypes[i]).Name == "DataGridViewLinkColumn")
                            {
                                ...
                                if (Cel.Value != null)
                                {
                                    tempString = Cel.Value.ToString();
                                    if (Cel.Value.GetType() == typeof(DateTime))
                                    {
                                        DateTime dt = (DateTime)Cel.Value;
                                        if (dt > Convert.ToDateTime("1/1/1753"))
                                        {
                                            tempString = dt.ToString().Replace("0:00:00", "");
                                        }
                                        else
                                        {
                                            tempString = "";
