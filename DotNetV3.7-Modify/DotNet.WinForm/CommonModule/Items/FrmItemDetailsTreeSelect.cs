    ...
    public partial class FrmItemDetailsTreeSelect : BaseForm
    {
        ...
        public string CurrentEntityId
        {
            get
            {
                ...
                {
                    this.entityId = this.tvItemDetails.SelectedNode.Tag.ToString();
                }
        ...
        private void LoadTreeChildren(TreeNode myTreeNode)
        {
            foreach (DataRow dataRow in this.DTItemDetails.Rows)
            {
                ...
                if ((myTreeNode.Tag == null) || (myTreeNode.Tag.ToString().Length == 0))
                {
                    // 树的根节点加载
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            this.SelectedId = this.tvItemDetails.SelectedNode.Tag.ToString();
