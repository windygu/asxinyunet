...
namespace DotNet.WinForm
{
    ...
    public partial class FrmFolderEdit : BaseForm
    {
        ...
        public override void ShowEntity()
        {
            ...
            if (String.IsNullOrEmpty(folderEntity.ParentId))
            {
                this.ucFolder.OpenId = folderEntity.Id;
            }
            this.ucFolder.CheckMove = true;
            this.txtFolderName.Text = folderEntity.FolderName;
            this.chkEnabled.Checked = folderEntity.Enabled;
        ...
        private BaseFolderEntity GetEntity()
        {
            ...
            folderEntity.Enabled = this.chkEnabled.Checked;
