...
namespace DotNet.WinForm
{
    ...
    public partial class FrmDocumentAdd : BaseForm
    {
        ...
        public override bool SaveEntity()
        {
            ...
            this.EntityId = DotNetService.Instance.FileService.Add(UserInfo, this.FolderId, this.txtFileName.Text, System.Text.Encoding.Default.GetBytes(this.txtContent.Text), this.txtDescription.Text, this.Category, this.chbEnabled.Checked, out statusCode, out statusMessage);
