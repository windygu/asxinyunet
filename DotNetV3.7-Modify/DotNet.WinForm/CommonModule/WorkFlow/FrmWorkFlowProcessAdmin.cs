...
namespace DotNet.WinForm
{
    ...
    public partial class FrmWorkFlowProcessAdmin : BaseForm
    {
        ...
        public FrmWorkFlowProcessAdmin(String organizeID, string organizeFullName) : this()
        {
        }
        ...
        private void BindItemDetails()
        {
            ...
            this.cmbWorkFlowCategory.DisplayMember = BaseNewsEntity.FieldTitle;
            this.cmbWorkFlowCategory.ValueMember = BaseNewsEntity.FieldTitle;
        }
        #endregion
        ...
        //{
        //    BaseInterfaceLogic.DataTableAddColumn(this.DTWorkFlow, "colSelected");
        //}
        #endregion
        ...
        private void SetRowFilter()
        {
            ...
            {
                rowFilter = BaseWorkFlowProcessEntity.FieldCode + " LIKE '" + search + "'"
        ...
        {
            FrmWorkFlowProcessAdd frmWorkFlowAdd = new FrmWorkFlowProcessAdd(null, string.Empty, this.cmbWorkFlowCategory.SelectedValue.ToString());
