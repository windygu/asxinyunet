...
namespace DotNet.WinForm
{
    ...
    public partial class UCAutoWorkFlow : UserControl
    {
        ...
        public delegate bool ButtonAuditPassClickEventHandler(String categoryId, string objectId);
        ...
        private void btnAuditPass_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!this.BeforBtnAuditPassClick(this.CategoryId, this.ObjectId))
                {
                    return;
                }
            }
            if (this.CheckAuditPass())
            {
                ...
                if (this.AuditPass())
                {
                    ...
                    {
                        this.AfterBtnAuditPassClick(this.CategoryId, this.ObjectId);
                    }
                }
            }
        }
