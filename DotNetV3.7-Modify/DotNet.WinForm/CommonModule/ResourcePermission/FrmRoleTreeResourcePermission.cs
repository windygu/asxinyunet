...
namespace DotNet.WinForm
{
    ...
    public partial class FrmRoleTreeResourcePermission : BaseForm
    {
        ...
        private void TargetResourceCheck(TreeNode treeNode)
        {
            if ((treeNode != null) && (treeNode.Tag != null))
            {
                string targetResourceId = treeNode.Tag.ToString();
        ...
        private void tvTargetTreeResource_AfterCheck(object sender, TreeViewEventArgs e)
        {
            if (this.isUserClick)
            {
                if (e.Node.Checked)
                {
                    string[] grantResourceIds = new string[] { e.Node.Tag.ToString() };
                ...
                {
                    string[] revokeResourceIds = new string[] { e.Node.Tag.ToString() };
        ...
        private void ResourceEntityToArray(TreeNode treeNode)
        {
            ...
            {
                // 提高运行速度
                string pesourceId = treeNode.Tag.ToString();
                if (treeNode.Checked)
                {
