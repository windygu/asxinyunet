...
namespace DotNet.WinForm
{
    ...
    {
        private DataTable DTRoleList = new DataTable(BaseRoleEntity.TableName);   // 角色 DataTable
        ...
        public override void GetPermission()
        {
            ...
            this.permissionDelete = this.IsAuthorized("RoleAdmin.Delte");   // 删除权限
        }
        #endregion
        ...
        private void SetSearch()
        {
            ...
            else
            {
                ...
                this.DTRoleList.DefaultView.RowFilter = BaseRoleEntity.FieldRealName + " LIKE '" + search + "'"
        ...
        //{
        //    BaseInterfaceLogic.DataTableAddColumn(this.DTRoleList, "colSelected");
        //}
        #endregion
        ...
        private void mItmEdit_Click(object sender, EventArgs e)
        {
            if (this.tvOrganize.SelectedNode != null)
            {
                ...
                Form frmOrganizeEdit = (Form)Activator.CreateInstance(type, this.tvOrganize.SelectedNode.Tag.ToString());
        ...
        private void mItmAddStaff_Click(object sender, EventArgs e)
        {
            ...
            if (this.tvOrganize.SelectedNode != null)
            {
                ...
                ((IBaseStaffAddForm)frmStaffAdd).CompanyName = companyFullName;
                ((IBaseStaffAddForm)frmStaffAdd).DepartmentId = DepartmentId;
                ((IBaseStaffAddForm)frmStaffAdd).DepartmentName = departmentFullName;
            }
        ...
        private void BatchMove()
        {
            ...
            ((IBaseSelectOrganizeForm)frmOrganizeSelect).PermissionItemScopeCode = this.PermissionItemScopeCode;
            if (frmOrganizeSelect.ShowDialog() == DialogResult.OK)
            {
                ...
                this.FormLoaded = false;
                // 调用事件
                DotNetService.Instance.RoleService.BatchMoveTo(UserInfo, this.GetSelecteIds(), ((IBaseSelectOrganizeForm)frmOrganizeSelect).SelectedId);
                // 绑定屏幕数据
                this.GetRoleList();
                this.FormLoaded = true;
                // 设置鼠标默认状态，原来的光标状态
        ...
        private void SingleMove(string currentEntityId)
        {
            ...
            if (frmOrganizeSelect.ShowDialog() == DialogResult.OK)
            {
                ...
                this.FormLoaded = false;
                // 调用事件
                DotNetService.Instance.RoleService.MoveTo(UserInfo, currentEntityId, ((IBaseSelectOrganizeForm)frmOrganizeSelect).SelectedId);
