...
namespace DotNet.WinForm
{
    ...
    public partial class FrmOrganizeEdit : BaseForm, IBaseOrganizeEditForm
    {
        ...
        private void GetRoleUser()
        {
            ...
            this.GetRoleId(this.btnAssistantLeadership);
            this.GetRoleUser(this.btnAssistantLeadership);
        ...
        private string GetRoleId(Button btnRole)
        {
            ...
            parameters.Add(new KeyValuePair<string, object>(BaseRoleEntity.FieldCode, btnRole.Name.Substring(3)));
        ...
        private void GetRoleUser(Button btnRole)
        {
            if (btnRole.Tag != null)
            {
                ...
                {
                    string txtControlCode = btnRole.Name.Substring(3);
        ...
        private void btnRole_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(roldId))
            {
                ...
                roleEntity.Code = ((Button)sender).Name.Substring(3);
