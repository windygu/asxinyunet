...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class FrmOrganizeSelect : BaseForm, IBaseSelectOrganizeForm
    {
        ...
        //{
        //    BaseInterfaceLogic.DataTableAddColumn(this.DTOrganize, "colSelected");
        //}
        #endregion
        ...
        private void GetOrganizeList()
        {
            ...
            {
                DataTable DTOrganizeList = DotNetService.Instance.OrganizeService.GetDataTableByParent(UserInfo, this.tvOrganize.SelectedNode.Tag.ToString());
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            if (this.CheckInput())
            {
                ...
                if (this.tcOrganizeTree.SelectedIndex == 0)
                {
                    this.SelectedId = this.tvOrganize.SelectedNode.Tag.ToString();
