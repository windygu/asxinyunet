...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class UCPermissionSelect : UserControl, IBaseSelectPermissionForm
    {
        /// <summary>
        /// 当前用户信息
        /// </summary>
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(this.SelectedId))
            {
                ((IBaseSelectPermissionForm)frmPermissionSelect).SelectedId = this.SelectedId;
            }
            if (!String.IsNullOrEmpty(this.OpenId))
            {
                ((IBaseSelectPermissionForm)frmPermissionSelect).OpenId = this.OpenId;
            }
            ((IBaseSelectPermissionForm)frmPermissionSelect).CheckMove = this.CheckMove;
            ((IBaseSelectPermissionForm)frmPermissionSelect).AllowNull = this.AllowNull;
            
            if (frmPermissionSelect.ShowDialog() == DialogResult.OK)
            {
                this.SelectedId = ((IBaseSelectPermissionForm)frmPermissionSelect).SelectedId;
                this.SelectedFullName = ((IBaseSelectPermissionForm)frmPermissionSelect).SelectedFullName;
