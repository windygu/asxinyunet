...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class UCUserSelect : UserControl, IBaseSelectUserForm
    {
        /// <summary>
        /// 当前用户信息
        /// </summary>
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                ((IBaseSelectUserForm)frmUserSelect).OpenId = this.OpenId;
            }
            ((IBaseSelectUserForm)frmUserSelect).AllowNull = this.AllowNull;
            ((IBaseSelectUserForm)frmUserSelect).MultiSelect = this.MultiSelect;
            if (this.MultiSelect && this.SelectedIds != null)
            {
                ((IBaseSelectUserForm)frmUserSelect).SetSelectIds = this.SelectedIds;
            }
            ((IBaseSelectUserForm)frmUserSelect).PermissionItemScopeCode = this.PermissionItemScopeCode;
            if (frmUserSelect.ShowDialog() == DialogResult.OK)
            {
                this.SelectedId = ((IBaseSelectUserForm)frmUserSelect).SelectedId;
                this.SelectedFullName = ((IBaseSelectUserForm)frmUserSelect).SelectedFullName;
                this.txtFullName.Text = ((IBaseSelectUserForm)frmUserSelect).SelectedFullName;
                this.SelectedIds = ((IBaseSelectUserForm)frmUserSelect).SelectedIds;
                if (this.SelectedIndexChanged != null)
                {
                    this.SelectedIndexChanged(this.SelectedId);
                }
