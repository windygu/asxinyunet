...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class UCScopePermissionSelect : UserControl, IBaseSelectScopePermissionForm
    {
        /// <summary>
        /// 当前用户信息
        /// </summary>
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            ((IBaseSelectScopePermissionForm)frmScopePermissionSelect).AllowNull = this.AllowNull;

            if (frmScopePermissionSelect.ShowDialog() == DialogResult.OK)
            {
                this.SelectedId = ((IBaseSelectScopePermissionForm)frmScopePermissionSelect).SelectedId;
                this.SelectedFullName = ((IBaseSelectScopePermissionForm)frmScopePermissionSelect).SelectedFullName;
