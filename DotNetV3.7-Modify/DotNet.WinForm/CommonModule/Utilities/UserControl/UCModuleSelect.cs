...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class UCModuleSelect : UserControl, IBaseSelectModuleForm
    {
        /// <summary>
        /// 当前用户信息
        /// </summary>
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            ((IBaseSelectModuleForm)frmModuleSelect).CheckMove = this.CheckMove;
            ((IBaseSelectModuleForm)frmModuleSelect).AllowNull = this.AllowNull;

            if (frmModuleSelect.ShowDialog() == DialogResult.OK)
            {
                this.SelectedId = ((IBaseSelectModuleForm)frmModuleSelect).SelectedId;
                this.SelectedCode = ((IBaseSelectModuleForm)frmModuleSelect).SelectedCode;
                this.SelectedFullName = ((IBaseSelectModuleForm)frmModuleSelect).SelectedFullName;
