...
namespace DotNet.WinForm
{
    ...
    public partial class FrmRolePermissionScope : BaseForm
    {
        ...
        public FrmRolePermissionScope(string targetRoleId) : this()
        {
        ...
        private void FrmRolePermissionScope_Load(object sender, EventArgs e)
        {
            if (!this.DesignMode)
            {
                // 设置鼠标繁忙状态，并保留原先的状态
        ...
        private void ShowPermissionScope(string[] organizeIds)
        {
            ...
            this.rdbUserSubOrg.Checked = StringUtil.Exists(organizeIds, ((int)PermissionScope.UserSubOrg).ToString());
