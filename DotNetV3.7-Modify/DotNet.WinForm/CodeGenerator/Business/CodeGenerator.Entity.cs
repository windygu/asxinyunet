...
namespace DotNet.WinForm
{
    ...
    {
        public bool BuilderEntity(string outputDirectory, bool overwrite)
        {
            this.postfix = "Entity";
            string fileName = outputDirectory + "\\" + this.project + ".Business\\" + this.project + ".Model\\" + this.className + "Entity.cs";
