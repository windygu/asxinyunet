...
namespace DotNet.WinForm
{
    ...
    {
        public bool BuilderTable(string outputDirectory, bool overwrite)
        {
            this.postfix = "Table";
            string fileName = outputDirectory + "\\" + this.project + ".Business\\" + this.project + ".Model\\" + this.className + "Table.cs";
