...
namespace DotNet.WinForm
{
    ...
    public partial class FrmCodeGenerator : BaseForm
    {
        ...
        private SettingHelper GetSetting()
        {
            ...
            {
                this.txtCompany.Text = "Hairihan TECH";
            }
        ...
        public bool BuilderManager(string outputDirectory, bool overwrite)
        {
            string fileName = outputDirectory + "\\" + this.ProjectName + ".Business\\" + this.ProjectName + ".Manager\\Manager\\" + this.txtClassName.Text + "Manager.cs";
        ...
        private void btnBuilder_Click(object sender, EventArgs e)
        {
            ...
            overwrite = codeGenerator.BuilderTable(this.txtOutput.Text, overwrite);
            overwrite = codeGenerator.BuilderEntity(this.txtOutput.Text, overwrite);
            overwrite = codeGenerator.BuilderManager(this.txtOutput.Text, overwrite, this.CurrentDb);
            overwrite = this.BuilderManager(this.txtOutput.Text, overwrite);
