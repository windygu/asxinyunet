...
namespace DotNet.Utilities
{
    ...
    {
        #region 设定当前软件Id public BaseConfiguration(string softName)
        /// <summary>
        /// 设定当前软件Id
        /// </summary>
        ...
        #region 数据库连接的类型判断 public static DbType GetDbType(string dbType)
        /// <summary>
        /// 数据库连接的类型判断
        /// </summary>
        ...
        #region 配置信息的类型判断 public static ConfigurationCategory GetConfiguration(string configuration)
        /// <summary>
        /// 配置信息的类型判断
        /// </summary>
        ...
        #region 读取配置信息 public static void GetSetting()
        /// <summary>
        /// 读取配置信息
        /// </summary>
