...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server" ID="Head1">
		...
		var OxO833c=[]; function PostBackAction(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style type="text/css">	
			.row { HEIGHT: 22px }
...
<CE:UploadPersistedFile id="InputFile" runat="server"></CE:UploadPersistedFile>
									</td>
								</tr>
								<tr>
									<td style="width:5">
