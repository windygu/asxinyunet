...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		var OxO70fe=[]; function PostBackAction(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style type="text/css">
			.row
			{
...
<CE:UploadPersistedFile id="InputFile" InsertText="ffff" runat="server"></CE:UploadPersistedFile>
									</td>
								</tr>
								<tr>
									<td style="width:8">
