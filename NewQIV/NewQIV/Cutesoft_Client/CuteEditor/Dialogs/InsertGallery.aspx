...
<html>
	<head runat="server">
		...
		<script type="text/javascript" src="Load.ashx?type=dialogscript&file=DialogHead.js"></script>
			...
			var OxO34f3=[]; function Check(Ox12,n){}  ; function showTooltip(Oxa9,obj,Oxaa){}  ; function insert(src){}  ; function delayhidetip(){}  ;
			</script>
			<style type="text/css">	 
			A:link { COLOR: #000099 }	
...
<CE:UploadPersistedFile id="myuploadFile"  runat="server"></CE:UploadPersistedFile>
					</td>
					<td align="left">
