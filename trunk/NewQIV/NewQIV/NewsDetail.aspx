<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsDetail.aspx.cs" Inherits="WebUI.NewsDetail" %>
...
<!-- fwtable fwsrc="news.png" fwpage="页面 1" fwbase="news.jpg" fwstyle="Dreamweaver" fwdocid = "394241400" fwnested="0" -->
  ...
  <tr>
   <td colspan="2" rowspan="7" align="center" style="height:57px; vertical-align:top;"><a href="LabNews.aspx"><img name="news_r3_c1" src="images/news_r3_c1.jpg" width="261" height="57" border="0" id="news_r3_c1" alt="" /></a><a href="ResearchNews.aspx"><br />
  ...
  <tr>
   <td>&nbsp;</td>
   <td rowspan="5" colspan="3" valign="top" id="articleList" style="font-size:16px;">
    
                	        <asp:Literal ID="ArticleDetail" runat="server" 
            OnLoad="ArticleDetail_Load"></asp:Literal>        </td>
   <td>&nbsp;</td>
