...
var OxOfe27=["ondblclick","navtd","shiftKey","style"]; Window_GetElement(window,OxOfe27[0x1],true)[OxOfe27[0x0]]=function (){if(event[OxOfe27[0x2]]){ alert(element[OxOfe27[0x3]].cssText) ;} ;}  ;
</script>
