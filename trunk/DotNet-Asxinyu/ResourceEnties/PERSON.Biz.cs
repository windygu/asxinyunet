...
namespace ResourceEnties
{
    ...
    public partial class PERSON : Entity<PERSON>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}PERSON数据……", typeof(PERSON).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}PERSON数据！", typeof(PERSON).Name);
        //}
        #endregion
        ...
        public static PERSON FindByPERSONID(String personid)
        {
            if (Meta.Count >= 1000)
                ...
                return Meta.Cache.Entities.Find(_.PERSONID, personid);
            // 单对象缓存
        ...
        //public static EntityList<PERSON> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
