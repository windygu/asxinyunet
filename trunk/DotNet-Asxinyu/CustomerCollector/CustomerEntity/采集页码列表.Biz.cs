...
namespace CustomerEntity
{
	...
	public partial class tb_pagelist : Entity<tb_pagelist>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个采集页码列表实体对象用于表单编辑
		/// </summary>
		///<param name="__PageURL">页码网址</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_pagelist FindByKeyForEdit(String __PageURL)
		{
			tb_pagelist entity=Find(new String[]{_.PageURL}, new Object[]{__PageURL});
			if (entity == null)
			{
				entity = new tb_pagelist();
			}
			return entity;
		}     
		#endregion
		...
		public static EntityList<tb_pagelist> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
