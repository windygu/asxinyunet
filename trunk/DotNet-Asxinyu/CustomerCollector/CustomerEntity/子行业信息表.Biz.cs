...
namespace CustomerEntity
{
	...
	public partial class tb_subindustrylist : Entity<tb_subindustrylist>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个子行业信息表实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_subindustrylist FindByKeyForEdit(UInt32 __ID)
		{
			tb_subindustrylist entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new tb_subindustrylist();
			}
			return entity;
		}     
		...
		/// <returns></returns>
		public static tb_subindustrylist FindByID(Int32 __ID)
		{
		...
		public static EntityList<tb_subindustrylist> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
