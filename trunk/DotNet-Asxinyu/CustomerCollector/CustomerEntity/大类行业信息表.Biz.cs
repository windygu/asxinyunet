...
namespace CustomerEntity
{
	...
	public partial class tb_industrylist : Entity<tb_industrylist>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个大类行业信息表实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">行业编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_industrylist FindByKeyForEdit(UInt32 __ID)
		{
			tb_industrylist entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new tb_industrylist();
			}
			return entity;
		}     
		...
		/// <returns></returns>
		public static tb_industrylist FindByID(Int32 __ID)
		{
		...
		public static EntityList<tb_industrylist> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
