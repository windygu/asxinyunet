...
namespace CustomerEntity
{
	...
	public partial class tb_registinfo : Entity<tb_registinfo>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个工商注册信息(认证)实体对象用于表单编辑
		/// </summary>
		///<param name="__RegistrationNo">注册号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_registinfo FindByKeyForEdit(String __RegistrationNo)
		{
			tb_registinfo entity=Find(new String[]{_.RegistrationNo}, new Object[]{__RegistrationNo});
			if (entity == null)
			{
				entity = new tb_registinfo();
			}
			return entity;
		}     
		#endregion
		...
		public static EntityList<tb_registinfo> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
