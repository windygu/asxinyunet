...
namespace NewLife.ServiceLib
{
    ...
    {
        /// <summary>
        /// 结果代码,为0表示正常,非0表示有异常,Message将提供详细的异常信息
        /// </summary>
        ...
        public class SourceTypes
        {
                ...
                get
                {
                    if (_KnowTypes == null)
                    {
                        ...
                        foreach (FieldInfo f in typeof(SourceTypes).GetFields())
                        {
                            ...
                            {
                                types.Add((string)f.GetValue(null));
                            }
                        }
            ...
            /// <summary>
            /// 混合的翻译结果,多个词汇由不同的翻译来源合并得到的
            /// </summary>
            public const string Mixed = "Mixed";
            /// <summary>
            /// 通过翻译条目添加接口添加的,一般会在后续描述明确的添加来源
            /// </summary>
...
#pragma warning restore 618
    ...
    public class TranslateParams
    {
        ...
        public string Text { get; set; }
        /// <summary>
        /// 提交文本是否是多个待翻译的文本,使用\u0000分割的
        /// </summary>
        public string MultiText { get; set; }
        /// <summary>
        /// 是否是多个待翻译的文本,使用\u0000分割的 方便使用的方法
        /// </summary>
        ...
        /// <summary>
        /// 是否始终产生多个单词合并的翻译结果.这个参数将会受OneTrans参数影响,如果已经存在一个翻译的话.
        /// </summary>
        public string Mix { get; set; }
        /// <summary>
        /// 是否始终产生多个单词合并的翻译结果.这个参数将会受OneTrans参数影响,如果已经存在一个翻译的话.方便使用的方法
        /// </summary>
        public bool IsMix
        {
            get { return Mix != null; }
        ...
        /// <summary>
        /// 文本翻译结果是否只需要返回一个翻译条目,即TextTrans.Translations.Count&lt;=1
        /// </summary>
        public string OneTrans { get; set; }
        /// <summary>
        /// 是否只需要返回一个翻译条目 方便使用的方法
        /// </summary>
