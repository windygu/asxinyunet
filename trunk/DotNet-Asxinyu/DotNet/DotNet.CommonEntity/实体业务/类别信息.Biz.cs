...
namespace DotNet.CommonEntity
{
    ...
    public partial class Category : Entity<Category>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}类别信息数据……", typeof(Category).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}类别信息数据！", typeof(Category).Name);
        //}
        #endregion
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Category> FindAllBySystemId(Int32 systemid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Category> FindAllBySystemIdAndName(Int32 systemid, String name)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Category> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
