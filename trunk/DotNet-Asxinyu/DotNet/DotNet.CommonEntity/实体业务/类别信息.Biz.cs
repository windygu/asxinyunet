...
namespace DotNet.CommonEntity
{
    ...
    /// <summary>类别信息</summary>
    public partial class Category<TEntity> : Entity<TEntity> where TEntity : Category<TEntity>, new()
    {
        #region 对象操作﻿
        static Category()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}类别信息数据……", typeof(TEntity).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}类别信息数据！", typeof(TEntity).Name);
        //}
        #endregion
