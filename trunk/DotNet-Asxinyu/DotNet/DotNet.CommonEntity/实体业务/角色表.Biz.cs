...
namespace DotNet.CommonEntity
{
    ...
    public partial class Role : Entity<Role>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}角色表数据！", typeof(Role).Name);
        //}
        #endregion
        ...
        /// <summary>该角色表所对应的组织部门信息表</summary>
        [XmlIgnore]
		...
		/// <summary>该角色表所拥有的用户信息集合</summary>
		[XmlIgnore]
		public EntityList<User> Users
		{
			get
			{
                ...
                {
					_Users = User.FindAllByRoleId(Id);
					Dirtys["Users"] = true;
				}
				return _Users;
			}
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Role> FindAllBySystemId(Int32 systemid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Role> FindAllByOrganizeId(Int32 organizeid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Role> FindAllBySystemIdAndOrganizeId(Int32 systemid, Int32 organizeid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Role> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
