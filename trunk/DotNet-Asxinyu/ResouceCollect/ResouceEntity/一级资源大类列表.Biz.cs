...
namespace ResouceEntity
{
	...
	public partial class tb_fistclasslist : Entity<tb_fistclasslist>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个一级资源大类列表实体对象用于表单编辑
		/// </summary>
		///<param name="__WebURL">网址</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_fistclasslist FindByKeyForEdit(String __WebURL)
		{
			tb_fistclasslist entity=Find(new String[]{_.WebURL}, new Object[]{__WebURL});
			if (entity == null)
			{
				entity = new tb_fistclasslist();
			}
			return entity;
		}     
		#endregion
