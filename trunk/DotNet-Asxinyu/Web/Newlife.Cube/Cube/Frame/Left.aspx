<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Left.aspx.cs" Inherits="Cube_Left" %>
                ...
                <li>
                    ...
                    <ul id='cd_<%# Eval("ID") %>' style="display: none;">
                        <li onmouseover="tdonmouseover(this)" onmouseout="tdonmouseout(this)" onclick="tdselect(this)">
                            ...
                            <a href='../ModelDesigner/ModelTable.aspx?DataModelID=<%# Eval("ID") %>' target="main" style="color: Blue; font-weight: bold;">
                                <b>模型表管理</b></a> </li>
                        <asp:Repeater runat="server" ID="menuItem">
                            <ItemTemplate>
                                <li onmouseover="tdonmouseover(this)" onmouseout="tdonmouseout(this)" onclick="tdselect(this)">
                                    ...
                                    <a href='../ModelDesigner/ModelColumn.aspx?ModelTableID=<%# Eval("ID") %>' target="main"
                                        style="color: Black;">
