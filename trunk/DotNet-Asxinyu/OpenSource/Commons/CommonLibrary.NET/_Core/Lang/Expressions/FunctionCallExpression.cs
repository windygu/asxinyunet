...
{        
    ...
    public class FunctionCallExpression : Expression, IParameterExpression
    {
        ...
        public FunctionCallExpression(string name, List<object> args)
        {
            _isScopeVariable = false;
            _name = name;
            ParamList = args;
        }
        ...
        public override object DoEvaluate()
        {
            ...
            if ( !isNameEmpty && _isScopeVariable)
            {
            ...
            // CASE 3: Variable name internal/external script. "getuser()".            
            else if (!isNameEmpty && !_isScopeVariable)
            {
                Ctx.State.Stack.Push(_name, this);
                called = true;
                result = FunctionHelper.Call(Ctx, _name, this);
            }
