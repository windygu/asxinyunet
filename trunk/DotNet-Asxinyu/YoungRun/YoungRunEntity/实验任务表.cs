...
namespace YoungRunEntity
{
    ...
    
    {
        ...
        [BindColumn(2, "TestTile", "实验名称", null, "varchar(30)", 0, 0, false)]
        public String TestTile
        {
            get { return _TestTile; }
            set { if (OnPropertyChanging("TestTile", value)) { _TestTile = value; OnPropertyChanged("TestTile"); } }
        }
        ...
        [BindColumn(10, "Remark", "备注", null, "varchar(100)", 0, 0, false)]
        ...
        public override Object this[String name]
        {
            get
            {
                ...
                {
                    case "ID" : return _ID;
                    case "TestTile" : return _TestTile;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "TestTile" : _TestTile = Convert.ToString(value); break;
        ...
        public class _
        {
            ...
            ///<summary>实验名称</summary>
            public static readonly FieldItem TestTile = Meta.Table.FindByName("TestTile");
