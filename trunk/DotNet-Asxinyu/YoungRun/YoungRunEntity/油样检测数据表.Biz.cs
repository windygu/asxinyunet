...
namespace YoungRunEntity
{
    ...
    
    {
        ...
        public static tb_oilsampletest FindByKeyForEdit(String id)
        {
            tb_oilsampletest entity = Find(new String[] { _.ID }, new Object[] { id });
            if (entity == null)
            {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static tb_oilsampletest FindByID(String id)
        {
            if (Meta.Count >= 1000)
