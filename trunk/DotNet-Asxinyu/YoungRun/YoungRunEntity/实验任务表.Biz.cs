...
namespace YoungRunEntity
{
    ...
    public partial class tb_TestTask : Entity<tb_TestTask>
    
    {
        ...
        #region 扩展查询
        /// <summary>
        /// 根据主键查询一个实验任务表实体对象用于表单编辑
        /// </summary>
        /// <param name="id">实验编号</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static tb_TestTask FindByKeyForEdit(String id)
        {
            tb_TestTask entity = Find(new String[] { _.ID }, new Object[] { id });
            if (entity == null)
            {
                entity = new tb_TestTask();
            }
            return entity;
        }
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static tb_TestTask FindByID(String id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<tb_TestTask> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
