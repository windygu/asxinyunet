...
namespace YoungRunControl
{
    public partial class AddBtTestData : UserControl, IEntityControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnOK.Location = new System.Drawing.Point(251, 291);
            ...
            this.btnCancle.Location = new System.Drawing.Point(326, 291);
            ...
            this.FormPager.Location = new System.Drawing.Point(6, 289);
            ...
            this.Size = new System.Drawing.Size(410, 323);
        ...
        private void SetControlReSet()
        {
            ...
            if (CutShowMode == FormShowMode.AddOne || CutShowMode == FormShowMode.ContinueAdd)
            {
                ...
                //设置控件清空，并且可用
                //增加数据编号的自动生成绑定
                txtID.Text = YoungRunHelper.GetNextYoungRunDataId(YoungRunDataType.R202);//手动添加
