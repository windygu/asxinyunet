	...
	namespace YoungRunControl.Controls
	{
			...
			public class AddOutSampleTest: UserControl
			{
				#region 自动生成代码
				...
				private void InitializeComponent()
				{
					...
					System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AddOutSampleTest));
					...
					this.FormPager = new DotNet.Tools.Controls.EntityFormPager();
						...
						this.lblDataID.Location = new System.Drawing.Point(6, 64);
						...
						this.txtDataID.Location = new System.Drawing.Point(158, 64);
						this.txtDataID.Name = "txtDataID";
						this.txtDataID.Size = new System.Drawing.Size(150,22);
						this.txtDataID.TabIndex = 4 ;
						this.Controls.Add(this.txtDataID) ;
						
						this.lblSendPersonTP.Location = new System.Drawing.Point(6, 91);
						...
						this.combSendPersonTP.Location = new System.Drawing.Point(158, 91);
						this.combSendPersonTP.Name = "combSendPersonTP";
						this.combSendPersonTP.Size = new System.Drawing.Size(150,22);
						this.combSendPersonTP.TabIndex = 6 ;
						this.Controls.Add(this.combSendPersonTP) ;
						
						this.lblSendDateTime.Location = new System.Drawing.Point(6, 118);
					...
					#endregion
					#region 窗体
					this.Name = "AddOutSampleTest";
					this.Size = new System.Drawing.Size(350, 500);
					this.Load += new System.EventHandler(this.AddAddOutSampleTestLoad);
					this.SuspendLayout();
			...
			#region 构造函数 及初始化
			public AddOutSampleTest()
			{
				InitializeComponent();
			}
			//控件加载事件,完成数据绑定和相关基本设置
			void AddAddOutSampleTestLoad(object sender, EventArgs e)
			{				
			}
			/// <summary>
			/// 初始化设置
			...
			public string CutSearchCondition
			{
				...
				set
				{
					...
					FormPager.RecordCount = tb_OutSampleTest.FindCount(CutSearchCondition,"","",0,0) ;
				}
			}
			/// <summary>
			/// 获取或者设置当前实体
			/// </summary>
			public tb_OutSampleTest CutModel
			{
				get ;set ;
			}
			/// <summary>
			...
			//TODO:有问题，需要根据当前的状态来更新和保存数据
				...
				{
				tb_OutSampleTest model = new tb_OutSampleTest();//定义当前实体
				...
				if(combSendPersonTP.Text.Trim()!=""){
					model.SendPersonTP = combSendPersonTP.Text.Trim() ;}{
						model.SendDateTime = dtSendDateTime.Value ;}
			...
			List <tb_OutSampleTest> modelList ;
			void GetData()
			{				
				//判断不为空，才能绑定				
				modelList = tb_OutSampleTest.FindAll(CutSearchCondition, "", "", (FormPager.PageIndex-1)*FormPager.PageSize ,FormPager.PageSize);
				if (modelList !=null ) {
			...
			private void SetControlReSet()
			{
				...
				if (CutShowMode == FormShowMode.AddOne || CutShowMode== FormShowMode.ContinueAdd )
				{
					...
					txtID.ReadOnly = false ;
							txtID.Text = string.Empty  ; txtOilName.ReadOnly = false ;
							txtOilName.Text = string.Empty  ; txtDataID.ReadOnly = false ;
							txtDataID.Text = string.Empty  ; 
							combSendPersonTP.Enabled = true ;txtRemark.ReadOnly = false ;
			...
			private void SetControlEdit()
			{
				if (CutShowMode== FormShowMode.ContinueDisplay || CutShowMode== FormShowMode.DisplayCurrent ) {
					...
					//控件除主键外都可读
				txtID.ReadOnly = true;
					txtOilName.ReadOnly = false ;
					txtDataID.ReadOnly = false ;combSendPersonTP.Enabled = true ;dtSendDateTime.Enabled = true ;
			...
			private void SetControlReadOnly()
			{
				...
				txtID.ReadOnly = true ;txtOilName.ReadOnly = true ;txtDataID.ReadOnly = true ;
							combSendPersonTP.Enabled = false ;
							
							dtSendDateTime.Enabled = false ;
