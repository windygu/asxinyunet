...
namespace YoungRunControl.Forms
{
	...
	/// tb_ProductFormule
	/// </summary>
	public partial class AddProductFormuleForm : Form
	{
			...
			{
				this.EntityControl = new AddProductFormule();
			this.SuspendLayout();
			// 
			// EntityControl
			// 						
		    ...
		    private AddProductFormule EntityControl;		
		
		public AddProductFormuleForm ()
		{
			InitializeComponent();			
		}
		#endregion
