...
namespace YoungRunControl.Forms
{
	...
	/// tb_OutSampleTest
	/// </summary>
	public partial class AddOutSampleTestForm : Form
	{
			...
			{
				this.EntityControl = new AddOutSampleTest();
			this.SuspendLayout();
			// 
			// EntityControl
			// 						
		    ...
		    private AddOutSampleTest EntityControl;		
		
		public AddOutSampleTestForm ()
		{
			InitializeComponent();			
		}
		#endregion
