...
namespace ResouceEntity
{
    ...
    public partial class tb_resoucepageslist : Entity<tb_resoucepageslist>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}资源列表数据……", typeof(tb_resoucepageslist).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}资源列表数据！", typeof(tb_resoucepageslist).Name);
        //}
        #endregion
        ...
        public static tb_resoucepageslist FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static tb_resoucepageslist FindByPageURL(String pageurl)
        {
            if (Meta.Count >= 1000)
                return Find(_.PageURL, pageurl);
            else // 实体缓存
                return Meta.Cache.Entities.Find(_.PageURL, pageurl);
            // 单对象缓存
            //return Meta.SingleCache[pageurl];
        }
        #endregion
        ...
        //public static EntityList<tb_resoucepageslist> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
