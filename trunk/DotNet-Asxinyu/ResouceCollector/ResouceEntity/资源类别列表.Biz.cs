...
namespace ResouceEntity
{
	...
	public partial class tb_typelist : Entity<tb_typelist>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个资源类别列表实体对象用于表单编辑
		/// </summary>
		///<param name="__URL">网址</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_typelist FindByKeyForEdit(String __URL)
		{
			tb_typelist entity=Find(new String[]{_.URL}, new Object[]{__URL});
			if (entity == null)
			{
				entity = new tb_typelist();
			}
			return entity;
		}     
		#endregion
