...
namespace ResouceEntity
{
    ...
    public partial class tb_fistclasslist : Entity<tb_fistclasslist>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}一级资源大类列表数据……", typeof(tb_fistclasslist).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}一级资源大类列表数据！", typeof(tb_fistclasslist).Name);
        //}
        #endregion
        ...
        public static tb_fistclasslist FindByWebURL(String weburl)
        {
            if (Meta.Count >= 1000)
                return Find(_.WebURL, weburl);
            else // 实体缓存
                return Meta.Cache.Entities.Find(_.WebURL, weburl);
            // 单对象缓存
            //return Meta.SingleCache[weburl];
        }
        #endregion
        ...
        //public static EntityList<tb_fistclasslist> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
