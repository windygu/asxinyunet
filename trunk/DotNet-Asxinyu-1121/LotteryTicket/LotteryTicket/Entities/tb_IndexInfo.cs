...
namespace LotteryTicket
{
    ...
    
    {
        ...
        [Description("所属类")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(3, "ClassName", "所属类", null, "VarChar", 0, 0, false)]
        ...
        [BindColumn(4, "PriorLevel", "优先级", "1", "Long", 10, 0, false)]
        ...
        private Int32 _SuitableType;
        /// <summary>适用类型</summary>
        [DisplayName("适用类型")]
        [Description("适用类型")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(5, "SuitableType", "适用类型", "1", "Long", 10, 0, false)]
        public virtual Int32 SuitableType
        {
            get { return _SuitableType; }
            set { if (OnPropertyChanging("SuitableType", value)) { _SuitableType = value; OnPropertyChanged("SuitableType"); } }
        }
        ...
        [BindColumn(6, "UseExplain", "使用说明", null, "VarChar", 0, 0, false)]
        ...
        [BindColumn(7, "Description", "指标描述", null, "VarChar", 0, 0, false)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "SuitableType" : return _SuitableType;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "SuitableType" : _SuitableType = Convert.ToInt32(value); break;
        ...
        public class _
        {
            ...
            ///<summary>所属类</summary>
            public static readonly FieldItem ClassName = Meta.Table.FindByName("ClassName");

            ///<summary>优先级</summary>
            public static readonly FieldItem PriorLevel = Meta.Table.FindByName("PriorLevel");

            ///<summary>适用类型</summary>
            public static readonly FieldItem SuitableType = Meta.Table.FindByName("SuitableType");
