...
{
	partial class TwoSameInOneForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.zedGraphControl1.Load += new System.EventHandler(this.ZedGraphControl1Load);
			// 
			// TwoSameInOneForm
			// 
			...
			this.Name = "TwoSameInOneForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "一次2个数相同周期";
			this.Load += new System.EventHandler(this.TwoSameInOneFormLoad);
