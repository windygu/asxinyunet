...
namespace DotNet.Authority
{
	...
	public partial class tb_popuauthority : Entity<tb_popuauthority>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个普通权限表实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_popuauthority FindByKeyForEdit(UInt32 __ID)
		{
			tb_popuauthority entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new tb_popuauthority();
			}
			return entity;
		}     
		...
		/// <returns></returns>
		public static tb_popuauthority FindByID(Int32 __ID)
		{
		...
		public static EntityList<tb_popuauthority> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
