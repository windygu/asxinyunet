...
namespace DotNet.Authority
{
	...
	public partial class tb_userinfo : Entity<tb_userinfo>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个用户信息实体对象用于表单编辑
		/// </summary>
		///<param name="__UserName">用户名</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_userinfo FindByKeyForEdit(String __UserName)
		{
			tb_userinfo entity=Find(new String[]{_.UserName}, new Object[]{__UserName});
			if (entity == null)
			{
				entity = new tb_userinfo();
			}
			return entity;
		}     
		...
		/// <returns></returns>
		public static tb_userinfo FindByName(String __Name)
		{
		...
		public static EntityList<tb_userinfo> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
