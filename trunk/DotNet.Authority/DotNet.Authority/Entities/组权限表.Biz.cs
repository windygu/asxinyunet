...
namespace DotNet.Authority
{
	...
	public partial class tb_groupauthority : Entity<tb_groupauthority>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个组权限表实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_groupauthority FindByKeyForEdit(UInt32 __ID)
		{
			tb_groupauthority entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new tb_groupauthority();
			}
			return entity;
		}     
		...
		/// <returns></returns>
		public static tb_groupauthority FindByID(Int32 __ID)
		{
		...
		public static EntityList<tb_groupauthority> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
