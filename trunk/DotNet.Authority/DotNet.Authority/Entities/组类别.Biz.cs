...
namespace DotNet.Authority
{
	...
	public partial class tb_grouplist : Entity<tb_grouplist>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个组类别实体对象用于表单编辑
		/// </summary>
		///<param name="__GroupName">组名称</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_grouplist FindByKeyForEdit(String __GroupName)
		{
			tb_grouplist entity=Find(new String[]{_.GroupName}, new Object[]{__GroupName});
			if (entity == null)
			{
				entity = new tb_grouplist();
			}
			return entity;
		}     
		#endregion
		...
		public static EntityList<tb_grouplist> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
