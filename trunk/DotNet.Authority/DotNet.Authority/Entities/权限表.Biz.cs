...
namespace DotNet.Authority
{
	...
	public partial class tb_authoritylist : Entity<tb_authoritylist>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个权限表实体对象用于表单编辑
		/// </summary>
		///<param name="__AuthorityID">权限编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_authoritylist FindByKeyForEdit(String __AuthorityID)
		{
			tb_authoritylist entity=Find(new String[]{_.AuthorityID}, new Object[]{__AuthorityID});
			if (entity == null)
			{
				entity = new tb_authoritylist();
			}
			return entity;
		}     
		#endregion
		...
		public static EntityList<tb_authoritylist> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
