...
namespace CustomerEntity
{
	...
	[DataObject]
	[Description("子类目信息表")]
	[BindTable("tb_subcategorylist", Description = "子类目信息表", ConnName = "CustomerEntity")]
	public partial class tb_subcategorylist : Entity<tb_subcategorylist>
	{
		#region 属性
		private UInt32 _ID;
		/// <summary>
		...
		private String _CategoryWebSite;
		/// <summary>
		/// 类目网址
		/// </summary>
		[Description("类目网址")]
		[DataObjectField(false, false, true, 65535)]
		[BindColumn("CategoryWebSite", Description = "类目网址", DefaultValue = "", Order = 3)]
		public String CategoryWebSite
		{
			get { return _CategoryWebSite; }
			set { if (OnPropertyChange("CategoryWebSite", value)) _CategoryWebSite = value; }
		}
		...
		[Description("父类子行业名称")]
		[DataObjectField(false, false, true, 30)]
		[BindColumn("SubIndustryName", Description = "父类子行业名称", DefaultValue = "", Order = 4)]
		...
		[Description("行业名称")]
		[DataObjectField(false, false, true, 30)]
		[BindColumn("IndustryName", Description = "行业名称", DefaultValue = "", Order = 5)]
		...
		[BindColumn("RootClassName", Description = "根类别名称", DefaultValue = "", Order = 6)]
		...
		[Description("关键词")]
		[DataObjectField(false, false, true, 65535)]
		[BindColumn("KeyWords", Description = "关键词", DefaultValue = "", Order = 8)]
		...
		public override Object this[String name]
		{
			get
			{
				switch (name)
				{
					...
					case "CategoryWebSite" : return _CategoryWebSite;
			...
			set
			{
				switch (name)
				{
					...
					case "CategoryWebSite" : _CategoryWebSite = Convert.ToString(value); break;
		...
		public class _
		{
			...
			/// 类目网址
			///</summary>
			public const String CategoryWebSite = "CategoryWebSite";
