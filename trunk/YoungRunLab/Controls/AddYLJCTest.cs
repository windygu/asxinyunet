...
namespace YoungRunLab.Controls
{
	...
	/// </summary>
	public partial class AddYLJCTest : UserControl
	{
		public AddYLJCTest()
		{
			InitializeComponent();
			IsFlag = false ;
			dtSendTime.CustomFormat = "yyyy-MM-dd HH:mm:ss";
		}
		bool IsFlag ;
		...
		private void AddOilSampleTest_Load(object sender, EventArgs e)
		{
			if (!DesignMode ) {
				...
				txtOilName.Items.AddRange (YoungRunHelper.GetDicValueList (YoungRunDicType.RawName )) ;
			}
		}
