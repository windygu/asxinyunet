...
namespace DotNet.Business
{
    ...
    public partial class BaseContactEntity
    {
        ...
        public BaseContactEntity GetFrom(DataRow dataRow)
        {
            ...
            this.Content = BaseBusinessLogic.ConvertToString(dataRow[BaseContactEntity.FieldContent]);
        ...
        public BaseContactEntity GetFrom(IDataReader dataReader)
        {
            ...
            this.Content = BaseBusinessLogic.ConvertToString(dataReader[BaseContactEntity.FieldContent]);
