...
namespace DotNet.Business
{
    ...
    public partial class BaseOrganizeEntity
    {
        ...
        public BaseOrganizeEntity GetFrom(DataRow dataRow)
        {
            ...
            this.ParentId = BaseBusinessLogic.ConvertToInt(dataRow[BaseOrganizeEntity.FieldParentId]);
        ...
        public BaseOrganizeEntity GetFrom(IDataReader dataReader)
        {
            ...
            this.ParentId = BaseBusinessLogic.ConvertToInt(dataReader[BaseOrganizeEntity.FieldParentId]);
