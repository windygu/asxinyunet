...
namespace DotNet.Business
{
    ...
    public partial class BaseManager : IBaseManager
    {
        ...
        {
            return DbLogic.GetChildrens(DbHelper, this.CurrentTableName, BaseBusinessLogic.FieldId, parentId, BaseBusinessLogic.FieldParentId, BaseBusinessLogic.FieldSortCode, false);
        }
        #endregion
