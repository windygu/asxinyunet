...
namespace DotNet.Business
{
    ...
    {
        #region public virtual int SetDeleted(object id, bool modifiedUser = false) 删除标志
        /// <summary>
        /// 删除标志
        /// </summary>
        ...
        public virtual int SetDeleted(object id, bool modifiedUser = false)
        {
        ...
        #region public virtual int SetDeleted(object[] ids, bool modifiedUser = false) 批量删除标志
        /// <summary>
        /// 批量删除标志
        /// </summary>
        ...
        /// <returns>影响行数</returns>
        public virtual int SetDeleted(object[] ids, bool modifiedUser = false)
        {
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>(BaseBusinessLogic.FieldDeletionStateCode, 1));
            if (modifiedUser && this.UserInfo != null)
