...
namespace DotNet.Business
{
    ...
    {
        #region public bool UserInRole(BaseUserInfo userInfo, string userId, string roleCode)
        /// <summary>
        /// 用户是否在某个角色里的判断
        /// </summary>
        ...
        public bool UserInRole(BaseUserInfo userInfo, string userId, string roleCode)
        {
            ...
            using (IDbHelper dbHelper = DbHelperFactory.GetHelper(BaseSystemInfo.UserCenterDbType))
            {
                try
                {
                    ...
                    returnValue = userRoleManager.UserIsInRoleByCode(userId, roleCode);
        ...
        #region public DataTable GetRoleDT(BaseUserInfo userInfo) 获取角色列表
        /// <summary>
        /// 获取用户的角色列表
        /// </summary>
        /// <param name="userInfo">用户</param>
        ...
        #region public string[] GetUserRoleIds(BaseUserInfo userInfo, string userId) 获取员工角色列表
        /// <summary>
        /// 获取员工角色列表
        /// </summary>
        /// <param name="userInfo">用户</param>
        ...
        #region public string[] GetAllUserRoleIds(BaseUserInfo userInfo, string userId) 获取员工角色列表
        /// <summary>
        /// 获取员工角色列表
        /// </summary>
        /// <param name="userInfo">用户</param>
        ...
        #region public int AddUserToRole(BaseUserInfo userInfo, string userId, string[] addRoleIds) 员工添加到角色
        /// <summary>
        /// 员工添加到角色
        /// </summary>
        /// <param name="userInfo">用户</param>
