...
namespace DotNet.Business
{
    ...
    public partial class BaseWorkFlowCurrentManager : BaseManager, IBaseManager
    {
        ...
        {
            IWorkFlowManager workFlowManager = new UserBillManager();
            ...
            BaseWorkFlowProcessEntity workFlowProcessEntity = workFlowProcessManager.GetEntity(workFlowId);
            ...
            // workFlowManager = new UserBillManager(this.DbHelper, this.UserInfo);
        ...
        public BaseWorkFlowActivityEntity GetFirstActivityEntity(string workFlowCode, string categoryCode = null)
        {
            ...
            {
                parameters.Add(new KeyValuePair<string, object>(BaseNewsEntity.FieldCategoryCode, categoryCode));
                ...
                BaseNewsEntity newsEntity = new BaseNewsEntity(dt);
                if (!string.IsNullOrEmpty(newsEntity.Id))
                {
                    workFlowCode = this.UserInfo.Id + "_" + newsEntity.Id;
                }
            }
            if (string.IsNullOrEmpty(workFlowCode))
            {
