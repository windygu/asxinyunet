...
namespace DotNet.Business
{
    ...
    /// </author> 
    /// </remarks>
    public partial class UserBillManager : BaseNewsManager, IWorkFlowManager
    {
        ...
        public virtual bool BeforeAutoStatr(string id)
        {
            ...
            if (!(string.IsNullOrEmpty(auditStatus)
                ...
                || auditStatus.Equals(AuditStatus.AuditReject.ToString())
                ))
            {
                return false;
            }
            ...
            /*
            if (!string.IsNullOrEmpty(newsEntity.Source))
            {
                if (newsEntity.Source.Equals("html"))
                {
                    if (newsEntity.Contents.IndexOf("#DayCode#") > 0)
                    {
                        ...
                        newsEntity.Contents = newsEntity.Contents.Replace("#DayCode#", sequenceCode);
