...
namespace DotNet.Business
{
    ...
    public partial class BasePermissionScopeManager : BaseManager, IBaseManager
    {
        ...
        {
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldResourceCategory, baseResourcePermissionScopeEntity.ResourceCategory);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldResourceId, baseResourcePermissionScopeEntity.ResourceId);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldTargetCategory, baseResourcePermissionScopeEntity.TargetCategory);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldTargetId, baseResourcePermissionScopeEntity.TargetId);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldPermissionItemId, baseResourcePermissionScopeEntity.PermissionId);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldPermissionConstraint, baseResourcePermissionScopeEntity.PermissionConstraint);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldStartDate, baseResourcePermissionScopeEntity.StartDate);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldEndDate, baseResourcePermissionScopeEntity.EndDate);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldEnabled, baseResourcePermissionScopeEntity.Enabled);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldDeletionStateCode, baseResourcePermissionScopeEntity.DeletionStateCode);
            sqlBuilder.SetValue(BasePermissionScopeEntity.FieldDescription, baseResourcePermissionScopeEntity.Description);
        }
