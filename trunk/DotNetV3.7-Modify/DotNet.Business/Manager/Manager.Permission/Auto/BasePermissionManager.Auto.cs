...
namespace DotNet.Business
{
    ...
    public partial class BasePermissionManager : BaseManager, IBaseManager
    {
        ...
        {
            sqlBuilder.SetValue(BasePermissionEntity.FieldResourceId, resourcePermissionEntity.ResourceId);
            sqlBuilder.SetValue(BasePermissionEntity.FieldResourceCategory, resourcePermissionEntity.ResourceCategory);
            sqlBuilder.SetValue(BasePermissionEntity.FieldPermissionItemId, resourcePermissionEntity.PermissionId);
            sqlBuilder.SetValue(BasePermissionEntity.FieldPermissionConstraint, resourcePermissionEntity.PermissionConstraint);
            sqlBuilder.SetValue(BasePermissionEntity.FieldEnabled, resourcePermissionEntity.Enabled);
            sqlBuilder.SetValue(BasePermissionEntity.FieldDeletionStateCode, resourcePermissionEntity.DeletionStateCode);
            sqlBuilder.SetValue(BasePermissionEntity.FieldDescription, resourcePermissionEntity.Description);
        }
