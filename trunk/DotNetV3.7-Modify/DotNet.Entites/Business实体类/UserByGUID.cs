...
{
    /// <summary>Usersandglobalprivileges由主键一</summary>
    [Serializable]
    [DataObject]
    [Description("Usersandglobalprivileges由主键一")]
    [BindIndex("PK_USERBYGUID", true, "UserId")]
    [BindTable("UserByGUID", Description = "Usersandglobalprivileges由主键一", ConnName = "BusinessDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class UserByGUID : IUserByGUID
    {
        #region 属性
        ...
        [BindColumn(1, "UserId", "用户编号", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(9, "Enabled", "是否可用", "1", "int", 10, 0, false)]
        ...
        [Description("用户是否删除")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(10, "DeletionStateCode", "用户是否删除", "0", "int", 10, 0, false)]
        ...
        [Description("排序号")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(11, "SortCode", "排序号", null, "int", 10, 0, false)]
        ...
        [BindColumn(12, "Description", "描述", null, "nvarchar(800)", 0, 0, true)]
        ...
        #region 字段名
        /// <summary>取得Usersandglobalprivileges由主键一字段信息的快捷方式</summary>
        public class _
        {
            ///<summary>用户编号</summary>
    ...
    /// <summary>Usersandglobalprivileges由主键一接口</summary>
    public partial interface IUserByGUID
    {
        #region 属性
        /// <summary>用户编号</summary>
