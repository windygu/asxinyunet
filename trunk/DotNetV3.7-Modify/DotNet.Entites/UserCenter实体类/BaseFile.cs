...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_File", true, "Id")]
    [BindTable("BaseFile", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseFile : IBaseFile
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(2, "FolderId", "", null, "nvarchar(40)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(4, "FileName", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [BindColumn(5, "Code", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(6, "FilePath", "", null, "nvarchar(500)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn(9, "ImageUrl", "", null, "nvarchar(500)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn(10, "Keywords", "", null, "nvarchar(500)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(11, "Source", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(12, "HomePage", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(13, "SubPage", "", null, "int", 10, 0, false)]
        ...
        [BindColumn(14, "Contents", "", null, "image", 0, 0, false)]
        ...
        [BindColumn(15, "ReadCount", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(16, "FileSize", "", "0", "int", 10, 0, false)]
        ...
        [BindColumn(17, "AuditStatus", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(18, "Enabled", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(19, "DeletionStateCode", "", "0", "int", 10, 0, false)]
        ...
        [BindColumn(22, "CreateOn", "", "getdate()", "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(23, "CreateUserId", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(24, "CreateBy", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(25, "ModifiedOn", "", "getdate()", "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(26, "ModifiedUserId", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(27, "ModifiedBy", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        public override Object this[String name]
        {
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "Contents" : _Contents = (Byte[])value; break;
    ...
    /// <summary>接口</summary>
    public partial interface IBaseFile
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
