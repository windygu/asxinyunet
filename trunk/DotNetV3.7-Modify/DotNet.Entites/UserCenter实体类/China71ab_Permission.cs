...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_Permission", true, "Id")]
    [BindTable("China71ab_Permission", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class China71ab_Permission : IChina71ab_Permission
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(7, "DeletionStateCode", "", "0", "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IChina71ab_Permission
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
