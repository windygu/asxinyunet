...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ResourcePermission", true, "Id")]
    [BindTable("BasePermission", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BasePermission : IBasePermission
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IBasePermission
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
