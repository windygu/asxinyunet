...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_YesNo", true, "Id")]
    [BindTable("ItemsYesNo", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsYesNo : IItemsYesNo
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsYesNo
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
