...
{
    /// <summary></summary>
    public partial class ItemsPayCategory : Entity<ItemsPayCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsPayCategory数据……", typeof(ItemsPayCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsPayCategory数据！", typeof(ItemsPayCategory).Name);
        //}
        #endregion
        ...
        public static ItemsPayCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsPayCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
