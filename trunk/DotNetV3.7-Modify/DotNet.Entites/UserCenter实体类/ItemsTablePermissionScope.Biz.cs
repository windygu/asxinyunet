...
{
    /// <summary></summary>
    public partial class ItemsTablePermissionScope : Entity<ItemsTablePermissionScope>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsTablePermissionScope数据……", typeof(ItemsTablePermissionScope).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsTablePermissionScope数据！", typeof(ItemsTablePermissionScope).Name);
        //}
        #endregion
        ...
        public static ItemsTablePermissionScope FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsTablePermissionScope> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
