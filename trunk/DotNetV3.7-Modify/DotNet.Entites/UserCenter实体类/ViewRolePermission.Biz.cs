...
{
    /// <summary></summary>
    public partial class ViewRolePermission : Entity<ViewRolePermission>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewRolePermission数据……", typeof(ViewRolePermission).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewRolePermission数据！", typeof(ViewRolePermission).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewRolePermission> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
