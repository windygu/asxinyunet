...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_UserOrganize_1", true, "Id")]
    [BindTable("BaseUserOrganize", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseUserOrganize : IBaseUserOrganize
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(7, "Enabled", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(8, "DeletionStateCode", "", "0", "int", 10, 0, false)]
        ...
        [BindColumn(10, "CreateOn", "", "getdate()", "smalldatetime", 3, 0, false)]
        ...
        [BindColumn(11, "CreateUserId", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(12, "CreateBy", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(13, "ModifiedOn", "", "getdate()", "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(14, "ModifiedUserId", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 20)]
        [BindColumn(15, "ModifiedBy", "", null, "nvarchar(20)", 0, 0, true)]
    ...
    /// <summary>接口</summary>
    public partial interface IBaseUserOrganize
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
