...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_WorkingProperty", true, "Id")]
    [BindTable("ItemsWorkingProperty", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsWorkingProperty : IItemsWorkingProperty
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsWorkingProperty
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
