...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_Disability", true, "Id")]
    [BindTable("ItemsDisability", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsDisability : IItemsDisability
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsDisability
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
