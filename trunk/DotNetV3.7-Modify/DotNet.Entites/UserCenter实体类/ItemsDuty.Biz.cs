...
{
    /// <summary></summary>
    public partial class ItemsDuty : Entity<ItemsDuty>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsDuty数据……", typeof(ItemsDuty).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsDuty数据！", typeof(ItemsDuty).Name);
        //}
        #endregion
        ...
        public static ItemsDuty FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsDuty> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
