...
{
    /// <summary></summary>
    public partial class BaseFolder : Entity<BaseFolder>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseFolder数据……", typeof(BaseFolder).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseFolder数据！", typeof(BaseFolder).Name);
        //}
        #endregion
        ...
        public static BaseFolder FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseFolder> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
