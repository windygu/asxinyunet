...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("BaseLogOnLog", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseLogOnLog : IBaseLogOnLog
    {
        #region 属性
        ...
        [BindColumn(5, "Parameters", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [BindColumn(6, "UserId", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [BindColumn(7, "UserRealName", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [BindColumn(8, "IPAddress", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(9, "UrlReferrer", "", null, "nvarchar(800)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 800)]
        [BindColumn(10, "WebUrl", "", null, "nvarchar(800)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(11, "Description", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [BindColumn(12, "CreateOn", "", null, "smalldatetime", 3, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IBaseLogOnLog
    {
        #region 属性
        /// <summary></summary>
        Int32 LogId { get; set; }
