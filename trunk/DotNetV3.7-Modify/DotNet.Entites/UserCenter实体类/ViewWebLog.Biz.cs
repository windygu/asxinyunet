...
{
    /// <summary></summary>
    public partial class ViewWebLog : Entity<ViewWebLog>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewWebLog数据……", typeof(ViewWebLog).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewWebLog数据！", typeof(ViewWebLog).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewWebLog> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
