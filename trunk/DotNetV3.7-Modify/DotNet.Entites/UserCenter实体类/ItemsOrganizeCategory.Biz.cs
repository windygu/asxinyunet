...
{
    /// <summary></summary>
    public partial class ItemsOrganizeCategory : Entity<ItemsOrganizeCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsOrganizeCategory数据……", typeof(ItemsOrganizeCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsOrganizeCategory数据！", typeof(ItemsOrganizeCategory).Name);
        //}
        #endregion
        ...
        public static ItemsOrganizeCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsOrganizeCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
