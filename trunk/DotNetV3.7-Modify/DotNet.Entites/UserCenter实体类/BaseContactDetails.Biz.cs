...
{
    /// <summary></summary>
    public partial class BaseContactDetails : Entity<BaseContactDetails>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseContactDetails数据……", typeof(BaseContactDetails).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseContactDetails数据！", typeof(BaseContactDetails).Name);
        //}
        #endregion
        ...
        public static BaseContactDetails FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseContactDetails> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
