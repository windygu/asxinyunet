...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_OilEventType_Old", true, "Id")]
    [BindTable("ItemsOilEventType_Old", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsOilEventType_Old : IItemsOilEventType_Old
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsOilEventType_Old
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
