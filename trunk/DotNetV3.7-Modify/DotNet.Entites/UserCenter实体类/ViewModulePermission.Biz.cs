...
{
    /// <summary></summary>
    public partial class ViewModulePermission : Entity<ViewModulePermission>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewModulePermission数据……", typeof(ViewModulePermission).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewModulePermission数据！", typeof(ViewModulePermission).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewModulePermission> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
