...
{
    /// <summary></summary>
    public partial class BasePermission : Entity<BasePermission>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BasePermission数据……", typeof(BasePermission).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BasePermission数据！", typeof(BasePermission).Name);
        //}
        #endregion
        ...
        public static BasePermission FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BasePermission> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
