...
{
    /// <summary></summary>
    public partial class ItemsBugLevel : Entity<ItemsBugLevel>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsBugLevel数据……", typeof(ItemsBugLevel).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsBugLevel数据！", typeof(ItemsBugLevel).Name);
        //}
        #endregion
        ...
        public static ItemsBugLevel FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsBugLevel> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
