...
{
    /// <summary></summary>
    public partial class BaseFile : Entity<BaseFile>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseFile数据……", typeof(BaseFile).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseFile数据！", typeof(BaseFile).Name);
        //}
        #endregion
        ...
        public static BaseFile FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseFile> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
