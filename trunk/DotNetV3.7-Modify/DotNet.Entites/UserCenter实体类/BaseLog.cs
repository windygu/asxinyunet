...
namespace DotNet.Entites
{
    ...
    [BindTable("BaseLog", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseLog : IBaseLog
    {
        ...
        [BindColumn(7, "UserId", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [BindColumn(8, "UserRealName", "", null, "nvarchar(20)", 0, 0, true)]
