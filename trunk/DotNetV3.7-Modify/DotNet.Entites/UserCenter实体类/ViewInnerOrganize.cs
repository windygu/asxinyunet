...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("ViewInnerOrganize", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ViewInnerOrganize : IViewInnerOrganize
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(15, "Layer", "", null, "int", 10, 0, false)]
        ...
        [BindColumn(16, "IsInnerOrganize", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(20, "Enabled", "", null, "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IViewInnerOrganize
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
