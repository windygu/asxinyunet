...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("ViewDuty", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ViewDuty : IViewDuty
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IViewDuty
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
