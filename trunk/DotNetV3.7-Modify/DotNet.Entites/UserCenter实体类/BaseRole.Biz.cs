...
{
    /// <summary></summary>
    public partial class BaseRole : Entity<BaseRole>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseRole数据……", typeof(BaseRole).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseRole数据！", typeof(BaseRole).Name);
        //}
        #endregion
        ...
        public static BaseRole FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseRole> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
