...
{
    /// <summary></summary>
    public partial class BaseComment : Entity<BaseComment>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseComment数据……", typeof(BaseComment).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseComment数据！", typeof(BaseComment).Name);
        //}
        #endregion
        ...
        public static BaseComment FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseComment> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
