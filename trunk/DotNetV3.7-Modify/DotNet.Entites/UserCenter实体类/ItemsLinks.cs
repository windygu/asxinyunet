...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_Links", true, "Id")]
    [BindTable("ItemsLinks", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsLinks : IItemsLinks
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(6, "IsPublic", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(10, "SortCode", "", null, "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IItemsLinks
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
