...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_Items", true, "Id")]
    [BindTable("BaseItems", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseItems : IBaseItems
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(5, "TargetTable", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        private Int32 _IsTree;
        /// <summary></summary>
        [DisplayName("IsTree")]
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(6, "IsTree", "", "0", "int", 10, 0, false)]
        public virtual Int32 IsTree
        {
            get { return _IsTree; }
            set { if (OnPropertyChanging("IsTree", value)) { _IsTree = value; OnPropertyChanged("IsTree"); } }
        }

        private String _UseItemCode;
        /// <summary></summary>
        [DisplayName("UseItemCode")]
        [Description("")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(7, "UseItemCode", "", "编号", "nvarchar(50)", 0, 0, true)]
        public virtual String UseItemCode
        {
            get { return _UseItemCode; }
            set { if (OnPropertyChanging("UseItemCode", value)) { _UseItemCode = value; OnPropertyChanged("UseItemCode"); } }
        }

        private String _UseItemName;
        /// <summary></summary>
        [DisplayName("UseItemName")]
        [Description("")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(8, "UseItemName", "", "名称", "nvarchar(50)", 0, 0, true)]
        public virtual String UseItemName
        {
            get { return _UseItemName; }
            set { if (OnPropertyChanging("UseItemName", value)) { _UseItemName = value; OnPropertyChanged("UseItemName"); } }
        }

        private String _UseItemValue;
        /// <summary></summary>
        [DisplayName("UseItemValue")]
        [Description("")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(9, "UseItemValue", "", "值", "nvarchar(50)", 0, 0, true)]
        public virtual String UseItemValue
        {
            get { return _UseItemValue; }
            set { if (OnPropertyChanging("UseItemValue", value)) { _UseItemValue = value; OnPropertyChanged("UseItemValue"); } }
        }
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(11, "AllowEdit", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(12, "AllowDelete", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(14, "SortCode", "", null, "int", 10, 0, false)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "IsTree" : return _IsTree;
                    case "UseItemCode" : return _UseItemCode;
                    case "UseItemName" : return _UseItemName;
                    case "UseItemValue" : return _UseItemValue;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "IsTree" : _IsTree = Convert.ToInt32(value); break;
                    case "UseItemCode" : _UseItemCode = Convert.ToString(value); break;
                    case "UseItemName" : _UseItemName = Convert.ToString(value); break;
                    case "UseItemValue" : _UseItemValue = Convert.ToString(value); break;
        ...
        public class _
        {
            ...
            ///<summary></summary>
            public static readonly Field IsTree = FindByName("IsTree");

            ///<summary></summary>
            public static readonly Field UseItemCode = FindByName("UseItemCode");

            ///<summary></summary>
            public static readonly Field UseItemName = FindByName("UseItemName");

            ///<summary></summary>
            public static readonly Field UseItemValue = FindByName("UseItemValue");
    ...
    /// <summary>接口</summary>
    public partial interface IBaseItems
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
        ...
        /// <summary></summary>
        Int32 IsTree { get; set; }

        /// <summary></summary>
        String UseItemCode { get; set; }

        /// <summary></summary>
        String UseItemName { get; set; }

        /// <summary></summary>
        String UseItemValue { get; set; }
