...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_Project", true, "Id")]
    [BindTable("BaseProject", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseProject : IBaseProject
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(3, "Realname", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(4, "Category", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(5, "AllowEdit", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(6, "AllowDelete", "", "1", "int", 10, 0, false)]
        ...
        [BindColumn(7, "SortCode", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(9, "Enabled", "", "1", "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IBaseProject
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
