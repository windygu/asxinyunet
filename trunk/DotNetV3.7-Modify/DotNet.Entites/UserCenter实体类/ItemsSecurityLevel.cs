...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_SecurityLevel", true, "Id")]
    [BindTable("ItemsSecurityLevel", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsSecurityLevel : IItemsSecurityLevel
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsSecurityLevel
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
