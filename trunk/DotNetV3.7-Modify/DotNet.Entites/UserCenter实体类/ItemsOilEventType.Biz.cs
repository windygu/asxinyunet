...
{
    /// <summary></summary>
    public partial class ItemsOilEventType : Entity<ItemsOilEventType>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsOilEventType数据……", typeof(ItemsOilEventType).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsOilEventType数据！", typeof(ItemsOilEventType).Name);
        //}
        #endregion
        ...
        public static ItemsOilEventType FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsOilEventType> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
