...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_Duty", true, "Id")]
    [BindTable("ItemsDuty", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsDuty : IItemsDuty
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsDuty
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
