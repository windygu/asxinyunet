...
{
    /// <summary></summary>
    public partial class BaseStaffOrganize : Entity<BaseStaffOrganize>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseStaffOrganize数据……", typeof(BaseStaffOrganize).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseStaffOrganize数据！", typeof(BaseStaffOrganize).Name);
        //}
        #endregion
        ...
        public static BaseStaffOrganize FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseStaffOrganize> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
