...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_OilEventGroup", true, "Id")]
    [BindTable("ItemsOilEventGroup", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsOilEventGroup : IItemsOilEventGroup
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(9, "IsPublic", "", null, "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IItemsOilEventGroup
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
