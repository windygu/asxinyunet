...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_Role", true, "Id")]
    [BindTable("BaseRole", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseRole : IBaseRole
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IBaseRole
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
