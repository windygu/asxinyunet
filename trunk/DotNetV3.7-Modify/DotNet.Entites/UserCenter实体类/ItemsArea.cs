...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_Area", true, "Id")]
    [BindTable("ItemsArea", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsArea : IItemsArea
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(3, "ItemCode", "", null, "varchar(50)", 0, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(4, "ItemName", "", null, "varchar(50)", 0, 0, false)]
        ...
        private Int32 _PostageFee;
        /// <summary></summary>
        [DisplayName("PostageFee")]
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(6, "PostageFee", "", "0", "int", 10, 0, false)]
        public virtual Int32 PostageFee
        {
            get { return _PostageFee; }
            set { if (OnPropertyChanging("PostageFee", value)) { _PostageFee = value; OnPropertyChanged("PostageFee"); } }
        }

        private Int32 _DeliveryPostageFee;
        /// <summary></summary>
        [DisplayName("DeliveryPostageFee")]
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(7, "DeliveryPostageFee", "", "0", "int", 10, 0, false)]
        public virtual Int32 DeliveryPostageFee
        {
            get { return _DeliveryPostageFee; }
            set { if (OnPropertyChanging("DeliveryPostageFee", value)) { _DeliveryPostageFee = value; OnPropertyChanged("DeliveryPostageFee"); } }
        }
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(8, "Enabled", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(9, "AllowEdit", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(10, "AllowDelete", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(11, "IsPublic", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(12, "DeletionStateCode", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(13, "SortCode", "", null, "int", 10, 0, false)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "PostageFee" : return _PostageFee;
                    case "DeliveryPostageFee" : return _DeliveryPostageFee;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "PostageFee" : _PostageFee = Convert.ToInt32(value); break;
                    case "DeliveryPostageFee" : _DeliveryPostageFee = Convert.ToInt32(value); break;
        ...
        public class _
        {
            ...
            ///<summary></summary>
            public static readonly Field PostageFee = FindByName("PostageFee");

            ///<summary></summary>
            public static readonly Field DeliveryPostageFee = FindByName("DeliveryPostageFee");
    ...
    /// <summary>接口</summary>
    public partial interface IItemsArea
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
        ...
        /// <summary></summary>
        Int32 PostageFee { get; set; }

        /// <summary></summary>
        Int32 DeliveryPostageFee { get; set; }
