...
{
    /// <summary></summary>
    public partial class ItemsOilEventGroup : Entity<ItemsOilEventGroup>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsOilEventGroup数据……", typeof(ItemsOilEventGroup).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsOilEventGroup数据！", typeof(ItemsOilEventGroup).Name);
        //}
        #endregion
        ...
        public static ItemsOilEventGroup FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsOilEventGroup> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
