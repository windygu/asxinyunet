...
{
    /// <summary></summary>
    public partial class ItemsOilEventType_Old : Entity<ItemsOilEventType_Old>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsOilEventType_Old数据……", typeof(ItemsOilEventType_Old).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsOilEventType_Old数据！", typeof(ItemsOilEventType_Old).Name);
        //}
        #endregion
        ...
        public static ItemsOilEventType_Old FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsOilEventType_Old> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
