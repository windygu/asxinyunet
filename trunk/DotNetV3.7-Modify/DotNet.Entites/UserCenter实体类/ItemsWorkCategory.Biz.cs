...
{
    /// <summary></summary>
    public partial class ItemsWorkCategory : Entity<ItemsWorkCategory>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsWorkCategory数据……", typeof(ItemsWorkCategory).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsWorkCategory数据！", typeof(ItemsWorkCategory).Name);
        //}
        #endregion
        ...
        public static ItemsWorkCategory FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsWorkCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
