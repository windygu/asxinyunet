...
{
    /// <summary></summary>
    public partial class BaseItems : Entity<BaseItems>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseItems数据……", typeof(BaseItems).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseItems数据！", typeof(BaseItems).Name);
        //}
        #endregion
        ...
        public static BaseItems FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseItems> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
