...
{
    /// <summary></summary>
    public partial class ItemsCondition : Entity<ItemsCondition>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsCondition数据……", typeof(ItemsCondition).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsCondition数据！", typeof(ItemsCondition).Name);
        //}
        #endregion
        ...
        public static ItemsCondition FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsCondition> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
