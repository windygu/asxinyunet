...
{
    /// <summary></summary>
    public partial class ItemsAllowDelete : Entity<ItemsAllowDelete>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsAllowDelete数据……", typeof(ItemsAllowDelete).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsAllowDelete数据！", typeof(ItemsAllowDelete).Name);
        //}
        #endregion
        ...
        public static ItemsAllowDelete FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsAllowDelete> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
