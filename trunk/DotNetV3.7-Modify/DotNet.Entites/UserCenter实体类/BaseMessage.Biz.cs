...
{
    /// <summary></summary>
    public partial class BaseMessage : Entity<BaseMessage>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseMessage数据……", typeof(BaseMessage).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseMessage数据！", typeof(BaseMessage).Name);
        //}
        #endregion
        ...
        public static BaseMessage FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseMessage> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
