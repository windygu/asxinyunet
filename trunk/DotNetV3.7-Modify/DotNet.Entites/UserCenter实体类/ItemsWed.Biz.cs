...
{
    /// <summary></summary>
    public partial class ItemsWed : Entity<ItemsWed>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsWed数据……", typeof(ItemsWed).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsWed数据！", typeof(ItemsWed).Name);
        //}
        #endregion
        ...
        public static ItemsWed FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsWed> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
