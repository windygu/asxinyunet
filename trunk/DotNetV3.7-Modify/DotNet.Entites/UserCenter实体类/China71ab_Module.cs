...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_China71ab_Module", true, "Id")]
    [BindTable("China71ab_Module", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class China71ab_Module : IChina71ab_Module
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [Description("")]
        [DataObjectField(false, false, true, 100)]
        [BindColumn(9, "Target", "", null, "nvarchar(100)", 0, 0, true)]
    ...
    /// <summary>接口</summary>
    public partial interface IChina71ab_Module
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
