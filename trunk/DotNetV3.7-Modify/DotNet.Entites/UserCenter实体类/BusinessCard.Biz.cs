...
{
    /// <summary></summary>
    public partial class BusinessCard : Entity<BusinessCard>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BusinessCard数据……", typeof(BusinessCard).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BusinessCard数据！", typeof(BusinessCard).Name);
        //}
        #endregion
        ...
        public static BusinessCard FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BusinessCard> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
