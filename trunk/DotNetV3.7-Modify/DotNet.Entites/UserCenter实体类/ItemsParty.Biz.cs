...
{
    /// <summary></summary>
    public partial class ItemsParty : Entity<ItemsParty>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsParty数据……", typeof(ItemsParty).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsParty数据！", typeof(ItemsParty).Name);
        //}
        #endregion
        ...
        public static ItemsParty FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsParty> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
