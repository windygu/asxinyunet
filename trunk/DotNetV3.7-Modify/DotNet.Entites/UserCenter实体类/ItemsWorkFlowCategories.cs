...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ItemDetails_WorkFlowCategories", true, "Id")]
    [BindTable("ItemsWorkFlowCategories", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsWorkFlowCategories : IItemsWorkFlowCategories
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(3, "ItemCode", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(4, "ItemName", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(5, "ItemValue", "", null, "nvarchar(200)", 0, 0, true)]
    ...
    /// <summary>接口</summary>
    public partial interface IItemsWorkFlowCategories
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
