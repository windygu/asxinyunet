...
{
    /// <summary></summary>
    public partial class ItemsTitle : Entity<ItemsTitle>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsTitle数据……", typeof(ItemsTitle).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsTitle数据！", typeof(ItemsTitle).Name);
        //}
        #endregion
        ...
        public static ItemsTitle FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsTitle> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
