...
{
    /// <summary></summary>
    public partial class ItemsExpress : Entity<ItemsExpress>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsExpress数据……", typeof(ItemsExpress).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsExpress数据！", typeof(ItemsExpress).Name);
        //}
        #endregion
        ...
        public static ItemsExpress FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsExpress> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
