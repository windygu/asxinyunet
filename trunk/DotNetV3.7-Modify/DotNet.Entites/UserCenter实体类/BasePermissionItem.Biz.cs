...
{
    /// <summary></summary>
    public partial class BasePermissionItem : Entity<BasePermissionItem>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BasePermissionItem数据……", typeof(BasePermissionItem).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BasePermissionItem数据！", typeof(BasePermissionItem).Name);
        //}
        #endregion
        ...
        public static BasePermissionItem FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BasePermissionItem> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
