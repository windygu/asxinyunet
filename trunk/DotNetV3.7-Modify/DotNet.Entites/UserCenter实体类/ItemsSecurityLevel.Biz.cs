...
{
    /// <summary></summary>
    public partial class ItemsSecurityLevel : Entity<ItemsSecurityLevel>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsSecurityLevel数据……", typeof(ItemsSecurityLevel).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsSecurityLevel数据！", typeof(ItemsSecurityLevel).Name);
        //}
        #endregion
        ...
        public static ItemsSecurityLevel FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsSecurityLevel> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
