...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_TablePermissionScope", true, "Id")]
    [BindTable("ItemsTablePermissionScope", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsTablePermissionScope : IItemsTablePermissionScope
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsTablePermissionScope
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
