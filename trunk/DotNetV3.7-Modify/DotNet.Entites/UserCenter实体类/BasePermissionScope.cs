...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_ResourcePermissionScope", true, "Id")]
    [BindTable("BasePermissionScope", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BasePermissionScope : IBasePermissionScope
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(2, "ResourceCategory", "", null, "nvarchar(50)", 0, 0, true)]
        public virtual String ResourceCategory
        {
            get { return _ResourceCategory; }
            set { if (OnPropertyChanging("ResourceCategory", value)) { _ResourceCategory = value; OnPropertyChanged("ResourceCategory"); } }
        }
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(3, "ResourceId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        /// <summary></summary>
        [DisplayName("TargetCategory")]
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(4, "TargetCategory", "", null, "nvarchar(50)", 0, 0, true)]
        public virtual String TargetCategory
        {
            get { return _TargetCategory; }
            set { if (OnPropertyChanging("TargetCategory", value)) { _TargetCategory = value; OnPropertyChanged("TargetCategory"); } }
        }
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(5, "TargetId", "", null, "nvarchar(50)", 0, 0, true)]
        public virtual String TargetId
        {
            get { return _TargetId; }
            set { if (OnPropertyChanging("TargetId", value)) { _TargetId = value; OnPropertyChanged("TargetId"); } }
        }
        ...
        [BindColumn(6, "PermissionId", "", null, "int", 10, 0, false)]
        ...
        /// <summary></summary>
        [DisplayName("PermissionConstraint")]
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(7, "PermissionConstraint", "", null, "nvarchar(200)", 0, 0, true)]
        public virtual String PermissionConstraint
        {
            get { return _PermissionConstraint; }
            set { if (OnPropertyChanging("PermissionConstraint", value)) { _PermissionConstraint = value; OnPropertyChanged("PermissionConstraint"); } }
        }
        ...
        [BindColumn(8, "StartDate", "", null, "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(9, "EndDate", "", null, "smalldatetime", 3, 0, false)]
        ...
        [BindColumn(10, "Enabled", "", "1", "int", 10, 0, false)]
        ...
        public override Object this[String name]
        {
            get
            {
                ...
                {
                    case "Id" : return _Id;
                    case "ResourceCategory" : return _ResourceCategory;
                    case "ResourceId" : return _ResourceId;
                    case "TargetCategory" : return _TargetCategory;
                    case "TargetId" : return _TargetId;
                    case "PermissionId" : return _PermissionId;
                    case "PermissionConstraint" : return _PermissionConstraint;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "ResourceCategory" : _ResourceCategory = Convert.ToString(value); break;
                    case "ResourceId" : _ResourceId = Convert.ToString(value); break;
                    case "TargetCategory" : _TargetCategory = Convert.ToString(value); break;
                    case "TargetId" : _TargetId = Convert.ToString(value); break;
                    case "PermissionId" : _PermissionId = Convert.ToInt32(value); break;
                    case "PermissionConstraint" : _PermissionConstraint = Convert.ToString(value); break;
        ...
        public class _
        {
            ...
            ///<summary></summary>
            public static readonly Field ResourceCategory = FindByName("ResourceCategory");

            ///<summary></summary>
            public static readonly Field ResourceId = FindByName("ResourceId");

            ///<summary></summary>
            public static readonly Field TargetCategory = FindByName("TargetCategory");
            ...
            ///<summary></summary>
            public static readonly Field PermissionConstraint = FindByName("PermissionConstraint");
    ...
    /// <summary>接口</summary>
    public partial interface IBasePermissionScope
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
        ...
        /// <summary></summary>
        String PermissionConstraint { get; set; }
