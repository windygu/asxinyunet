...
{
    /// <summary></summary>
    public partial class BaseContact : Entity<BaseContact>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseContact数据……", typeof(BaseContact).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseContact数据！", typeof(BaseContact).Name);
        //}
        #endregion
        ...
        public static BaseContact FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseContact> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
