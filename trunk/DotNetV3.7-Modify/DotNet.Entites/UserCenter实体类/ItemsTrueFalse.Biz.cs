...
{
    /// <summary></summary>
    public partial class ItemsTrueFalse : Entity<ItemsTrueFalse>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsTrueFalse数据……", typeof(ItemsTrueFalse).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsTrueFalse数据！", typeof(ItemsTrueFalse).Name);
        //}
        #endregion
        ...
        public static ItemsTrueFalse FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsTrueFalse> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
