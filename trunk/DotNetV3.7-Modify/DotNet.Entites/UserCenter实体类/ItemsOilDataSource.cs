...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_OilDataSource", true, "Id")]
    [BindTable("ItemsOilDataSource", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsOilDataSource : IItemsOilDataSource
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsOilDataSource
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
