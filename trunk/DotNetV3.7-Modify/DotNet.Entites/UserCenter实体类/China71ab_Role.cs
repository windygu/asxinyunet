...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_China71ab_Role", true, "Id")]
    [BindTable("China71ab_Role", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class China71ab_Role : IChina71ab_Role
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [BindColumn(6, "Realname", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(9, "IsVisible", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(10, "SortCode", "", "0", "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IChina71ab_Role
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
