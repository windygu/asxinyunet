...
{
    /// <summary></summary>
    public partial class BaseModule : Entity<BaseModule>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseModule数据……", typeof(BaseModule).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseModule数据！", typeof(BaseModule).Name);
        //}
        #endregion
        ...
        public static BaseModule FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseModule> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
