...
{
    /// <summary></summary>
    public partial class BaseException : Entity<BaseException>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseException数据……", typeof(BaseException).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseException数据！", typeof(BaseException).Name);
        //}
        #endregion
        ...
        #region 扩展查询﻿
        /// <summary>根据LogId查找</summary>
        /// <param name="logid"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static BaseException FindByLogId(String logid)
        {
            if (Meta.Count >= 1000)
                return Find(_.LogId, logid);
            else // 实体缓存
                return Meta.Cache.Entities.Find(_.LogId, logid);
            // 单对象缓存
        ...
        //public static EntityList<BaseException> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
