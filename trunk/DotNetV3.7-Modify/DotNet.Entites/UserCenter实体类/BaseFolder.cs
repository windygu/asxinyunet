...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_Folder", true, "Id")]
    [BindTable("BaseFolder", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseFolder : IBaseFolder
    {
        #region 属性
        private String _Id;
        /// <summary></summary>
        ...
        [BindColumn(3, "FolderName", "", null, "nvarchar(200)", 0, 0, true)]
        public virtual String FolderName
        {
            get { return _FolderName; }
            set { if (OnPropertyChanging("FolderName", value)) { _FolderName = value; OnPropertyChanged("FolderName"); } }
        }
        ...
        [Description("")]
        [DataObjectField(false, false, true, 40)]
        [BindColumn(4, "StateCode", "", null, "nvarchar(40)", 0, 0, true)]
        ...
        [BindColumn(5, "SortCode", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(6, "AllowEdit", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(7, "AllowDelete", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(9, "DeletionStateCode", "", "0", "int", 10, 0, false)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "FolderName" : return _FolderName;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "FolderName" : _FolderName = Convert.ToString(value); break;
                    case "StateCode" : _StateCode = Convert.ToString(value); break;
        ...
        public class _
        {
            ...
            ///<summary></summary>
            public static readonly Field FolderName = FindByName("FolderName");
    ...
    /// <summary>接口</summary>
    public partial interface IBaseFolder
    {
        #region 属性
        /// <summary></summary>
        String Id { get; set; }
