...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Water_ItemDetails_SalaryItemCategory", true, "Id")]
    [BindTable("ItemsSalaryItemCategory", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsSalaryItemCategory : IItemsSalaryItemCategory
    {
        #region 属性
        private String _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsSalaryItemCategory
    {
        #region 属性
        /// <summary></summary>
        String Id { get; set; }
