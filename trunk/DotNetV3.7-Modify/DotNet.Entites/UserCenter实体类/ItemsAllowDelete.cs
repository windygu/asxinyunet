...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_AllowDelete", true, "Id")]
    [BindTable("ItemsAllowDelete", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsAllowDelete : IItemsAllowDelete
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsAllowDelete
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
