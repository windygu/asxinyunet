...
{
    /// <summary></summary>
    public partial class BaseParameter : Entity<BaseParameter>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseParameter数据……", typeof(BaseParameter).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseParameter数据！", typeof(BaseParameter).Name);
        //}
        #endregion
        ...
        public static BaseParameter FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseParameter> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
