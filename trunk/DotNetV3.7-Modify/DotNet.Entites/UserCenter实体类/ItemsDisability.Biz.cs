...
{
    /// <summary></summary>
    public partial class ItemsDisability : Entity<ItemsDisability>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsDisability数据……", typeof(ItemsDisability).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsDisability数据！", typeof(ItemsDisability).Name);
        //}
        #endregion
        ...
        public static ItemsDisability FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsDisability> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
