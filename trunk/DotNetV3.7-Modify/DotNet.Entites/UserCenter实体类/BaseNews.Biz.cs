...
{
    /// <summary></summary>
    public partial class BaseNews : Entity<BaseNews>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseNews数据……", typeof(BaseNews).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseNews数据！", typeof(BaseNews).Name);
        //}
        #endregion
        ...
        public static BaseNews FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseNews> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
