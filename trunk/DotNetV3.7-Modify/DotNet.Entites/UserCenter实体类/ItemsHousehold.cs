...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_Household", true, "Id")]
    [BindTable("ItemsHousehold", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsHousehold : IItemsHousehold
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsHousehold
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
