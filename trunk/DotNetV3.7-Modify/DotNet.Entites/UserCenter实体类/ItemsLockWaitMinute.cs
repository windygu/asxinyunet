...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_LockWaitMinute", true, "Id")]
    [BindTable("ItemsLockWaitMinute", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsLockWaitMinute : IItemsLockWaitMinute
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsLockWaitMinute
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
