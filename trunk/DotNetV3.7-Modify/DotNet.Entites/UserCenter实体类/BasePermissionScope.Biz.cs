...
{
    /// <summary></summary>
    public partial class BasePermissionScope : Entity<BasePermissionScope>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BasePermissionScope数据……", typeof(BasePermissionScope).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BasePermissionScope数据！", typeof(BasePermissionScope).Name);
        //}
        #endregion
        ...
        public static BasePermissionScope FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BasePermissionScope> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
