...
{
    /// <summary></summary>
    public partial class ItemDetails : Entity<ItemDetails>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemDetails数据……", typeof(ItemDetails).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemDetails数据！", typeof(ItemDetails).Name);
        //}
        #endregion
        ...
        public static ItemDetails FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemDetails> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
