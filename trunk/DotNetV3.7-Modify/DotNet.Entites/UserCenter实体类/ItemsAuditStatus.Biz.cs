...
{
    /// <summary></summary>
    public partial class ItemsAuditStatus : Entity<ItemsAuditStatus>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsAuditStatus数据……", typeof(ItemsAuditStatus).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsAuditStatus数据！", typeof(ItemsAuditStatus).Name);
        //}
        #endregion
        ...
        public static ItemsAuditStatus FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsAuditStatus> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
