...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Items_Enabled", true, "Id")]
    [BindTable("ItemsEnabled", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsEnabled : IItemsEnabled
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsEnabled
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
