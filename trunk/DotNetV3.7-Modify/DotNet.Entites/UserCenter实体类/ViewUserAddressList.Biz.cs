...
{
    /// <summary></summary>
    public partial class ViewUserAddressList : Entity<ViewUserAddressList>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ViewUserAddressList数据……", typeof(ViewUserAddressList).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ViewUserAddressList数据！", typeof(ViewUserAddressList).Name);
        //}
        #endregion
        ...
        //public static EntityList<ViewUserAddressList> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
