...
{
    /// <summary></summary>
    public partial class ItemsOilDataSource : Entity<ItemsOilDataSource>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsOilDataSource数据……", typeof(ItemsOilDataSource).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsOilDataSource数据！", typeof(ItemsOilDataSource).Name);
        //}
        #endregion
        ...
        public static ItemsOilDataSource FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsOilDataSource> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
