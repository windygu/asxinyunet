...
{
    /// <summary></summary>
    public partial class BaseStaff : Entity<BaseStaff>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseStaff数据……", typeof(BaseStaff).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseStaff数据！", typeof(BaseStaff).Name);
        //}
        #endregion
        ...
        public static BaseStaff FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseStaff> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
