...
namespace DotNet.Entites
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_ItemsLeaveCategory", true, "Id")]
    [BindTable("ItemsLeaveCategory", Description = "", ConnName = "UserCenterDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ItemsLeaveCategory : IItemsLeaveCategory
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
    ...
    /// <summary>接口</summary>
    public partial interface IItemsLeaveCategory
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
