...
{
    /// <summary></summary>
    public partial class ItemsWorkingProperty : Entity<ItemsWorkingProperty>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ItemsWorkingProperty数据……", typeof(ItemsWorkingProperty).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ItemsWorkingProperty数据！", typeof(ItemsWorkingProperty).Name);
        //}
        #endregion
        ...
        public static ItemsWorkingProperty FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ItemsWorkingProperty> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
