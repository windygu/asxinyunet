...
namespace DotNet.Entites.WorkFlow
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_APPPROCUREMENTEQUIPMENT", true, "Id")]
    [BindTable("ProcurementEquipment", Description = "", ConnName = "WorkFlowDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class ProcurementEquipment : IProcurementEquipment
    {
        #region 属性
        private String _Id;
        /// <summary></summary>
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(11, "ApplyCause", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(12, "ApplyDate", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(14, "ArrivalDate", "", null, "datetime", 3, 0, false)]
        public virtual DateTime ArrivalDate
        {
            get { return _ArrivalDate; }
            set { if (OnPropertyChanging("ArrivalDate", value)) { _ArrivalDate = value; OnPropertyChanged("ArrivalDate"); } }
        }
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(15, "ContractNumber", "", null, "nvarchar(50)", 0, 0, true)]
        public virtual String ContractNumber
        {
            get { return _ContractNumber; }
            set { if (OnPropertyChanging("ContractNumber", value)) { _ContractNumber = value; OnPropertyChanged("ContractNumber"); } }
        }
        ...
        [BindColumn(16, "CompletionSituation", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(17, "Problem", "", null, "nvarchar(200)", 0, 0, true)]
        public virtual String Problem
        {
            get { return _Problem; }
            set { if (OnPropertyChanging("Problem", value)) { _Problem = value; OnPropertyChanged("Problem"); } }
        }
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(20, "DeletionStateCode", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(21, "Enabled", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(23, "CreateOn", "", null, "datetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(26, "ModifiedOn", "", null, "datetime", 3, 0, false)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "ArrivalDate" : return _ArrivalDate;
                    case "ContractNumber" : return _ContractNumber;
                    case "CompletionSituation" : return _CompletionSituation;
                    case "Problem" : return _Problem;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "ApplyDate" : _ApplyDate = Convert.ToString(value); break;
                    case "ConsumingDate" : _ConsumingDate = Convert.ToDateTime(value); break;
                    case "ArrivalDate" : _ArrivalDate = Convert.ToDateTime(value); break;
                    case "ContractNumber" : _ContractNumber = Convert.ToString(value); break;
                    case "CompletionSituation" : _CompletionSituation = Convert.ToString(value); break;
                    case "Problem" : _Problem = Convert.ToString(value); break;
        ...
        public class _
        {
            ...
            ///<summary></summary>
            public static readonly Field ArrivalDate = FindByName("ArrivalDate");

            ///<summary></summary>
            public static readonly Field ContractNumber = FindByName("ContractNumber");

            ///<summary></summary>
            public static readonly Field CompletionSituation = FindByName("CompletionSituation");

            ///<summary></summary>
            public static readonly Field Problem = FindByName("Problem");
    ...
    /// <summary>接口</summary>
    public partial interface IProcurementEquipment
    {
        #region 属性
        /// <summary></summary>
        String Id { get; set; }
