...
{
    /// <summary></summary>
    public partial class MeterSubmission : Entity<MeterSubmission>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}MeterSubmission数据……", typeof(MeterSubmission).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}MeterSubmission数据！", typeof(MeterSubmission).Name);
        //}
        #endregion
        ...
        public static MeterSubmission FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<MeterSubmission> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
