...
{
    /// <summary></summary>
    public partial class BaseLog : Entity<BaseLog>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseLog数据……", typeof(BaseLog).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseLog数据！", typeof(BaseLog).Name);
        //}
        #endregion
        ...
        public static BaseLog FindByLogId(Int32 logid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<BaseLog> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
