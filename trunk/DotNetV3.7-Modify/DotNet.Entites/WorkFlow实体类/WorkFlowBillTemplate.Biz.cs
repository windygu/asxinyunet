...
{
    /// <summary></summary>
    public partial class WorkFlowBillTemplate : Entity<WorkFlowBillTemplate>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}WorkFlowBillTemplate数据……", typeof(WorkFlowBillTemplate).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}WorkFlowBillTemplate数据！", typeof(WorkFlowBillTemplate).Name);
        //}
        #endregion
        ...
        public static WorkFlowBillTemplate FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<WorkFlowBillTemplate> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
