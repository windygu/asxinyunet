...
{
    /// <summary></summary>
    public partial class View_BillTemplate : Entity<View_BillTemplate>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}View_BillTemplate数据……", typeof(View_BillTemplate).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}View_BillTemplate数据！", typeof(View_BillTemplate).Name);
        //}
        #endregion
        ...
        //public static EntityList<View_BillTemplate> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
