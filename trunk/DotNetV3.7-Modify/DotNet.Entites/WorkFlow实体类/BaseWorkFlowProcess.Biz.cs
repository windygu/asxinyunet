...
{
    /// <summary></summary>
    public partial class BaseWorkFlowProcess : Entity<BaseWorkFlowProcess>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseWorkFlowProcess数据……", typeof(BaseWorkFlowProcess).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseWorkFlowProcess数据！", typeof(BaseWorkFlowProcess).Name);
        //}
        #endregion
        ...
        public static BaseWorkFlowProcess FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseWorkFlowProcess> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
