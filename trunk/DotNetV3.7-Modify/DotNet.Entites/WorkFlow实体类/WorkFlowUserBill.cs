...
namespace DotNet.Entites.WorkFlow
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_WorkFlow_UserBill", true, "Id")]
    [BindTable("WorkFlowUserBill", Description = "", ConnName = "WorkFlowDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class WorkFlowUserBill : IWorkFlowUserBill
    {
        #region 属性
        private String _Id;
        /// <summary></summary>
        ...
        [BindColumn(11, "ReadCount", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(12, "FileSize", "", null, "int", 10, 0, false)]
        ...
        [BindColumn(16, "AuditStatus", "", null, "nvarchar(20)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(17, "Enabled", "", null, "int", 10, 0, false)]
    ...
    /// <summary>接口</summary>
    public partial interface IWorkFlowUserBill
    {
        #region 属性
        /// <summary></summary>
        String Id { get; set; }
