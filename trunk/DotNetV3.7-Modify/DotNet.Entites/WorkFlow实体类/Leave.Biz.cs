...
{
    /// <summary></summary>
    public partial class Leave : Entity<Leave>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}Leave数据……", typeof(Leave).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}Leave数据！", typeof(Leave).Name);
        //}
        #endregion
        ...
        //public static EntityList<Leave> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
