...
{
    /// <summary></summary>
    public partial class BaseSequence : Entity<BaseSequence>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BaseSequence数据……", typeof(BaseSequence).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BaseSequence数据！", typeof(BaseSequence).Name);
        //}
        #endregion
        ...
        public static BaseSequence FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<BaseSequence> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
