...
{
    /// <summary></summary>
    public partial class ModifyInformation : Entity<ModifyInformation>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ModifyInformation数据……", typeof(ModifyInformation).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ModifyInformation数据！", typeof(ModifyInformation).Name);
        //}
        #endregion
        ...
        public static ModifyInformation FindById(String id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<ModifyInformation> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
