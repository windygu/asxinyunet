...
namespace DotNet.Entites.WorkFlow
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK_Base_WorkFlowStep", true, "Id")]
    [BindTable("BaseWorkFlowStep", Description = "", ConnName = "WorkFlowDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseWorkFlowStep : IBaseWorkFlowStep
    {
        #region 属性
        private Int32 _Id;
        /// <summary></summary>
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(3, "ObjectId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(4, "WorkFlowId", "", null, "int", 10, 0, false)]
        ...
        [BindColumn(5, "ActivityId", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(7, "FullName", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(8, "AuditDepartmentId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(9, "AuditDepartmentName", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(10, "AuditUserId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(11, "AuditUserCode", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(12, "AuditUserRealname", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(13, "AuditRoleId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(14, "AuditRoleRealname", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(15, "ActivityType", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(16, "AllowPrint", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(17, "AllowEditDocuments", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(20, "DeletionStateCode", "", null, "int", 10, 0, false)]
        ...
        [BindColumn(21, "Description", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [BindColumn(22, "CreateOn", "", null, "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(23, "CreateUserId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(24, "CreateBy", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(25, "ModifiedOn", "", null, "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(26, "ModifiedUserId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(27, "ModifiedBy", "", null, "nvarchar(50)", 0, 0, true)]
    ...
    /// <summary>接口</summary>
    public partial interface IBaseWorkFlowStep
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
