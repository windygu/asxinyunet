...
namespace DotNet.Entites.WorkFlow
{
    ...
    [BindTable("BaseComment", Description = "", ConnName = "WorkFlowDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseComment : IBaseComment
    {
        ...
        [BindColumn(16, "CreateOn", "", "getdate()", "datetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(19, "ModifiedOn", "", "getdate()", "datetime", 3, 0, false)]
