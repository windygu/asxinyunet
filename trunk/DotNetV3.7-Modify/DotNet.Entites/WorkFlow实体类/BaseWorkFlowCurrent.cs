...
namespace DotNet.Entites.WorkFlow
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("IX_Base_WorkFlowCurrent", false, "ToUserId,DeletionStateCode,Enabled")]
    [BindIndex("PK_BASE_WORKFLOWCURRENT", true, "Id")]
    [BindTable("BaseWorkFlowCurrent", Description = "", ConnName = "WorkFlowDbConnection", DbType = DatabaseType.SqlServer)]
    public partial class BaseWorkFlowCurrent : IBaseWorkFlowCurrent
    {
        #region 属性
        private String _Id;
        /// <summary></summary>
        ...
        [BindColumn(2, "CategoryCode", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        /// <summary></summary>
        [DisplayName("CategoryFullName")]
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(3, "CategoryFullName", "", null, "nvarchar(50)", 0, 0, true)]
        public virtual String CategoryFullName
        {
            get { return _CategoryFullName; }
            set { if (OnPropertyChanging("CategoryFullName", value)) { _CategoryFullName = value; OnPropertyChanged("CategoryFullName"); } }
        }
        ...
        [BindColumn(5, "ObjectFullName", "", null, "nvarchar(200)", 0, 0, true)]
        public virtual String ObjectFullName
        {
            get { return _ObjectFullName; }
            set { if (OnPropertyChanging("ObjectFullName", value)) { _ObjectFullName = value; OnPropertyChanged("ObjectFullName"); } }
        }
        ...
        [BindColumn(6, "WorkFlowId", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(7, "ActivityId", "", null, "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(8, "ActivityFullName", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(9, "SendDate", "", "getdate()", "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(10, "ToDepartmentId", "", null, "nvarchar(50)", 0, 0, true)]
        public virtual String ToDepartmentId
        {
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(11, "ToDepartmentName", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(12, "ToUserId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(13, "ToUserRealname", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        private String _ToRoleId;
        /// <summary></summary>
        [DisplayName("ToRoleId")]
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(14, "ToRoleId", "", null, "nvarchar(50)", 0, 0, true)]
        public virtual String ToRoleId
        {
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(15, "ToRoleRealname", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(16, "AuditIdea", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(18, "AuditUserId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(19, "AuditUserCode", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(20, "AuditUserRealname", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(21, "AuditStatus", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(22, "Worked", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(23, "SortCode", "", "0", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(24, "Enabled", "", "1", "int", 10, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 200)]
        [BindColumn(26, "Description", "", null, "nvarchar(200)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(27, "CreateOn", "", "getdate()", "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(28, "CreateUserId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(29, "CreateBy", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn(30, "ModifiedOn", "", "getdate()", "smalldatetime", 3, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(31, "ModifiedUserId", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(32, "ModifiedBy", "", null, "nvarchar(50)", 0, 0, true)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "CategoryFullName" : return _CategoryFullName;
                    case "ObjectId" : return _ObjectId;
                    case "ObjectFullName" : return _ObjectFullName;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "CategoryFullName" : _CategoryFullName = Convert.ToString(value); break;
                    case "ObjectId" : _ObjectId = Convert.ToString(value); break;
                    case "ObjectFullName" : _ObjectFullName = Convert.ToString(value); break;
                    ...
                    case "ToDepartmentId" : _ToDepartmentId = Convert.ToString(value); break;
                    case "ToDepartmentName" : _ToDepartmentName = Convert.ToString(value); break;
                    case "ToUserId" : _ToUserId = Convert.ToString(value); break;
                    case "ToUserRealname" : _ToUserRealname = Convert.ToString(value); break;
                    case "ToRoleId" : _ToRoleId = Convert.ToString(value); break;
        ...
        public class _
        {
            ...
            ///<summary></summary>
            public static readonly Field CategoryFullName = FindByName("CategoryFullName");

            ///<summary></summary>
            public static readonly Field ObjectId = FindByName("ObjectId");

            ///<summary></summary>
            public static readonly Field ObjectFullName = FindByName("ObjectFullName");
    ...
    /// <summary>接口</summary>
    public partial interface IBaseWorkFlowCurrent
    {
        #region 属性
        /// <summary></summary>
        String Id { get; set; }
        ...
        /// <summary></summary>
        String CategoryFullName { get; set; }
