...
/// </author>
/// </remarks>
public partial class LeaveList : BasePage
{
	/// <summary>
    /// 是否按工作流方式运行
    /// </summary>
    ...
    private void DoSearch()
    {
        ...
        DataTable dataTable = manager.GetDataTableByPage(this.UserInfo.Id, this.txtSearch.Text, out recordCount, this.myNavigator.PageIndex, this.PageSize, this.SortExpression, this.SortDire);
    ...
    private void ShowEdit(string id)
    {
        ...
        {
			// string url = "LeaveEdit.aspx?Id=" + id + "&ReturnURL=LeaveList.aspx&ticks=" + ticks;
    ...
    private void ShowDetail(string id)
    {
        ...
        if (!string.IsNullOrEmpty(id))
        {
            // string url = "LeaveShow.aspx?Id=" + id + "&ReturnURL=LeaveList.aspx&ticks=" + ticks;
    ...
    {
	    // string url = "LeaveEdit.aspx?ReturnURL=LeaveList.aspx";
