...
/// </author>
/// </remarks>
public partial class LeaveAdmin : BasePage
{
	/// <summary>
    /// 是否按工作流方式运行
    /// </summary>
    ...
    private void ShowEdit(string id)
    {
        ...
        {
			// string url = "LeaveEdit.aspx?Id=" + id + "&ReturnURL=LeaveAdmin.aspx&ticks=" + ticks;
    ...
    private void ShowDetail(string id)
    {
        ...
        if (!string.IsNullOrEmpty(id))
        {
            // string url = "LeaveShow.aspx?Id=" + id + "&ReturnURL=LeaveAdmin.aspx&ticks=" + ticks;
    ...
    {
	    // string url = "LeaveEdit.aspx?ReturnURL=LeaveAdmin.aspx";
