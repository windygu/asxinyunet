...
/// </author>
/// </remarks>
public partial class SubmittedMaintain : BasePage
{
    ...
    private void DoSearch()
    {
        ...
        // DataTable dataTable = maintainManager.GetDataTableByPage(this.UserInfo.Id, "已提交", searchValue, out recordCount, this.myNavigator.PageIndex + 1, this.myNavigator.PageSize, this.SortExpression, this.SortDire);
        DataTable dataTable = maintainManager.GetDataTableByPage(this.UserInfo.Id, string.Empty, MaintainStatus.Submitted.ToDescription(), searchValue, out recordCount, this.myNavigator.PageIndex + 1, this.myNavigator.PageSize, this.SortExpression, this.SortDire);
    ...
    #region private int SetDraft() 设置为草稿状态
    /// <summary>
    /// 设置为草稿状态
    /// </summary>
