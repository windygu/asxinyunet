<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubmittedMaintain.aspx.cs"
    Inherits="SubmittedMaintain" %>
        ...
        <tr>
            <td align="center" valign="middle" style="height: 20px">
                ...
                &nbsp;<asp:Button ID="btnSetProcessed" runat="server" CssClass="Button" Text="已处理(S)"
                    AccessKey="D" TabIndex="3" OnClientClick="return CheckSelectAnyOne('你确定所选单据设置为已处理状态吗？');"
