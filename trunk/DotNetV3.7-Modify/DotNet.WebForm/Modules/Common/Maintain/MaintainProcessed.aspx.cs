...
/// </author>
/// </remarks>
public partial class MaintainProcessed : BasePage
{
    ...
    private void SetControlState()
    {
        ...
        this.btnProcessing.Enabled = this.gridView.Rows.Count > 0;
    ...
    private void DoSearch()
    {
        ...
        // DataTable dataTable = maintainManager.GetDataTableByPage(string.Empty, "已处理", searchValue, out recordCount, this.myNavigator.PageIndex + 1, this.myNavigator.PageSize, this.SortExpression, this.SortDire);
        DataTable dataTable = maintainManager.GetDataTableByPage(string.Empty, this.cmbBugCategory.SelectedValue, MaintainStatus.MaintainProcessed.ToDescription(), searchValue, out recordCount, this.myNavigator.PageIndex + 1, this.myNavigator.PageSize, this.SortExpression, this.SortDire);
