<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProcessedMaintain.aspx.cs"
    Inherits="ProcessedMaintain" %>
        ...
        <tr>
            <td align="center" valign="middle" style="height: 20px">
                <asp:Button ID="btnCheckAll" runat="server" CssClass="Button" Text="全选(A)" TabIndex="1"
                    ...
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                &nbsp;
                <asp:Button ID="btnSetProcessing" runat="server" CssClass="ButtonLarge" Text="未能解决(C)"
                    AccessKey="C" TabIndex="3" OnClientClick="return CheckSelectAnyOne('你确定退回所选单据吗？');"
                    OnClick="btnSetProcessing_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/ButtonLargem.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/ButtonLarge.gif)';" />
                &nbsp;
                <asp:Button ID="btnComplete" runat="server" CssClass="ButtonLarge" Text="确认完成(S)"
                    AccessKey="S" TabIndex="3" OnClientClick="return CheckSelectAnyOne('你确定完成所选单据吗？');"
                    OnClick="btnBatchComplete_Click" onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/ButtonLargem.gif)';"
                    onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/ButtonLarge.gif)';" />
            </td>
        </tr>
    </table>
