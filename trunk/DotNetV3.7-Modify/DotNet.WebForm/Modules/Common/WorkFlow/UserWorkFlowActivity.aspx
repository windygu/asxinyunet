<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserWorkFlowActivity.aspx.cs"
    Inherits="UserWorkFlowActivity" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>审批流程详细步骤设置-按用户按单据</title>
...
<body>
    ...
    <table width="100%">
        <tr valign="top">
            <td colspan="2">
                <div class="breadcrumbHeader">
                    <b>用户信息</b><span>
                        <img id="img" src="../../../Themes/Default/Images/open.gif" alt="显示" onmouseover="this.style.cursor='hand'"
                            onclick="displayTable('img','table_taskallot')" /></span>
                </div>
            </td>
        </tr>
        <tr valign="top">
            <td colspan="2">
                <table id="table_taskallot" class="table" width="100%" border="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td class="td-content" style="padding-top: 3">
                            <asp:Label ID="lblOrganizeName" runat="server" Text="部门"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" align="right" nowrap="nowrap" class="td-title">
        ...
        <tr valign="top">
            ...
            <td>
                <div class="breadcrumbHeader">
                    <b>审批流程</b><span>
                        <img id="img2" src="../../../Themes/Default/Images/close.gif" alt="隐藏" onmouseover="this.style.cursor='hand'"
                            onclick="displayTable('img2','grdWorkFlow')" /></span>
                </div>
            </td>
        </tr>
        <tr valign="top" style="height: 20px">
            <td>
                <asp:Label ID="lblWorkFlowActivity" runat="server" Text="标准审批流程"></asp:Label>
                <br />
            </td>
            <td align="center">
    ...
    <asp:HiddenField ID="txtUserWorkFlowId" runat="server" Value="" />
    </form>
    <!--endprint-->
</body>
</html>
