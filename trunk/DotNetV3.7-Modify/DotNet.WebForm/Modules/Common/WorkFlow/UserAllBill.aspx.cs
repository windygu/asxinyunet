...
/// 已审核
///
///     2012.04.10 版本：1.0  JiRiGaLa 创建代码。
///
/// 版本：1.0
///
/// <author>
...
/// </author>
/// </remarks>
public partial class UserAllBill : BasePage
{
    ...
    private void DoSearch()
    {
        ...
        DataTable dataTable = workFlowCurrentManager.GetUserAllBill(this.cmbCategory.SelectedValue, this.cmbBill.SelectedItem.Value, searchValue);
