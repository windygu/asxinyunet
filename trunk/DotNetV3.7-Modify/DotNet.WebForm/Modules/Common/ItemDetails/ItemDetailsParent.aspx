<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemDetailsParent.aspx.cs" Inherits="ItemDetailsParent" %>
<html>
<head>
    <title>编码管理</title>
        ...
        <table width="100%" height="100%">
            <tr>
             ...
             <tr>
                <td>
                    <div class="breadcrumbHeader">
                        <asp:Label ID="lblNavigation" runat="server" Text="&nbsp;"></asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
                <td width="100%" height="100%" valign="top">                    
                    <div style="overflow: auto; width: 100%; height: 100%">
                        <asp:GridView ID="grdItemDetails" runat="server" Width="100%" AutoGenerateColumns="False"
                            BackColor="White" BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="3" DataKeyNames="Id,ItemName"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="编号">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtCode" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ItemCode") %>'
                                ...
                                <asp:TemplateField Visible="true">
                                    <ItemTemplate >                                    
                                        <asp:LinkButton ID="lkbSub" runat="server" CausesValidation="true"
                                ...
                                <asp:TemplateField >
                                    <ItemTemplate>                                                                        
                                        <asp:LinkButton ID="lkbSubMuLu" runat="server" CommandName="SubMuLu" CausesValidation="true"
                                            Text='<%# DataBinder.Eval(Container, "DataItem.ItemValue")%>'>
                                        </asp:LinkButton> 
                                    </ItemTemplate>
                                    <EditItemTemplate>
                        ...
                        <asp:HiddenField ID="txtItemCode" Value="NewsCategory" runat="server" />
                        <asp:HiddenField ID="txtTableName" Value="BaseItemDetails" runat="server" />
                        <asp:HiddenField ID="txtUseItemCode" Value="" runat="server" />
                        <asp:HiddenField ID="txtUseItemName" Value="" runat="server" />
                        <asp:HiddenField ID="txtUseItemValue" Value="" runat="server" />
                        <asp:HiddenField ID="txtParentId" Value="" runat="server" />
                    </div>
                </td>
            </tr>
            <tr>
                <td align="center" valign="middle" style="height: 20px">
                    ...
                    <asp:Button ID="btnDelete" runat="server" CssClass="Button" Text="删除(D)" AccessKey="D"
                        ...
                        onmouseover="this.style.backgroundImage='url(../../../Themes/Default/Images/Buttonm.gif)';"
                        onmouseout="this.style.backgroundImage='url(../../../Themes/Default/Images/Button.gif)';" />
                    <asp:Button ID="btnPrint" Visible="false" runat="server" CssClass="ButtonLarge" Text="屏幕打印(P)" AccessKey="P" 
