...
var OxOd896=["ondblclick","navtd","shiftKey","style"]; Window_GetElement(window,OxOd896[0x1], true)[OxOd896[0x0]]=function (){if(event[OxOd896[0x2]]){ alert(element[OxOd896[0x3]].cssText) ;} ;}  ;
</script>
