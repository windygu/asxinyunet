...
namespace DotNet.WinForm
{
    ...
    public partial class FrmUserRoleAdmin : BaseForm
    {
        ...
        private void BindData()
        {
            ...
            // 往DataTable中添加选择列
            //BaseInterfaceLogic.DataTableAddColumn(this.DTRole, "colSelected");
            ...
            // {
            //     bool selected = Array.IndexOf(this.RoleIds, dataRowView.Row[BaseRoleEntity.FieldId].ToString()) >= 0;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                DotNetService.Instance.UserService.AddUserToRole(UserInfo, this.TargetUserId, ((IBaseSelectRoleForm)frmRoleSelect).SelectedIds);
                // 重新加载窗体
