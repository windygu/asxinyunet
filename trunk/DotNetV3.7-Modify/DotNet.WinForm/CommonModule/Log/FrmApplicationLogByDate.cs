...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary> 
    public partial class FrmApplicationLogByDate : BaseForm
    {
        ...
        public FrmApplicationLogByDate()
        {
            InitializeComponent();
        }
        ...
        //{
        //    BaseInterfaceLogic.DataTableAddColumn(this.DTLog, "colSelected");
        //}
        #endregion
        ...
        {
            // 获取数据
            this.DTLog = DotNetService.Instance.LogService.GetDataTableApplicationByDate(UserInfo, this.dtpStartDate.Value.Date.ToString(), this.dtpEndDate.Value.Date.ToString());
        ...
        private void DoSearch()
        {
            ...
            try
            {
                string startDate = this.dtpStartDate.Value.Date.ToString();
                string endDate = this.dtpEndDate.Value.Date.ToString();
                // 权限信息
                this.DTLog = DotNetService.Instance.LogService.GetDataTableApplicationByDate(UserInfo, startDate, endDate);
                this.GetList();
            }
            catch (Exception ex)
            {
        ...
        public override int BatchDelete()
        {
            ...
            try
            {
                ...
                returnValue = DotNetService.Instance.LogService.BatchDeleteApplication(UserInfo, this.GetSelecteIds());
            }
            catch (Exception ex)
            {
                this.ProcessException(ex);
        ...
        private void ClearLog()
        {
            ...
            try
            {
                DotNetService.Instance.LogService.TruncateApplication(UserInfo);
                // 绑定屏幕数据
                this.GetList();
