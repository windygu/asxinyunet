      ...
      //private bool permissionAccess           = false;    // 访问权限
        ...
        public string ParentEntityId
        {
            get
            {
                ...
                {
                    this.parentEntityId = this.tvFolder.SelectedNode.Tag.ToString();
                }
                else
                {
        ...
        public override void SetControlState()
        {
            ...
            if ((this.DTFileList.DefaultView.Count >= 1) || (this.tvFolder.Nodes.Count > 0))
            {
                ...
                this.mItmDelete.Enabled         = this.permissionDeleteFolder;
                this.mItmEdit.Enabled           = this.permissionEditFolder;
                this.mItmMove.Enabled           = this.permissionMoveFolder;
        ...
        //{
        //    BaseInterfaceLogic.DataTableAddColumn(this.DTFileList, "colSelected");
        //}
        #endregion
        ...
        private void tvFolder_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (e.Data.GetDataPresent("System.Windows.Forms.TreeNode", false))
            {
                ...
                if (BaseInterfaceLogic.TreeNodeCanMoveTo(treeNode, targetTreeNode))
                {
                    ...
                    DotNetService.Instance.FolderService.MoveTo(UserInfo, treeNode.Tag.ToString(), targetTreeNode.Tag.ToString());
                    // 往目标节点中加入被拖动节点的一份克隆
        ...
        private void mItmAddUrl_Click(object sender, EventArgs e)
        {
            ...
            FrmDocumentAdd frmDocumentAdd = new FrmDocumentAdd(this.tvFolder.SelectedNode.Tag.ToString(), "url");
        ...
        private void mItmAddFile_Click(object sender, EventArgs e)
        {
            ...
            FrmDocumentAdd frmDocumentAdd = new FrmDocumentAdd(this.tvFolder.SelectedNode.Tag.ToString(), "txt");
            frmDocumentAdd.ShowDialog();
            if (frmDocumentAdd.Changed)
            {
                // 获得子文件夹列表
        ...
        private string AddFile(string parentId, string filePath, bool child)
        {
            string returnValue = string.Empty;
        ...
        private void grdFile_DragDrop(object sender, DragEventArgs e)
        {
            if (e.Data.GetDataPresent(DataFormats.FileDrop))
            {
                ...
                {
                    if (this.AddFile(this.ParentEntityId, folder[i], false).Length > 0)
                    {
                        returnValue++;
                    }
        ...
        public string AddFolder(bool root)
        {
            ...
            {
                FrmFolderAdd = new FrmFolderAdd(this.tvFolder.SelectedNode.Tag.ToString(), this.tvFolder.SelectedNode.Text);
            }
        ...
        public string Add()
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                for (int i = 0; i < openFileDialog.FileNames.Length; i++)
                {
                    ...
                    returnValue = this.AddFile(this.ParentEntityId, filePath, false);
                }
            }
            return returnValue;
        }
        ...
        private void EditTree()
        {
            ...
            FrmFolderEdit FrmFolderEdit = new FrmFolderEdit(this.tvFolder.SelectedNode.Tag.ToString());
        ...
        {
            if (BaseInterfaceLogic.CheckInputSelectOne(this.DTFileList, "colSelected"))
            {
                ...
                if ((fileEntity.CategoryCode != null) && (fileEntity.CategoryCode.ToUpper().Equals("URL") || fileEntity.CategoryCode.ToUpper().Equals("TXT") || fileEntity.CategoryCode.ToUpper().Equals("TEXT")))
                {
