...
namespace DotNet.WinForm
{
    ...
    public partial class FrmWorkFlowProcessAdd : BaseForm
    {
        ...
        public FrmWorkFlowProcessAdd(String organizeId, string organizeFullName) : this()
        {
            this.ucOrganize.SelectedId = organizeId;
            this.ucOrganize.SelectedFullName = organizeFullName;
        }

        public FrmWorkFlowProcessAdd(String organizeId, string organizeFullName, string workFlowCategory): this(organizeId, organizeFullName)
        {
