...
namespace DotNet.WinForm
{
    ...
    public partial class FrmMessageSend : BaseForm
    {
        ...
        {
            this.btnSend.Enabled = (((!String.IsNullOrEmpty(this.ucUser.SelectedId)) || (this.ucUser.SelectedIds != null)) && (this.txtContent.Text.Length > 0));
        }
        #endregion
        ...
        public void SetSendTo(string userId, string fullName)
        {
            ...
            this.ActiveControl = this.txtContent;
