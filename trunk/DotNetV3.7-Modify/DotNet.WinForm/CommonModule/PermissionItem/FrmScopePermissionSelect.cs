...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class FrmScopePermissionSelect : BaseForm, IBaseSelectScopePermissionForm
    {
        ...
        public override void FormOnLoad()
        {
            ...
            // 往DataTable中添加选择列
            //BaseInterfaceLogic.DataTableAddColumn(this.DTPermission, "colSelected");
