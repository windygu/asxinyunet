    ...
    public partial class FrmPermissionItemModuleBatchSet : BaseForm
    {
        ...
        public string TargetPermissionItemId
        {
            get
            {
                ...
                {
                    permissionItemId = this.tvPermissionItem.SelectedNode.Tag.ToString();
                }
        ...
        private void tvModule_AfterCheck(object sender, TreeViewEventArgs e)
        {
            if (this.isUserClick)
            {
                ...
                {
                    // 关联操作权限
                    DotNetService.Instance.ModuleService.BatchAddModules(UserInfo, this.TargetPermissionItemId, new string[] { e.Node.Tag.ToString() });
                }
                else
                {
                    // 撤销关联操作权限
                    DotNetService.Instance.ModuleService.BatchDleteModules(UserInfo, this.TargetPermissionItemId, new string[] { e.Node.Tag.ToString() });
                }
