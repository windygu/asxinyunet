...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class UCStaffSelect : UserControl, IBaseSelectUserForm
    {
        /// <summary>
        /// 当前用户信息
        /// </summary>
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                ((IBaseSelectUserForm)frmStaffSelect).OpenId = this.OpenId;
            }
            ((IBaseSelectUserForm)frmStaffSelect).AllowNull = this.AllowNull;
            ((IBaseSelectUserForm)frmStaffSelect).MultiSelect = this.MultiSelect;
            if (this.MultiSelect && this.SelectedIds != null)
            {
                ((IBaseSelectUserForm)frmStaffSelect).SetSelectIds = this.SelectedIds;
            }
            ((IBaseSelectUserForm)frmStaffSelect).PermissionItemScopeCode = this.PermissionItemScopeCode;
            if (frmStaffSelect.ShowDialog() == DialogResult.OK)
            {
                this.SelectedId = ((IBaseSelectUserForm)frmStaffSelect).SelectedId;
                this.SelectedFullName = ((IBaseSelectUserForm)frmStaffSelect).SelectedFullName;
                this.txtFullName.Text = ((IBaseSelectUserForm)frmStaffSelect).SelectedFullName;
                this.SelectedIds = ((IBaseSelectUserForm)frmStaffSelect).SelectedIds;
                if (this.SelectedIndexChanged != null)
                {
                    this.SelectedIndexChanged(this.SelectedId);
                }
