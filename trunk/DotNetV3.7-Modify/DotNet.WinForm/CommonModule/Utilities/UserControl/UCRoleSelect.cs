...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class UCRoleSelect : UserControl, IBaseSelectRoleForm
    {
        /// <summary>
        /// 当前用户信息
        /// </summary>
        ...
        private void ShowRoleSelect()
        {
            ...
            ((IBaseSelectRoleForm)frmRoleSelect).ShowRoleOnly = this.ShowRoleOnly;
            ((IBaseSelectRoleForm)frmRoleSelect).AllowNull = this.AllowNull;
            ((IBaseSelectRoleForm)frmRoleSelect).PermissionItemScopeCode = this.PermissionItemScopeCode;
            if (frmRoleSelect.ShowDialog() == DialogResult.OK)
            {
                this.SelectedId = ((IBaseSelectRoleForm)frmRoleSelect).SelectedId;
                this.SelectedFullName = ((IBaseSelectRoleForm)frmRoleSelect).SelectedFullName;
                this.txtFullName.Text = ((IBaseSelectRoleForm)frmRoleSelect).SelectedFullName;
        ...
        private void ShowOrganizeRoleSelect()
        {
            ...
            if (!String.IsNullOrEmpty(this.SelectedId))
            {
                ((IBaseSelectRoleForm)frmRoleSelect).OpenId = this.SelectedId;
            }
            else
            {
                if (!String.IsNullOrEmpty(this.OpenId))
                {
                    ((IBaseSelectRoleForm)frmRoleSelect).OpenId = this.OpenId;
                }
            }
            ((IBaseSelectRoleForm)frmRoleSelect).ShowRoleOnly = this.ShowRoleOnly;
            ((IBaseSelectRoleForm)frmRoleSelect).AllowNull = this.AllowNull;
