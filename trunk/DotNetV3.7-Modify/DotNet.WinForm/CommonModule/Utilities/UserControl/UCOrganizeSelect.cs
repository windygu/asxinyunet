...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class UCOrganizeSelect : UserControl, IBaseSelectOrganizeForm
    {
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            //    {
                   ((IBaseSelectOrganizeForm)frmOrganizeSelect).OpenId = this.OpenId;
            //    }
            //}
            ((IBaseSelectOrganizeForm)frmOrganizeSelect).CheckMove = this.CheckMove;
            ((IBaseSelectOrganizeForm)frmOrganizeSelect).AllowNull = this.AllowNull;
            ...
            {
                this.SelectedId = ((IBaseSelectOrganizeForm)frmOrganizeSelect).SelectedId;
                this.SelectedFullName = ((IBaseSelectOrganizeForm)frmOrganizeSelect).SelectedFullName;
