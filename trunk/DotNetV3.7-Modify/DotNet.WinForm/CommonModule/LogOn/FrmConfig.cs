...
namespace DotNet.WinForm
{
    ...
    public partial class FrmConfig : BaseForm
    {
        ...
        private void GetConfigInfo()
        {
            ...
            this.lblWorkFlowDbConnection.Visible = UserConfigHelper.Exists("WorkFlowDbConnection");
            this.txtWorkFlowDbConnection.Visible = UserConfigHelper.Exists("WorkFlowDbConnection");
            this.cmbWorkFlowDbDbType.Visible = UserConfigHelper.Exists("WorkFlowDbConnection");
        }
        #endregion
