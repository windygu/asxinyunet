...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class FrmRoleAdmin : BaseForm, IBaseForm
    {
        /// <summary>
        /// 本模块的角色用户关联关系管理
        /// </summary>
        ...
        public FrmRoleAdmin(string categoryCode) : this()
        {
        ...
        private void SetRowFilter()
        {
            ...
            {
                rowFilter = BaseRoleEntity.FieldRealName + " LIKE '" + search + "'"
        ...
        private void btnFrmRolePermissionScope_Click(object sender, EventArgs e)
        {
            ...
            string formName = "FrmRolePermissionScopes";
        ...
        {
            // 只能选一个的功能加强，而且不能多选的功能实现
            // if (BaseInterfaceLogic.CheckInputSelectOne(this.DTRole, "colSelected"))
            // {
            //   DataRow dataRow = BaseInterfaceLogic.GetDataGridViewEntity(this.grdRole);
