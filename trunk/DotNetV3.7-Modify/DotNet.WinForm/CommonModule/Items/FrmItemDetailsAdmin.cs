...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class FrmItemDetailsAdmin : BaseForm, IBaseForm, IBaseItemDetailsAdminForm
    {
        ...
        public FrmItemDetailsAdmin(string targetTable) : this()
        {
        ...
        private void BindData()
        {
            ...
            //BaseInterfaceLogic.DataTableAddColumn(this.DTItemDetails, "colSelected");
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.DTItemDetails.DefaultView.RowFilter = BaseItemDetailsEntity.FieldItemCode + " LIKE '" + search + "'"
                    + " OR " + BaseItemDetailsEntity.FieldItemName + " LIKE '" + search + "'"
                    + " OR " + BaseItemDetailsEntity.FieldItemValue + " LIKE '" + search + "'"
                    + " OR " + BaseItemDetailsEntity.FieldDescription + " LIKE '" + search + "'";
            }
            // 设置按钮状态
            this.SetControlState();
        }
        ...
        private void btnRoleResourcePermission_Click(object sender, EventArgs e)
        {
            ...
            string targetResourceSQL = "SELECT " + BaseItemDetailsEntity.FieldId + " AS Id, "
                                        ...
                                        + BaseItemDetailsEntity.TableName
