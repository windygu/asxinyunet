...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class FrmItemsAdmin : BaseForm, IBaseForm, IBaseItemsAdminForm
    {
        ...
        {
            //BaseInterfaceLogic.DataTableAddColumn(this.DTItems, "colSelected");
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                rowFilter += "("+ BaseItemsEntity.FieldCode + " LIKE '" + search + "'"
