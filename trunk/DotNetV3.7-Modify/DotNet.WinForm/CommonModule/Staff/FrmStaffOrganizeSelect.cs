...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class FrmStaffOrganizeSelect : BaseForm, IBaseSelectUserForm
    {
        ...
        public string ParentOrganizeId
        {
            get
            {
                ...
                {
                    this.parentOrganizeId = this.tvOrganize.SelectedNode.Tag.ToString();
                }
        ...
        public string EntityID
        {
            get
            {
                ...
                {
                    entityId = this.tvOrganize.SelectedNode.Tag.ToString();
                }
                return entityId;
            }
        }
        ...
        //{
        //    BaseInterfaceLogic.DataTableAddColumn(this.DTStaffList, "colSelected");
        //}
        #endregion
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.DTStaffList.DefaultView.RowFilter = BaseStaffEntity.FieldUserName + " LIKE '" + search + "'"
