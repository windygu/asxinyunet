    ...
    public partial class FrmModulePermissionItemBatchSet : BaseForm
    {
        ...
        public string TargetModuleId
        {
            get
            {
                ...
                {
                    permissionItemId = this.tvModule.SelectedNode.Tag.ToString();
                }
        ...
        private void tvPermissionItem_AfterCheck(object sender, TreeViewEventArgs e)
        {
            if (this.isUserClick)
            {
                ...
                {
                    // 关联操作权限
                    DotNetService.Instance.ModuleService.BatchAddModules(UserInfo, e.Node.Tag.ToString(), new string[] { this.TargetModuleId });
                }
                else
                {
                    // 撤销关联操作权限
                    DotNetService.Instance.ModuleService.BatchDleteModules(UserInfo, e.Node.Tag.ToString(), new string[] { this.TargetModuleId });
                }
            }
        }
