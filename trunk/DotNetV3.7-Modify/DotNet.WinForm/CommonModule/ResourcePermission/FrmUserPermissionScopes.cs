...
namespace DotNet.WinForm
{
    ...
    /// </author> 
    /// </summary>
    public partial class FrmUserPermissionScopes : BaseForm
    {
        /// <summary>
        /// 权限域（范围权限、数据权限）
        /// </summary>
        ...
        public FrmUserPermissionScopes()
        {
            InitializeComponent();
        }

        public FrmUserPermissionScopes(string roleId)
            : this()
        {
            this.TargetUserId = roleId;
        }
