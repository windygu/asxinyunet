...
namespace DotNet.WinForm
{
    ...
    public partial class FrmUserOrganizeScope : BaseForm
    {
        ...
        private void GetUserOrganizeScope()
        {
            ...
            dtUserOrganizeScope.Columns.Add("colUserSubOrg", typeof(bool));
            ...
            for (int i = 0; i < dtUserOrganizeScope.Rows.Count; i++)
            {
                ...
                if (StringUtil.Exists(organizeIds, ((int)PermissionScope.UserSubOrg).ToString()))
                {
                    dtUserOrganizeScope.Rows[i]["colUserSubOrg"] = true;
                }
        ...
        private void SetRowFilter()
        {
            ...
            else
            {
                if (this.dtUserOrganizeScope.Columns.Count > 1)
                {
                    ...
                    this.dtUserOrganizeScope.DefaultView.RowFilter = BaseUserEntity.FieldUserName + " LIKE '" + search + "'"
