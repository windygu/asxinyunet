...
namespace DotNet.WinForm
{
    ...
    {
        public bool BuilderManager(string outputDirectory, bool overwrite, string dataBase=null)
        {
            this.postfix = "Manager";
            string fileName = outputDirectory + "\\" + this.project + ".Business\\" + this.project + ".Manager\\Manager.Auto\\" + this.className + "Manager.Auto.cs";
