...
namespace DotNet.WinForm
{
    ...
    public partial class CodeGenerator
    {
        ...
        public void DBSQL(XmlNode xmlNode)
        {
            ...
            this.CodeText.AppendLine(" USE [WorkFlowV36]");
            ...
            this.CodeText.AppendLine(" INSERT INTO WorkFlowBillTemplate(Code, Title, Source, AddPage, EditPage, ShowPage, ListPage, AdminPage) VALUES (" + "\'"
            ...
            this.CodeText.AppendLine("");
            this.CodeText.AppendLine(" USE [UserCenterV36]");
