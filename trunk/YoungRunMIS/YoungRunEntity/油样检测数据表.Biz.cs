...
namespace YoungRunEntity
{
	...
	/// 油样检测数据表
	/// </summary>
	public partial class tb_oilsampletest : Entity<tb_oilsampletest>
	{
		#region 对象操作
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个油样检测数据表实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">记录编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_oilsampletest FindByKeyForEdit(String __ID)
		{
			tb_oilsampletest entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new tb_oilsampletest();
			}
			return entity;
		}     
		...
		/// <returns></returns>
		public static tb_oilsampletest FindByID(Int32 __ID)
		{
		...
		public static EntityList<tb_oilsampletest> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
