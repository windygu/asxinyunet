...
namespace YoungRunEntity
{
	...
	/// 糠醛车间检测数据
	/// </summary>
	public partial class tb_kqtestdata : Entity<tb_kqtestdata>
	{
		#region 对象操作
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个糠醛车间检测数据实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">数据编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_kqtestdata FindByKeyForEdit(String __ID)
		{
			tb_kqtestdata entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new tb_kqtestdata();
			}
			return entity;
		}     
		...
		/// <returns></returns>
		public static tb_kqtestdata FindByID(Int32 __ID)
		{
		...
		public static EntityList<tb_kqtestdata> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
