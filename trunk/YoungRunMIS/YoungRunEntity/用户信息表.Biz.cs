...
namespace YoungRunEntity
{
	...
	public partial class tb_user : Entity<tb_user>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个用户信息表实体对象用于表单编辑
		/// </summary>
		///<param name="__UserName">用户名</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_user FindByKeyForEdit(String __UserName)
		{
			tb_user entity=Find(new String[]{_.UserName}, new Object[]{__UserName});
			if (entity == null)
			{
				entity = new tb_user();
			}
		...
		/// <returns></returns>
		public static tb_user FindByName(String __Name)
		{
		...
		public static EntityList<tb_user> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
