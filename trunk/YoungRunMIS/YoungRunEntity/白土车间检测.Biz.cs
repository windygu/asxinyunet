...
namespace YoungRunEntity
{
	...
	public partial class tb_bttestdata : Entity<tb_bttestdata>
	{
		...
		public static tb_bttestdata FindByKeyForEdit(String __ID)
		{
			tb_bttestdata entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
		...
		/// <returns></returns>
		public static tb_bttestdata FindByID(Int32 __ID)
		{
		...
		public static EntityList<tb_bttestdata> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
