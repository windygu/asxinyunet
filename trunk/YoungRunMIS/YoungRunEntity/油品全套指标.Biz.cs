...
namespace YoungRunEntity
{
	...
	public partial class tb_oildata : Entity<tb_oildata>
	{
		...
		///<param name="__OilName">油品名称</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_oildata FindByKeyForEdit(String __ID, String __OilName)
		{
			tb_oildata entity=Find(new String[]{_.ID, _.OilName}, new Object[]{__ID, __OilName});
			if (entity == null)
			{
		...
		/// <returns></returns>
		public static tb_oildata FindByID(Int32 __ID)
		{
