...
namespace YoungRunEntity
{
	...
	public partial class tb_oilsampletest
	{
		#region 属性
		private String _ID;
		/// <summary>
		...
		[BindColumn(1, "ID", "记录编号", "", "varchar(20)", 0, 0, false)]
		public String ID
		{
			get { return _ID; }
		...
		[BindColumn(2, "RecordType", "记录类型", "", "varchar(16)", 0, 0, false)]
		...
		[BindColumn(3, "OilName", "油品名称", "", "varchar(20)", 0, 0, false)]
		...
		[Description("供应方")]
		[DataObjectField(false, false, true, 20)]
		[BindColumn(4, "Provider", "供应方", "", "varchar(20)", 0, 0, false)]
		...
		[BindColumn(5, "DataID", "数据编号", "", "varchar(20)", 0, 0, false)]
		...
		[Description("送样人")]
		[DataObjectField(false, false, true, 20)]
		[BindColumn(6, "SendPerson", "送样人", "", "varchar(20)", 0, 0, false)]
		...
		[BindColumn(7, "SendDateTime", "送样时间", "", "datetime", 0, 0, false)]
		...
		[BindColumn(8, "Remark", "备注", "", "varchar(50)", 0, 0, false)]
		...
		public class _
		{
			...
			/// 送样人
			///</summary>
			public const String SendPerson = "SendPerson";
