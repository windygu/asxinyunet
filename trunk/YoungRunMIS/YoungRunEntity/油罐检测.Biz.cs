...
namespace YoungRunEntity
{
	...
	/// 油罐检测
	/// </summary>
	public partial class tb_oiltanktest : Entity<tb_oiltanktest>
	{
		#region 对象操作
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个油罐检测实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">数据编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_oiltanktest FindByKeyForEdit(String __ID)
		{
			tb_oiltanktest entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new tb_oiltanktest();
			}
			return entity;
		}     
		...
		/// <returns></returns>
		public static tb_oiltanktest FindByID(Int32 __ID)
		{
		...
		public static EntityList<tb_oiltanktest> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
