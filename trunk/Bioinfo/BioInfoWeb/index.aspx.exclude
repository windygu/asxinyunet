...
<body>
	<div id="wrapper">
		<div id="logo">
			<h1><a href="index.html">DESIGN<span>HQ</span></a></h1>
		</div>
		...
		<!-- main menu -->
			<ul class="menu" id="jMenu">
				...
				<li><a href="category.html">Blog</a>
					<ul>
				...
				<li><a href="category.html">Portfolio</a>
					<ul>
			...
			<!-- main content -->
			<div id="left">
				<h1><a href="inner.html">So who are we?</a></h1>
				...
				<a href="inner.html" class="read-more">Read more</a>
			</div>
