...
{
    /// <summary>消息</summary>
    public partial class Messages : Entity<Messages>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}消息数据……", typeof(Messages).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}消息数据！", typeof(Messages).Name);
        //}
        #endregion
        ...
        /// <summary>该消息所对应的类别信息类名称</summary>
        [XmlIgnore]
        ...
        public static Messages FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        /// <summary>根据问题类别查找</summary>
        /// <param name="categoryid">问题类别</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Messages> FindAllByCategoryId(Int32 categoryid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Messages> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
