...
namespace Bioinfo.Entites
{
    ...
    public partial class News : Entity<News>
    {
        ...
        /// <summary>该新闻信息表所对应的类别信息</summary>
        [XmlIgnore]
        ...
        /// <summary>该新闻信息表所对应的类别信息类名称</summary>
        [XmlIgnore]
        ...
        /// <summary>根据类别编号查找</summary>
        /// <param name="categoryid">类别编号</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<News> FindAllByCategoryId(Int32 categoryid)
        {
            if (Meta.Count >= 1000)
