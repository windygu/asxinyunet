...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server" ID="Head1">
		...
		<script>
var OxO46d5=["0","#","length","\x3Ctr\x3E","\x3Ctd class=\x27colorcell\x27\x3E\x3Cdiv class=\x27colordiv\x27 style=\x27background-color:","\x27 cvalue=\x27","\x27 title=\x27","\x27\x3E\x26nbsp;\x3C/div\x3E\x3C/td\x3E","\x3C/tr\x3E"]; function DoubleHex(Ox8){if(Ox8<0x10){return OxO46d5[0x0]+Ox8.toString(0x10);} ;return Ox8.toString(0x10);}  ; function ToHexString(Oxa,Oxb,Oxc){return (OxO46d5[0x1]+DoubleHex(Oxa*0x33)+DoubleHex(Oxb*0x33)+DoubleHex(Oxc*0x33)).toUpperCase();}  ; function MakeHex(z,x,y){var Ox11=z%0x2;var Ox12=(z-Ox11)/0x2; z=Ox11*0x3+Ox12 ;if(z<0x3){ x=0x5-x ;} ;if(z==0x1||z==0x4){ y=0x5-y ;} ;return ToHexString(0x5-y,0x5-x,0x5-z);}  ;var colors= new Array(0xd8);for(var z=0x0;z<0x6;z++){for(var x=0x0;x<0x6;x++){for(var y=0x0;y<0x6;y++){var hex=MakeHex(z,x,y);var xx=(z%0x2)*0x6+x;var yy=Math.floor(z/0x2)*0x6+y; colors[yy*0xc+xx]=hex ;} ;} ;} ;var arr=[];for(var i=0x0;i<colors[OxO46d5[0x2]];i++){if(i%0xc==0x0){ arr.push(OxO46d5[0x3]) ;} ; arr.push(OxO46d5[0x4]) ; arr.push(colors[i]) ; arr.push(OxO46d5[0x5]) ; arr.push(colors[i]) ; arr.push(OxO46d5[0x6]) ; arr.push(colors[i]) ; arr.push(OxO46d5[0x7]) ;if(i%0xc==0xb){ arr.push(OxO46d5[0x8]) ;} ;} ;
		</script>
	</head>
	<body>
	<div id="container">
			<div class="tab-pane-control tab-pane" id="tabPane1">
				...
				<div class="tab-page">
					<table cellSpacing='2' cellPadding="1" align="center">
						<script>
							var OxO32eb=[""]; document.write(arr.join(OxO32eb[0x0])) ;
						</script>
						<tr>
