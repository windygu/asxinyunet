...
namespace ComLib.Automation
{
    ...
    public class Interpreter
    {
        ...
        /// <returns></returns>
        public VariableExpression TokenizeVariable(string line, string pattern)
        {
        ...
        private VariableExpression ParseVariable(string name, string val)
        {
            var type = typeof(int);
            ...
            return new VariableExpression() { Name = name, Value = objVal, DataType = type };
        }
        ...
        /// <returns></returns>
        public FunctionCallExpression TokenizeFunctionCall(string line, int linenumber)
        {
            line = line.Trim();
            ...
            if (currentChar == ')') return new FunctionCallExpression() { Name = funcName, ParamMap = new Dictionary<string, object>() };
            char[] endToken = new []{' ',',',')'};
            ...
            return new FunctionCallExpression() { Name = funcName, ParamMap = paramMap, ParamList = paramList};
        }
