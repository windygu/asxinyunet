...
namespace YoungRunEntity
{
    ...
    public partial class tb_oiltankst : Entity<tb_oiltankst>
    
    {
        ...
        #region 扩展查询
        /// <summary>
        /// 根据主键查询一个油罐储量信息表实体对象用于表单编辑
        /// </summary>
        /// <param name="id">编号</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static tb_oiltankst FindByKeyForEdit(UInt32 id)
        {
            tb_oiltankst entity = Find(new String[] { _.ID }, new Object[] { id });
            if (entity == null)
            {
                entity = new tb_oiltankst();
            }
            return entity;
        }
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static tb_oiltankst FindByID(UInt32 id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<tb_oiltankst> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
