...
namespace YoungRunEntity
{
    ...
    
    {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static tb_dictype FindByID(UInt32 id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<tb_dictype> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
