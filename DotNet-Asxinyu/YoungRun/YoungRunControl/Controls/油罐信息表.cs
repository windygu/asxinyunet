	...
	namespace YoungRunControl.Controls
	{
			...
			/// 获取或者设置当前实体
			/// </summary>
			public tb_OilTankInfo CutModel
			{
				get ;set ;
			}
			/// <summary>
			...
			//TODO:有问题，需要根据当前的状态来更新和保存数据
				...
				tb_OilTankInfo model = new tb_OilTankInfo();//定义当前实体
					...
					if(txtTankId.Text.Trim()!=""){
						model.TankId = txtTankId.Text.Trim() ;}if(txtHeight.Text.Trim()!=""){
				...
				if(combProductNameTP.Text.Trim()!=""){
					model.ProductNameTP = combProductNameTP.Text.Trim() ;}
				if(combStrogeType.Text.Trim()!=""){
					model.StrogeType = combStrogeType.Text.Trim() ;}
					if(txtPurpose.Text.Trim()!=""){
						model.Purpose = txtPurpose.Text.Trim() ;}if(txtAlarmHeight.Text.Trim()!=""){
			...
			private void SetControlReSet()
			{
				...
				if (CutShowMode == FormShowMode.AddOne || CutShowMode== FormShowMode.ContinueAdd )
				{
					...
					btnOK.Text ="保存";
					//设置控件清空，并且可用
					txtTankId.ReadOnly = false ;
							txtTankId.Text = string.Empty  ; txtHeight.ReadOnly = false ;
							txtHeight.Text = string.Empty  ; txtVolume.ReadOnly = false ;
							txtVolume.Text = string.Empty  ; txtPerCmVolume.ReadOnly = false ;
							txtPerCmVolume.Text = string.Empty  ; 
							combProductNameTP.Enabled = true ;
							combStrogeType.Enabled = true ;txtPurpose.ReadOnly = false ;
							txtPurpose.Text = string.Empty  ; txtAlarmHeight.ReadOnly = false ;
							txtAlarmHeight.Text = string.Empty  ; txtD20.ReadOnly = false ;
							txtD20.Text = string.Empty  ; txtRemark.ReadOnly = false ;
			...
			private void SetControlEdit()
			{
				...
				txtTankId.ReadOnly = true;
					...
					txtPerCmVolume.ReadOnly = false ;combProductNameTP.Enabled = true ;combStrogeType.Enabled = true ;
					txtPurpose.ReadOnly = false ;
					txtAlarmHeight.ReadOnly = false ;
					txtD20.ReadOnly = false ;dtUpdateTime.Enabled = true ;
			...
			private void SetControlReadOnly()
			{
				...
				txtTankId.ReadOnly = true ;txtHeight.ReadOnly = true ;txtVolume.ReadOnly = true ;txtPerCmVolume.ReadOnly = true ;
							combProductNameTP.Enabled = false ;
							
							combStrogeType.Enabled = false ;
							txtPurpose.ReadOnly = true ;txtAlarmHeight.ReadOnly = true ;txtD20.ReadOnly = true ;
			...
			private void BandingData()
			{
				  ...
				  txtVolume.DataBindings.Clear();
						   txtVolume.DataBindings.Add ("Text",CutModel,"Volume");
				  txtPerCmVolume.DataBindings.Clear();
