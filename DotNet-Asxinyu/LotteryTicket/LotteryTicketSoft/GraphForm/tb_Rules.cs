...
private System.Windows.Forms.TextBox txtNeedRows ;
		private System.Windows.Forms.Label    lblNeedRows ;
...
private System.Windows.Forms.TextBox txtRemark ;
   ...
   private System.Windows.Forms.ErrorProvider errorProvider1 ;
		...
		private void InitializeComponent()
		{
            ...
            this.lblNeedRows = new System.Windows.Forms.Label();
            ...
            this.txtNeedRows = new System.Windows.Forms.TextBox();
            ...
            this.lblSchemeId.Location = new System.Drawing.Point(6, 11);
            ...
            this.lblIndexSelectorNameTP.Location = new System.Drawing.Point(6, 38);
            ...
            this.lblCompareRuleNameTP.Location = new System.Drawing.Point(6, 65);
            ...
            this.lblRuleCompareParams.Location = new System.Drawing.Point(6, 92);
            ...
            // lblNeedRows
            // 
            this.lblNeedRows.AutoSize = true;
            this.lblNeedRows.Font = new System.Drawing.Font("宋体", 10.5F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.lblNeedRows.Location = new System.Drawing.Point(6, 119);
            this.lblNeedRows.Name = "lblNeedRows";
            this.lblNeedRows.Size = new System.Drawing.Size(63, 14);
            this.lblNeedRows.TabIndex = 200;
            this.lblNeedRows.Text = "需要行数";
            // 
            // lblCorrectRate
            // 
            ...
            this.lblCorrectRate.Location = new System.Drawing.Point(20, 146);
            ...
            this.lblFilterInfo.Location = new System.Drawing.Point(6, 173);
            ...
            this.lblEnable.Location = new System.Drawing.Point(34, 200);
            ...
            this.lblUpdateTime.Location = new System.Drawing.Point(6, 227);
            ...
            this.lblRemark.Location = new System.Drawing.Point(34, 254);
            ...
            this.txtSchemeId.Location = new System.Drawing.Point(71, 6);
            ...
            this.combIndexSelectorNameTP.Location = new System.Drawing.Point(71, 33);
            ...
            this.combCompareRuleNameTP.Location = new System.Drawing.Point(71, 60);
            ...
            this.txtRuleCompareParams.Location = new System.Drawing.Point(71, 87);
            ...
            this.txtNeedRows.Location = new System.Drawing.Point(71, 114);
            ...
            this.txtCorrectRate.Location = new System.Drawing.Point(71, 141);
            ...
            this.txtFilterInfo.Location = new System.Drawing.Point(71, 168);
            ...
            this.txtEnable.Location = new System.Drawing.Point(71, 195);
            ...
            this.dtUpdateTime.Location = new System.Drawing.Point(71, 222);
            ...
            this.txtRemark.Location = new System.Drawing.Point(71, 249);
            ...
            this.btnCancle.Location = new System.Drawing.Point(163, 278);
            ...
            this.Controls.Add(this.lblNeedRows);
            ...
            this.Controls.Add(this.txtNeedRows);
        ...
        {
            AddRules EntityControl = new AddRules();
		...
		{   			
			...
			if(txtNeedRows.Text.Trim()=="")//需要行数
			{
				errorProvider1.SetError(txtNeedRows,"必填项目");
				return false ;
			}
		...
		void btnOK_Click(object sender, EventArgs e)
		{
			...
			else 
			{
				if(((CutShowMode!= FormShowMode.ReadOnlyForAll) || (CutShowMode != FormShowMode.ReadOnlyForOne)) && ValidateControls() )
				{
					...
					if(txtNeedRows.Text.Trim()!="")	model.NeedRows =Convert.ToInt32(txtNeedRows.Text.Trim()) ;//需要行数
		...
		private void SetControlReSet()
		{
			...
			if (CutShowMode == FormShowMode.AddOne || CutShowMode== FormShowMode.ContinueAdd )
			{
				...
				txtNeedRows.ReadOnly = false ;//需要行数
				txtNeedRows.Text = string.Empty  ; 
		...
		private void SetControlReadOnly()
		{
			...
			txtNeedRows.ReadOnly = true  ;//需要行数
		...
		{			
			...
			txtNeedRows.DataBindings.Clear();//需要行数
			txtNeedRows.DataBindings.Add ("Text",CutModel,"NeedRows");
