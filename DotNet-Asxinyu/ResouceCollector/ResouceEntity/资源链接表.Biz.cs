...
namespace ResouceEntity
{
	...
	public partial class tb_resoucelink : Entity<tb_resoucelink>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个资源链接表实体对象用于表单编辑
		/// </summary>
		///<param name="__ResouceMD5">资源MD5值</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_resoucelink FindByKeyForEdit(String __ResouceMD5)
		{
			tb_resoucelink entity=Find(new String[]{_.ResouceMD5}, new Object[]{__ResouceMD5});
			if (entity == null)
			{
				entity = new tb_resoucelink();
			}
			return entity;
		}     
		#endregion
