...
namespace ResouceEntity
{
	...
	public partial class tb_resoucepageslist : Entity<tb_resoucepageslist>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个资源列表实体对象用于表单编辑
		/// </summary>
		///<param name="__PageURL">网址</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static tb_resoucepageslist FindByKeyForEdit(String __PageURL)
		{
			tb_resoucepageslist entity=Find(new String[]{_.PageURL}, new Object[]{__PageURL});
			if (entity == null)
			{
				entity = new tb_resoucepageslist();
			}
			return entity;
		}     
		#endregion
