...
namespace DotNet.CommonEntity
{
    ...
    public partial class Log<TEntity> : Entity<TEntity> where TEntity : Log<TEntity>, new()
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}日志信息数据……", typeof(TEntity).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}日志信息数据！", typeof(TEntity).Name);
        //}
        #endregion
