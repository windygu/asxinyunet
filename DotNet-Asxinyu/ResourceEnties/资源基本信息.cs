...
namespace ResourceEnties
{
    ...
    [BindTable("ResourceInfo", Description = "资源基本信息", ConnName = "ResourceConn", DbType = DatabaseType.SqlServer)]
    public partial class ResourceInfo : IResourceInfo
    {
        ...
        [BindColumn(11, "Md5", "MD5值", null, "nvarchar(32)", 0, 0, true)]
        ...
        [BindColumn(16, "StorageLocation", "存储位置", null, "nvarchar(100)", 0, 0, true)]
