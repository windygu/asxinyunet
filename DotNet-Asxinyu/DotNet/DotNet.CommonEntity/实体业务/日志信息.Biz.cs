...
namespace DotNet.CommonEntity
{
    ...
    public partial class Log : Entity<Log>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}日志信息数据……", typeof(Log).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}日志信息数据！", typeof(Log).Name);
        //}
        #endregion
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Log> FindAllByUserId(Int32 userid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Log> FindAllBySystemDbId(Int32 systemdbid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Log> FindAllBySystemDbIdAndUserId(Int32 systemdbid, Int32 userid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Log> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
