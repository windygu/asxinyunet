...
namespace DotNet.CommonEntity
{
    ...
    public partial class Setting : Entity<Setting>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}系统设置表数据……", typeof(Setting).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}系统设置表数据！", typeof(Setting).Name);
        //}
        #endregion
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Setting> FindAllBySystemId(Int32 systemid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Setting> FindAllBySystemIdAndName(Int32 systemid, String name)
        {
            if (Meta.Count >= 1000)
