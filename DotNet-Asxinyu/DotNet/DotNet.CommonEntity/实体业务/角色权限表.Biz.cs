...
namespace DotNet.CommonEntity
{
    ...
    public partial class RolePermission : Entity<RolePermission>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}角色权限表数据……", typeof(RolePermission).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}角色权限表数据！", typeof(RolePermission).Name);
        //}
        #endregion
        ...
        public static RolePermission FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<RolePermission> FindAllByRoleIdAndPermissionId(Int32 roleid, Int32 permissionid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<RolePermission> FindAllByPermissionId(Int32 permissionid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<RolePermission> FindAllByRoleId(Int32 roleid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<RolePermission> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
